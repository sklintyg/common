...
module.exports = function(grunt) {
  ...
  var minaintyg = grunt.file.expand({cwd: SRC_DIR},
      ['webjars/common/app-shared/**/*.js', 'webjars/common/minaintyg/**/*.js', '!**/*.spec.js', '!**/module.js']).sort();
  ...
  minaintyg = [SRC_DIR + 'webjars/common/minaintyg/module.js', DEST_DIR + 'webjars/common/minaintyg/templates.js'].concat(
      minaintyg.map(function(file) {
        return SRC_DIR + file;
      }));

  var webcert = grunt.file.expand({cwd: SRC_DIR},
      ['webjars/common/app-shared/**/*.js', 'webjars/common/webcert/**/*.js', '!**/*.spec.js', '!**/module.js']).sort();
  ...
  webcert =
      [SRC_DIR + 'webjars/common/webcert/module.js', DEST_DIR + 'webjars/common/webcert/templates.js'].concat(webcert.map(function(file) {
        return SRC_DIR + file;
      }));
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      webcert: {
        src: ['Gruntfile.js', SRC_DIR + '!webjars/common/webcert/**/vendor/*.js', SRC_DIR + 'webjars/common/app-shared/**/*.js',
          SRC_DIR + 'webjars/common/webcert/**/*.js']
      }
    }
