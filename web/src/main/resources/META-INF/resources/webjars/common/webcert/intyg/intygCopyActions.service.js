...
angular.module('common').factory('common.IntygCopyActions',
    ['$log', '$stateParams', '$state', 'common.messageService',
      ...
      'common.PersonIdValidatorService',
      function($log, $stateParams, $state, messageService,
        ...
        function _fornya(viewState, intygFornyaRequest, isOtherCareUnit) {
          ...
          if (UserModel.getAnvandarPreference(_FORNYA_DIALOG_PREFERENCE) === true || UserModel.getAnvandarPreference(
              _FORNYA_DIALOG_PREFERENCE) === 'true') {
        ...
        function _ersatt(viewState, intygErsattRequest, isOtherCareUnit) {
          ...
          var ersattDialog = dialogService.showDialog({
            ...
            button2click: function(modalInstance) {
              modalInstance.close();
              IntygHelper.goToDraft(viewState.intygModel.typ, viewState.intygModel.textVersion,
                  viewState.common.intygProperties.latestChildRelations.replacedByUtkast.intygsId);
            },
        ...
        function _createFromTemplate(viewState, intygCreateFromTemplateRequest, isOtherCareUnit, previousIntyg) {
          ...
          if (!viewState.common.isSentIntyg()) {
            var notSentInfoMessageKey = intygCreateFromTemplateRequest.intygType + '.createfromtemplate.' +
                newIntygType + '.modal.text.info.notsent';
          ...
          var confirmCreateButtonMessageKey = intygCreateFromTemplateRequest.intygType + '.createfromtemplate.' +
              newIntygType + '.modal.button.continue';
