        ...
        */
        ...
        this.setIntygViewState = function(intygViewState, intygType) {
          ...
          if (this.currentCreateFromTemplateConfig) {
            this.currentCreateFromTemplateConfig.buttonText =
                messageService.getProperty('common.createfromtemplate', {intygName: this.currentCreateFromTemplateConfig.name});
            this.currentCreateFromTemplateConfig.gotoButtonText =
                messageService.getProperty('common.gotofromtemplate', {intygName: this.currentCreateFromTemplateConfig.name});
