    ...
    ['$q', 'common.ObjectHelper', 'common.srsProxy', 'common.srsViewState', 'common.authorityService', '$stateParams',
        ...
        function($q, ObjectHelper, srsProxy, srsViewState, authorityService, $stateParams, srsService, $rootScope) {
            ...
            return {
                ...
                link: function(scope, element, attrs) {
                    ...
                    function setPredictionImage() {
                        if (scope.srsViewState.prediction.description === 'Prediktion saknas.') {
                            ...
                            scope.srsViewState.riskImage = '/web/webjars/common/webcert/utkast/srs/img/latt_forhojd.png';
                        }
                        else if (scope.srsViewState.prediction.description === 'Måttligt förhöjd risk') {
                            scope.srsViewState.riskImage = '/web/webjars/common/webcert/utkast/srs/img/mattligt_forhojd.png';
                        }
                        else if (scope.srsViewState.prediction.description === 'Starkt förhöjd risk') {
                            scope.srsViewState.riskImage = '/web/webjars/common/webcert/utkast/srs/img/starkt_forhojd.png';
                        }
                    }
                    ...
                    function loadDiagCodes() {
                        scope.srsViewState.diagnosisListFetching = srsProxy.getDiagnosisCodes().then(function(diagnosisCodes) {
                ...
                templateUrl: '/web/webjars/common/webcert/utkast/srs/wcSrsHelpDisplay.directive.html'
            };
        }]);
