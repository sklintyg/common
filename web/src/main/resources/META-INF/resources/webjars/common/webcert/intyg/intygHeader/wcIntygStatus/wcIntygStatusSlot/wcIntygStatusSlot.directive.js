        ...
        $scope.openModal = function() {
          ...
          var modalInstance = $uibModal.open({
            ...
            controller: function($scope) {
              ...
              $scope.header =
                  messageService.getProperty(IntygStatusService.getMessageKeyForIntyg('.modalheader.intygstatus.' + statusCode), vars);
              $scope.body =
                  messageService.getProperty(IntygStatusService.getMessageKeyForIntyg('.modalbody.intygstatus.' + statusCode), vars);
            }
          });
