 ...
 */
angular.module('common').directive('ueDecimalTsSyn',
    function() {
      'use strict';
      ...
      return {
        ...
        link: function(scope, elem, attrs, ngModelCtrl) {
          ...
          function filter(s) {
            ...
            if (scope.ueDecimalTsSyn > 0) {
              // Limits length to maxNumbers with optional decimal separator
              var maxLength = scope.ueDecimalTsSyn;
              if (dec) {
                maxLength++;
              }
          ...
          function _isMaxTwoDecimals(value) {
            ...
            return value.ueDecimalTsSyn === 2 || value.ueDecimalTsSyn === '2';
          }
