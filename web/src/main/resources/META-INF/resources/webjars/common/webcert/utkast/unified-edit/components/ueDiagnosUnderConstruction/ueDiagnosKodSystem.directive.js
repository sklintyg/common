 ...
 */
angular.module('common').directive('ueDiagnosKodSystem', [ '$log', '$timeout', 'common.ObjectHelper',
    'common.MonitoringLogService', 'common.UtkastValidationService',
    function($log, $timeout, ObjectHelper, monitoringService, UtkastValidationService) {
        'use strict';
        ...
        return {
            ...
            templateUrl: '/web/webjars/common/webcert/utkast/unified-edit/components/ueDiagnosUnderConstruction/ueDiagnosKodSystem.directive.html',
            link: function($scope) {
                ...
                $scope.$watch(diagnosViewState.diagnosKodSystem, function(newVal, oldVal) {
                    if (newVal) {
