...
describe('ArendeProxy', function() {
  ...
  // Testdata
  var testNewQuestionResponse = {
    'internReferens': 13, 'frageStallare': 'WC', 'amne': 'ARBETSTIDSFORLAGGNING',
    ...
    'intygsReferens': {
      'intygsId': 'intyg-2', 'intygsTyp': 'luse', 'patientNamn': 'Test Testorsson',
      'signeringsDatum': '2012-12-23T21:00:00.000', 'patientId': {
        'patientIdRoot': '1.2.752.129.2.1.3.1',
        'patientIdExtension': '19121212-1212'
      }
    }, 'vardperson': {
      'hsaId': 'hans', 'namn': 'Hans Njurgren', 'enhetsId': 'dialys',
      ...
      'vardgivarnamn': 'Landstinget Västmanland'
    }, 'status': 'PENDING_EXTERNAL_ACTION', 'vidarebefordrad': false,
  ...
  var testAnswerResponse = {
    ...
    'vardAktorNamn': 'Eva Holgersson', 'intygsReferens': {
      'intygsId': 'intyg-4-revoked', 'intygsTyp': 'luse',
    ...
    'vardperson': {
      'hsaId': 'eva', 'namn': 'Eva Rättare', 'forskrivarKod': '1234567', 'enhetsId': 'centrum-vast',
    ...
    }, 'status': 'CLOSED', 'vidarebefordrad': false,
