...
var commonMessages = {
    'sv': {
        ...
        'common.error.sign.authorization': '<strong>Intyget kunde inte signeras.</strong><br/>Antingen har en annan e-legitimation använts vid signering än vid inloggning, eller så är ni inte inloggad som läkare. Försök signera igen med samma identitet i NetID som användes vid inloggningen.',
