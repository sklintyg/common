...
var commonMessages = {
    'sv': {
        ...
        'common.error.sign.authorization': '<strong>Intyget kunde inte signeras.</strong><br/>Intyget måste signeras med samma e-legitimation som du loggade in med. Kontrollera om du valt rätt och prova igen.',
