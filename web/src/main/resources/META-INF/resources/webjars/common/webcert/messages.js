...
angular.module('common').constant('common.messages', {
    'sv': {
        ...
        'common.createfromtemplate.tooltip': 'Skapar ett utkast av ett ${intygName} för den avlidne.',
        ...
        // Utkast status
        'common.label.intygstatus.is-010': 'Utkastet sparas',
        'common.label.intygstatus.is-011': 'Utkastet är sparat',
        'common.label.intygstatus.is-012': 'Obligatoriska uppgifter saknas',
        'common.label.intygstatus.is-013': 'Klart att signera',
