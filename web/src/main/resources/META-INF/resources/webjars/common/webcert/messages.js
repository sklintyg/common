...
(function() {
  ...
  angular.module('common').constant('common.messages', {
    'sv': {
      ...
      'common.modal.copy.body_new': '<p>' +
          'Genom att kopiera ett låst intygsutkast skapas ett nytt utkast med samma information som i det ursprungliga låsta utkastet. ' +
          'Du kan redigera utkastet innan du signerar det. Det ursprungliga låsta utkastet finns kvar.</p>' +
      ...
      'common.modal.fornya.text': 'Förnya intyg kan användas vid förlängning av en sjukskrivning. ' +
          ...
          'Om intyget är utfärdat på en annan enhet kommer det nya utkastet utfärdas på den enhet du är inloggad på.<br><br>' +
