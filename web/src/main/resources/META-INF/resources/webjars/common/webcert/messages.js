...
(function(){
    ...
    angular.module('common').constant('common.messages', {
        'sv': {
            ...
            'common.label.intygstatus.is-003': 'Intyget har ersatts av <a wc-close-modals href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/">detta intyg</a>',
            'common.label.intygstatus.is-004': 'Intyget är makulerat',
            'common.label.intygstatus.is-005': 'Intyget har kompletterats med ett annat intyg. <a wc-close-modals href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/">Öppna intyget</a>',
            'common.label.intygstatus.is-006': 'Försäkringkassan har begärt komplettering',
            'common.label.intygstatus.is-007': 'Intyget ersatte ett tidigare intyg som också kan behöva makuleras. <a wc-close-modals href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/">Öppna intyget</a>',
            'common.label.intygstatus.is-008': 'Intyget är tillgängligt för patienten',
            'common.label.intygstatus.is-009': 'Det finns redan ett påbörjat utkast som ska ersätta detta intyg. <a wc-close-modals href="#/${intygstyp}/${intygTypeVersion}/edit/${intygsid}/">Öppna utkastet</a>',
            'common.label.intygstatus.is-010': 'Intyget är förnyat utifrån ett tidigare intyg som också kan behöva makuleras. <a wc-close-modals href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/">Öppna intyget</a>',
            'common.label.intygstatus.is-011': 'Intyget är en komplettering av ett tidigare intyg som också kan behöva makuleras. <a wc-close-modals href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/">Öppna intyget</a>',
            'common.label.intygstatus.is-012': 'Det finns redan en påbörjad komplettering. <a wc-close-modals href="#/${intygstyp}/${intygTypeVersion}/edit/${intygsid}/">Öppna utkastet</a>',
            // Utkast status
    ...
    // Status - signed but not sent
            ...
            'common.validation.date.beforeLastYear': 'Datumet får inte vara tidigare än början på förra året',
