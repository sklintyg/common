...
(function(){
    ...
    angular.module('common').constant('common.messages', {
        'sv': {
            ...
            'common.error.sign.only_possible_in_ie': 'Åtgärden kan inte genomföras då signering med SITHS-kort i andra webbläsare än Internet Explorer inte stöds. Intyget har inte signerats.<br><br>Om fortsatt problem kontakta i första hand din lokala IT-avdelning och i andra hand <LINK:ineraKundserviceAnmalFel>.',
