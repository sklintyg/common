...
(function(){
    ...
    angular.module('common').constant('common.messages', {
        'sv': {
            ...
            'common.label.intygstatus.lus-03': 'Det låsta utkastet kopierades från ett tidigare låst utkast som också kan behöva makuleras. <a href="#/intyg/${intygstyp}/${intygTypeVersion}/${intygsid}/?forcelink">Öppna intyget</a>',
