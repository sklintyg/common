...
(function(){
    ...
    angular.module('common').constant('common.messages', {
        'sv': {
            ...
            'common.label.intygstatus.is-012': 'Det finns redan en påbörjad komplettering. <a wc-close-modals href="#/intyg/${intygstyp}/${intygsid}/">Öppna intyget</a>',
            // Utkast status
    ...
    // Status - signed but not sent
            ...
            'db.error.sign.intyg_of_type_exists': '<strong>Intyget kunde inte signeras.</strong><br>Dödsbevis för detta personnummer har utfärdats av någon annan hos annan vårdgivare under tiden du har arbetat med detta utkast. Det är inte möjligt att signera detta dödsbevis.',
        ...
        // fragaSvar errors
            ...
            'common.error.certificateinvalidstate': '<strong>Åtgärden kunde inte slutföras.</strong>Åtgärden ej applicerbar. Ladda om sidan och försök igen. Kontakta supporten om problemet kvarstår.',
