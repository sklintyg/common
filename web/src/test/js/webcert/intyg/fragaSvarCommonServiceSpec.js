describe('fragaSvarCommonService', function() {
    ...
    describe('Mail link', function() {
        ...
        it('should be correct for uthopp role', inject(['common.fragaSvarCommonService', function(fragaSvarCommonService) {
            ...
            expect(link).toEqual("mailto:?subject=En%20fraga-svar%20ska%20besvaras%20i%20Webcert&body=Klicka%20pa%20lanktexten%20for%20att%20besvara%20fraga-svar%3A%0Ahttp%3A%2F%2Flocalhost%3A9876%2Fwebcert%2Fweb%2Fuser%2Fcertificate%2Ftestid%2Fquestions");
        }]));
        ...
        it('should be correct for landsting role', inject(['common.fragaSvarCommonService', function(fragaSvarCommonService) {
            ...
            userModelMock.isTandlakareUthopp = function(){ return false; };
            var link = fragaSvarCommonService.buildMailToLink(qa);
            expect(link).toEqual("mailto:?subject=En%20fraga-svar%20ska%20besvaras%20i%20Webcert&body=Klicka%20pa%20lanktexten%20for%20att%20besvara%20fraga-svar%3A%0Ahttp%3A%2F%2Flocalhost%3A9876%2Fwebcert%2Fweb%2Fuser%2Fbasic-certificate%2Ftestid%2Fquestions");
        }]));
