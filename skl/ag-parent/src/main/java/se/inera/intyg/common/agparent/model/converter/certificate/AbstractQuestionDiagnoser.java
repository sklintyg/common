 ...
 */
package se.inera.intyg.common.agparent.model.converter.certificate;
...
public abstract class AbstractQuestionDiagnoser {
    ...
    protected static CertificateDataElement toCertificate(List<Diagnos> diagnoser, String questionId, String parentId, String textId,
        String descriptionId, int index, CertificateTextProvider textProvider, String showValidationQuestionId,
        String showValidationJsonId) {
            ...
            .validation(
                new CertificateDataValidation[]{
                    ...
                    CertificateDataValidationShow.builder()
                        .questionId(showValidationQuestionId)
                        .expression(singleExpression(showValidationJsonId))
                        .build()
                }
            )
            .build();
