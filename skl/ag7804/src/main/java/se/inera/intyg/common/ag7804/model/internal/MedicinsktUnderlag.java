...
public abstract class MedicinsktUnderlag {
  ...
  @JsonCreator
  public static MedicinsktUnderlag create(
      @JsonProperty("medicinsktUnderlagTyp") MedicinsktUnderlagTyp medicinsktUnderlagTyp,
      @JsonProperty("datum") InternalDate datum,
      @JsonProperty("annanGrund") String annanGrund) {
  ...
  @Nullable public abstract String getAnnanGrundForMedicinsktUnderlag();
