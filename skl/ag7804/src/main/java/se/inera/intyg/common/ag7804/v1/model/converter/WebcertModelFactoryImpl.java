...
public class WebcertModelFactoryImpl implements WebcertModelFactory<Ag7804UtlatandeV1> {
   ...
   * @return {@link Ag7804UtlatandeV1} or throws a ConverterException if something unforeseen
   *     happens
   */
  @Override
  public Ag7804UtlatandeV1 createNewWebcertDraft(CreateNewDraftHolder newDraftData)
    ...
    template.setTextVersion(
        intygTexts.getLatestVersionForSameMajorVersion(
            Ag7804EntryPoint.MODULE_ID, newDraftData.getIntygTypeVersion()));

    return template.setGrundData(grundData).build();
  }

  @Override
  public Ag7804UtlatandeV1 createCopy(CreateDraftCopyHolder copyData, Utlatande template)
      throws ConverterException {
   ...
   */
  private Ag7804UtlatandeV1 createCopyFromAg7804(
      CreateDraftCopyHolder copyData, Ag7804UtlatandeV1 template) throws ConverterException {
    LOG.trace(
        "Creating copy with id {} from a Ag7804UtlatandeV1 with id {}",
   ...
   * @return an Utlatande of type AG7804
   */
  private Ag7804UtlatandeV1 createCopyFromFk7804(
      CreateDraftCopyHolder copyData, LisjpUtlatandeV1 template) throws ConverterException {
    LOG.trace(
        "Creating copy with id {} from a LisjpUtlatandeV1 with id {}",
        copyData.getCertificateId(),
        template.getId());
  ...
  private void populateWithId(Ag7804UtlatandeV1.Builder utlatande, String utlatandeId)
      throws ConverterException {
