...
public class Ag7804TestabilityCertificateTestdataProvider
  ...
  public Map<String, CertificateDataValue> getMinimumValues() {
    ...
    final CertificateDataValueCode shouldIncludeDiagnoses =
        CertificateDataValueCode.builder().code(NO_ID).id(NO_ID).build();
  ...
  public Map<String, CertificateDataValue> getMaximumValues() {
    ...
    final CertificateDataValueCode shouldIncludeDiagnoses =
        CertificateDataValueCode.builder().code(YES_ID).id(YES_ID).build();
    values.put(ONSKAR_FORMEDLA_DIAGNOS_SVAR_ID_100, shouldIncludeDiagnoses);
            ...
            .list(
                Collections.singletonList(
                    CertificateDataValueDate.builder()
                        .id(
                            se.inera.intyg.common.ag7804.converter.RespConstants
                                .GRUNDFORMEDICINSKTUNDERLAG_ANNAT_SVAR_JSON_ID_1)
                        .date(LocalDate.now())
                        .build()))
            .build();
    values.put(
        se.inera.intyg.common.ag7804.converter.RespConstants.GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1,
        baseratPa);
    ...
    final var ovrigt =
        CertificateDataValueText.builder().id(OVRIGT_SVAR_JSON_ID_25).text(EXAMPLE_TEXT).build();
