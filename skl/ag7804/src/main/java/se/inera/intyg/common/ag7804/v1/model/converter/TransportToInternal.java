...
public final class TransportToInternal {
  ...
  private static void setSvar(Ag7804UtlatandeV1.Builder utlatande, Intyg source)
  ...
  private static void handleArbetslivsinriktadeAtgarder(
      List<ArbetslivsinriktadeAtgarder> arbetslivsinriktadeAtgarder, Svar svar)
      throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
        case ARBETSLIVSINRIKTADE_ATGARDER_VAL_DELSVAR_ID_40:
          ...
          arbetslivsinriktadeAtgarder.add(
              ArbetslivsinriktadeAtgarder.create(
                  ArbetslivsinriktadeAtgarder.ArbetslivsinriktadeAtgarderVal.fromId(
                      arbetslivsinriktadeAtgarderValKod)));
          break;
        default:
          throw new IllegalArgumentException();
      }
  ...
  private static void handleArbetslivsinriktadeAtgarderBeskrivning(
      Ag7804UtlatandeV1.Builder utlatande, Svar svar) throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handlePrognos(Ag7804UtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
  ...
  private static void handleForsakringsmedicinsktBeslutsstod(
      Ag7804UtlatandeV1.Builder utlatande, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleBehovAvSjukskrivning(List<Sjukskrivning> sjukskrivningar, Svar svar)
    ...
    for (Delsvar delsvar : svar.getDelsvar()) {
      ...
      if (sjukskrivningsnivaString != null && period != null) {
        sjukskrivningar.add(
            Sjukskrivning.create(SjukskrivningsGrad.fromId(sjukskrivningsnivaString), period));
      }
    }
  }
