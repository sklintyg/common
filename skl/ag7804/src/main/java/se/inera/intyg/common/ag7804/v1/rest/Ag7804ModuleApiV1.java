...
import se.inera.intyg.common.ag7804.v1.testability.Ag7804TestabilityCertificateTestdataProvider;
...
public class Ag7804ModuleApiV1 extends AgParentModuleApi<Ag7804UtlatandeV1> {
  ...
  private void init() {
    try {
      ...
      final var inputStream2 = new ClassPathResource("ag7804-messages.js").getInputStream();
      validationMessages =
    ...
    try {
      ...
      return new PdfGenerator()
          .generatePdf(
              utlatande.getId(),
              internalModel,
              getMajorVersion(utlatande.getTextVersion()),
              personId,
              texts,
              statuses,
              applicationOrigin,
  ...
  @Override
  protected Ag7804UtlatandeV1 getInternal(String internalModel, LocalDateTime created)
      throws ModuleException {
    try {
      final var ag7804UtlatandeV1 = objectMapper.readValue(internalModel, Ag7804UtlatandeV1.class);
  ...
  @Override
  protected RegisterCertificateType internalToTransport(Ag7804UtlatandeV1 utlatande)
  ...
  @Override
  protected Ag7804UtlatandeV1 decorateWithSignature(
      Ag7804UtlatandeV1 utlatande, String base64EncodedSignatureXml) {
  ...
  public Optional<GetCopyFromCriteria> getCopyFromCriteria() {
    return Optional.of(
        new GetCopyFromCriteria(LisjpEntryPoint.MODULE_ID, SUPPORTED_LISJP_MAJOR_VERSION));
  }
  ...
  public String getJsonFromUtlatande(Utlatande utlatande) throws ModuleException {
    if (utlatande instanceof Ag7804UtlatandeV1) {
      return toInternalModelResponse((Ag7804UtlatandeV1) utlatande);
    }
    final var message = utlatande == null ? "null" : utlatande.getClass().toString();
    throw new IllegalArgumentException(
        "Utlatande was not instance of class Ag7804UtlatandeV1, utlatande was instance of class: "
            + message);
  }
  ...
  public String getUpdatedJsonWithTestData(
    ...
    TestabilityToolkit.fillCertificateWithTestData(
        certificate, fillType, new Ag7804TestabilityCertificateTestdataProvider());
    final var updateInternalCertificate =
        CertificateToInternal.convert(certificate, internalCertificate, moduleService);
    return toInternalModelResponse(updateInternalCertificate);
  }
