...
public class QuestionPrognos extends AbstractQuestionPrognos {
  ...
  public static CertificateDataElement toCertificate(
    ...
    final var prognosConfigProvider = new QuestionPrognosConfigProvider(covertValue(prognos));
    return toCertificate(
        prognosConfigProvider, PROGNOS_SVAR_ID_39, CATEGORY_BEDOMNING, index, texts);
  }
