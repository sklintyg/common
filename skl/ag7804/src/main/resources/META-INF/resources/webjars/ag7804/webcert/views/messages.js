...
angular.module('ag7804').constant('ag7804.messages', {
    'sv': {
        ...
        'ag7804.modal.copy-from-candidate.text': 'Det finns ett Läkarintyg för sjukpenning för denna patient som är utfärdat <strong>${createdDate}</strong> på en enhet som du har åtkomst till. Vill du kopiera de svar som givits i det intyget till detta intygsutkast?'
    },
    'en': {
