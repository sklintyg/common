...
angular.module('ag7804').controller('ag7804.CustomizePdfCtrl',
    [ '$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope','ag7804.customizeViewstate', 'common.IntygListService',
        ...
        function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService, dialogService, messageService, $cookies, $http) {
            ...
            $scope.downloadAsPdfLink = '/moduleapi/certificate/ag7804/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId + '/pdf/arbetsgivarutskrift';
