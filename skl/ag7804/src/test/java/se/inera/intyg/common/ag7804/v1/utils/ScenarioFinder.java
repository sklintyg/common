 ...
 */
package se.inera.intyg.common.ag7804.v1.utils;
...
public final class ScenarioFinder {
  ...
  public static List<Scenario> getTransportScenarios(String scenarioWithWildcards)
    ...
    return getScenarios(
        scenarioWithWildcards + TRANSPORT_MODEL_EXT, TRANSPORT_MODEL_PATH, "v1/transport");
  }
  ...
  public static List<Scenario> getInternalScenarios(String scenarioWithWildcards)
      throws ScenarioNotFoundException {
    return getScenarios(
        scenarioWithWildcards + INTERNAL_MODEL_EXT, INTERNAL_MODEL_PATH, "v1/internal");
  }
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    /** {@inheritDoc} */
    @Override
    public Ag7804UtlatandeV1 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), Ag7804UtlatandeV1.class);
      } catch (IOException e) {
