...
class ConverterTest {
  ...
  @Spy private ValidatorUtil validatorUtil = new ValidatorUtil();
  ...
  void doSchematronValidationAg7804() throws Exception {
    String xmlContents =
        Resources.toString(getResource("v1/transport/ag7804.xml"), StandardCharsets.UTF_8);
  ...
  void outputJsonFromXml() throws Exception {
    ...
    RegisterCertificateType transportConvertedALot =
        InternalToTransport.convert(utlatandeFromJson, webcertModuleService);
  ...
  private String getJsonFromTransport(RegisterCertificateType transport) throws ConverterException {
    ...
    Ag7804UtlatandeV1 internal = TransportToInternal.convert(transport.getIntyg());
    try {
