...
public class InternalValidatorTest {
    ...
    static int getNumberOfInternalValidationErrors(ValidateDraftResponse internalValidationResponse) {
    ...
    public void test() throws ScenarioNotFoundException {
        ...
        Ag7804UtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("sjukskrivningOverlappandePerioder").asInternalModel();
