...
class QuestionIntygetBaseratPaTest {
  ...
  class ToCertificate {
    ...
    void shouldExcludeQuestionValueUndersokningPatientenWhenDateIsNotValid() {
      ...
      final var question =
          certificate.getData().get(RespConstants.GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1);
    ...
    void shouldIncludeGrundForMUUndersokningValue(InternalDate expectedValue) {
      ...
      final var certificate =
          CertificateBuilder.create()
              .addElement(
                  se.inera.intyg.common.ag7804.v1.model.converter.certificate.question
                      .QuestionIntygetBaseratPa.toCertificate(utlatande, index, texts))
              .build();
