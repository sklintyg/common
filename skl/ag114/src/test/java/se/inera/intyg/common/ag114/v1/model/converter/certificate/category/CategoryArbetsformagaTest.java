...
import static se.inera.intyg.common.ag114.v1.model.converter.RespConstants.CATEGORY_ARBETSFORMAGA_TEXT_ID;
...
class CategoryArbetsformagaTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryArbetsformaga.toCertificate(0, texts);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return CATEGORY_ARBETSFORMAGA_TEXT_ID;
        }
