...
import static se.inera.intyg.common.ag114.v1.model.converter.RespConstants.CATEGORY_BEDOMNING_TEXT_ID;
...
class CategoryBedomningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryBedomning.toCertificate(0, texts);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return CATEGORY_BEDOMNING_TEXT_ID;
        }
