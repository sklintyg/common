 ...
 */
package se.inera.intyg.common.ag114.v1.pdf;
...
public class IntygTextsAg114RepositoryTestHelper extends IntygTextsRepositoryImpl {
    ...
    public void update()  {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ClassPathResource("v1/text/texterMU_AG114_v1.0.xml").getInputStream());
            ...
            prop.putAll(ImmutableMap.of("formId", "FK 7802 (001 F 001) Fastställd av SKL", "blankettId", "AG1-14", "blankettVersion", "01"));
