...
package se.inera.intyg.common.ag114.v1.model.converter.certificate;

import static org.mockito.Mockito.when;
import static se.inera.intyg.common.ag114.support.Ag114EntryPoint.MODULE_NAME;
import static se.inera.intyg.common.ag114.v1.model.converter.certificate.MetaDataGrundData.toInternal;
...
class MetaDataGrundDataTest {
    ...
    @Nested
    class IncludeCommonMetaDataTest extends CommonMetaDataTest {

        @Override
        protected CertificateMetadata getMetaData() {
            return MetaDataGrundData.toCertificate((Ag114UtlatandeV1) getInternalCertificate(), texts);
        }
        ...
        protected String getTypeName() {
            return Ag114EntryPoint.ISSUER_TYPE_ID;
        }
    }


    @Nested
    class IncludeInternalMetaDataTests extends InternalMetaDataTest {
