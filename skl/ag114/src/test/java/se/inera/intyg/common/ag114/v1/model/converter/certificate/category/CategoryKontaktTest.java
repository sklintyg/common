...
import static se.inera.intyg.common.ag114.v1.model.converter.RespConstants.CATEGORY_KONTAKT_TEXT_ID;
...
class CategoryKontaktTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryKontakt.toCertificate(0, texts);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return CATEGORY_KONTAKT_TEXT_ID;
        }
