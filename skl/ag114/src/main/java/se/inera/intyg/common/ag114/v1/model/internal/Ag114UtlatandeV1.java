...
public abstract class Ag114UtlatandeV1 implements Utlatande {
  ...
  // Fråga 1.1
  @Nullable public abstract List<Sysselsattning> getSysselsattning();
  ...
  // Fråga 5 - Inkludera ...
  @Nullable public abstract String getNedsattArbetsformaga();

  // Fråga 6.1
  @Nullable public abstract Boolean getArbetsformagaTrotsSjukdom();

  // Fråga 6.2
  @Nullable public abstract String getArbetsformagaTrotsSjukdomBeskrivning();

  // Fråga 8
  @Nullable public abstract String getOvrigaUpplysningar();

  // Fråga 7 Bedömning

  @Nullable public abstract String getSjukskrivningsgrad();

  @Nullable public abstract InternalLocalDateInterval getSjukskrivningsperiod();

  // Fråga 9
  @Nullable public abstract Boolean getKontaktMedArbetsgivaren();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setArbetsformagaTrotsSjukdomBeskrivning(
