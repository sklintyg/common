...
public class QuestionSjukskrivningsgrad {
  ...
  public static CertificateDataElement toCertificate(
      String sjukskrivningsgrad, int index, CertificateTextProvider textProvider) {
  ...
  public static String toInternal(Certificate certificate) {
    return integerValue(
        certificate.getData(), SJUKSKRIVNINGSGRAD_SVAR_ID, SJUKSKRIVNINGSGRAD_SVAR_JSON_ID);
  }
}
