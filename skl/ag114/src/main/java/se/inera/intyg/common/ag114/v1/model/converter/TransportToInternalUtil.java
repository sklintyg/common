    ...
    public static void handleDiagnos(List<Diagnos> diagnoser, Svar svar) throws ConverterException {
        ...
        for (Delsvar delsvar : svar.getDelsvar()) {
            ...
            case TYP_AV_DIAGNOS_BESKRIVNING_DELSVAR_ID_4:
                ...
                break;
            case TYP_AV_BIDIAGNOS_1_DELSVAR_ID_4:
                ...
                break;
            case TYP_AV_BIDIAGNOS_1_BESKRIVNING_DELSVAR_ID_4:
                bidiagnosBeskrivning1 = getStringContent(delsvar);
                break;
            case TYP_AV_BIDIAGNOS_2_DELSVAR_ID_4:
                ...
                break;
            case TYP_AV_BIDIAGNOS_2_BESKRIVNING_DELSVAR_ID_4:
