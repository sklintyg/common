...
angular.module('ag114').controller('ag114.CustomizePdfCtrl',
    ['$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope', 'ag114.customizeViewstate',
      ...
      function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService,
        ...
        $scope.downloadAsPdfLink =
            '/moduleapi/certificate/ag114/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId + '/pdf/arbetsgivarutskrift';
