 ...
 */
angular.module('ag114').service('ag114.EditCertCtrl.ViewStateService.v1',
    ['$log', '$state', 'common.UtkastViewStateService', 'ag114.Domain.IntygModel.v1',
        function($log, $state, CommonViewState, IntygModel) {
            ...
            this.reset = function() {
                ...
                CommonViewState.intyg.type = 'ag114';
