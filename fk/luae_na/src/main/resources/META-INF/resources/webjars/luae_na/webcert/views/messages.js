...
angular.module('luae_na').constant('luae_na.messages', {
  'sv': {
    ...
    'luae_na.modal.fornya.text':
        'Förnya intyg innebär att ett nytt intygsutkast skapas med samma information som i det ursprungliga intyget.<br><br>' +
