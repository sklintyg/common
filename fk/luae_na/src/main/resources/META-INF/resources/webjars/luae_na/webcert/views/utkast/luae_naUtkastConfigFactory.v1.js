...
angular.module('luae_na').factory('luae_na.UtkastConfigFactory.v1',
    ['$log', '$timeout',
        ...
        function _getConfig(viewState) {
          ...
          function funktionsnedsattningar() {
            return ['funktionsnedsattningIntellektuell', 'funktionsnedsattningKommunikation', 'funktionsnedsattningKoncentration',
              'funktionsnedsattningPsykisk', 'funktionsnedsattningSynHorselTal', 'funktionsnedsattningBalansKoordination',
