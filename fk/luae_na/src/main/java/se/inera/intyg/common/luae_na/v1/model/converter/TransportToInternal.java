...
public final class TransportToInternal {
  ...
  private static void setSvar(LuaenaUtlatandeV1.Builder utlatande, Intyg source)
  ...
  private static void handleGrundForMedicinsktUnderlag(
      LuaenaUtlatandeV1.Builder utlatande, Svar svar) throws ConverterException {
  ...
  private static void handleFunktionsNedsattningIntellektuell(
      LuaenaUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFormagaTrotsBegransning(
      LuaenaUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
