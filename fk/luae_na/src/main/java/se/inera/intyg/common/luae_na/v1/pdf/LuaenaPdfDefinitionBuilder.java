...
/**
 * Contructs a object graph of PdfComponents that represents a LUAENA intyg. Created by eriklup on
 * 11/01/17.
 *
 * <p>Derived directly from the LUSE PDF definition. The main differences are:
 * <li>All misc parts in the header has been offset by 2 millimeters to the left compared to LUSE.
 * <li>The kategori 1 and kategori 2 sections on page 1 are approx 6.3 mm lower than their LUSE
 *     counterparts.
 * <li>The descriptionary text has gotten a grey background with rounded corners
 */
...
public class LuaenaPdfDefinitionBuilder extends FkBasePdfDefinitionBuilder {
    ...
    try {
      ...
      def.addPageEvent(
          new FkFormPagePersonnummerEventHandlerImpl(
              intyg.getGrundData().getPatient().getPersonId().getPersonnummer(), -2.0f, 0.0f));
      def.addPageEvent(
  ...
  private FkPage createPage1(
    ...
    FkFieldGroup fraga1 =
        new FkFieldGroup("1. " + getText("FRG_1.RBK"))
    ...
    fraga1.addChild(
        new FkCheckbox(
                getText("KV_FKMU_0001.ANHORIG.RBK"),
                intyg.getAnhorigsBeskrivningAvPatienten() != null)
            .offset(0f, checkBoxYOffset)
            .size(CHECKBOX_DEFAULT_WIDTH, CHECKBOXROW_DEFAULT_HEIGHT));
    fraga1.addChild(
        new FkValueField(nullSafeString(intyg.getAnhorigsBeskrivningAvPatienten()))
            .offset(CHECKBOX_DEFAULT_WIDTH, checkBoxYOffset)
            .size(CHECKBOX_DEFAULT_WIDTH, CHECKBOXROW_DEFAULT_HEIGHT)
            .withValueTextAlignment(PdfPCell.ALIGN_MIDDLE));
    ...
    // FRG_2.RBK
    fraga1.addChild(
        new FkLabel(getText("FRG_2.RBK"))
            .offset(0f, 42.8f)
            .size(CHECKBOX_DEFAULT_WIDTH, CHECKBOXROW_DEFAULT_HEIGHT)
            .withBorders(Rectangle.TOP)
            .withVerticalAlignment(Element.ALIGN_BOTTOM));
    fraga1.addChild(
        new FkValueField(nullSafeString(intyg.getKannedomOmPatient()))
    ...
    FkFieldGroup fraga2 =
        new FkFieldGroup("2. " + getText("FRG_3.RBK"))
            .offset(KATEGORI_OFFSET_X, 222.3f)
            .size(KATEGORI_FULL_WIDTH, 63f)
            .withBorders(Rectangle.BOX);
    fraga2.addChild(
        new FkCheckbox("Nej", intyg.getUnderlagFinns() != null && !intyg.getUnderlagFinns())
            .offset(0, 0)
            .withCellWith(6f)
            .size(20.5f, CHECKBOXROW_DEFAULT_HEIGHT));
    fraga2.addChild(
        new FkCheckbox("Ja, fyll i nedan.", safeBoolean(intyg.getUnderlagFinns()))
            .offset(21.5f, 0)
    ...
    for (int i = 0; i < 3; i++) {
      ...
      fraga2.addChild(
          new FkValueField(datum)
              .offset(72.3f, yOffset)
              .size(50f, CHECKBOXROW_DEFAULT_HEIGHT)
              .withBorders(Rectangle.TOP)
              .withTopLabel("datum (år, månad, dag)"));

      // Bifogas Ja/Nej är bara till för manuell/fysisk/pappers ifyllnad och skall därför alltid
      // vara ej ifylld i
      // vårt fall.
      fraga2.addChild(
          new FkLabel("Bifogas")
      ...
      fraga2.addChild(
          new FkValueField(nullSafeString(hamtasFran))
              .offset(0, yOffset)
  ...
  private void addPage1MiscFields(
      LuaenaUtlatandeV1 intyg,
      boolean isUtkast,
      boolean isLocked,
      boolean showFkAddress,
    ...
    FkLabel mainHeader =
        new FkLabel("Läkarutlåtande")
            .offset(105.5f, 10f)
            .size(40, 12f)
            .withVerticalAlignment(Element.ALIGN_TOP)
            .withFont(PdfConstants.FONT_FRAGERUBRIK);
    FkLabel subHeader =
        new FkLabel("för aktivitetsersättning vid nedsatt arbetsförmåga")
            .offset(105.5f, 14f)
            .size(80, 15)
            .withVerticalAlignment(Element.ALIGN_TOP)
            .withFont(PdfConstants.FONT_BOLD_9);
    ...
    if (showFkAddress) {
      FkLabel skickaBlankettenTillLbl =
          new FkLabel("Skicka blanketten till")
              .offset(111.2f, 37.5f)
              .size(35f, 5f)
              .withVerticalAlignment(Element.ALIGN_TOP)
              .withFont(PdfConstants.FONT_STAMPER_LABEL);
      ...
      FkLabel inlasningsCentralRad1 =
          new FkLabel("Försäkringskassans inläsningscentral")
              .withVerticalAlignment(Element.ALIGN_TOP)
              .size(60f, 6f)
              .offset(111.2f, 42f);
      FkLabel inlasningsCentralRad2 =
          new FkLabel("839 88 Östersund")
              .withVerticalAlignment(Element.ALIGN_TOP)
              .size(60f, 6f)
    ...
    FkLabel luaenaDescriptonText =
        new FkLabel(getText("FRM_2.RBK"))
  ...
  private FkPage createPage2(LuaenaUtlatandeV1 intyg) throws IOException, DocumentException {
    ...
    FkFieldGroup fraga3 =
        new FkFieldGroup("3. " + getText("FRG_6.RBK"))
    ...
    FkOverflowableValueField narOchHur =
        new FkOverflowableValueField(intyg.getDiagnosgrund(), getText("FRG_7.RBK"))
    ...
    FkCheckbox noCheckbox =
        new FkCheckbox(
                "Nej",
                intyg.getNyBedomningDiagnosgrund() != null && !intyg.getNyBedomningDiagnosgrund())
            .size(24.5f, 11f)
            .offset(0f, CHECKBOX_UNDER_TOPLABEL_PADDING)
            .withBorders(Rectangle.NO_BORDER);
    FkCheckbox yesCheckbox =
        new FkCheckbox("Ja. Fyll i nedan.", safeBoolean(intyg.getNyBedomningDiagnosgrund()))
            .size(84.5f, 11f)
    ...
    FkOverflowableValueField vilkenAvses =
        new FkOverflowableValueField(intyg.getDiagnosForNyBedomning(), getText("DFR_45.2.RBK"))
            .size(KATEGORI_FULL_WIDTH, 12f)
            .offset(0f, 67.5f)
            .showLabelOnTop();
    ...
    FkFieldGroup fraga4 =
        new FkFieldGroup("4. " + getText("FRG_5.RBK"))
            .offset(KATEGORI_OFFSET_X, 116f)
            .size(KATEGORI_FULL_WIDTH, 22.5f)
            .withBorders(Rectangle.BOX);

    FkOverflowableValueField bakgrund =
        new FkOverflowableValueField(intyg.getSjukdomsforlopp(), getText("FRG_5.RBK"))
    ...
    FkFieldGroup fraga5 =
        new FkFieldGroup("5. " + getText("DFR_10.1.RBK"))
    ...
    fraga5.addChild(
        new FkOverflowableValueField(
                intyg.getFunktionsnedsattningIntellektuell(), getText("FRG_8.RBK"))
    ...
    fraga5.addChild(
        new FkOverflowableValueField(
                intyg.getFunktionsnedsattningKommunikation(), getText("FRG_9.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
    ...
    fraga5.addChild(
        new FkLabel(getText("FRG_10.RBK"))
            .offset(0, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_RUBRIK_HEIGHT)
            .withBorders(Rectangle.BOX));
    fraga5YOffset += FRAGA_5_DELFRAGA_RUBRIK_HEIGHT;
    ...
    fraga5.addChild(
        new FkOverflowableValueField(
                intyg.getFunktionsnedsattningKoncentration(), getText("FRG_10.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
    fraga5YOffset += FRAGA_5_DELFRAGA_HEIGHT;
    ...
    fraga5YOffset += FRAGA_5_DELFRAGA_RUBRIK_HEIGHT;
    fraga5.addChild(
        new FkOverflowableValueField(intyg.getFunktionsnedsattningPsykisk(), getText("FRG_11.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
  ...
  private FkPage createPage3(LuaenaUtlatandeV1 intyg) throws IOException, DocumentException {
    ...
    fraga5.addChild(
        new FkOverflowableValueField(
                intyg.getFunktionsnedsattningSynHorselTal(), getText("FRG_12.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
    fraga5YOffset += FRAGA_5_DELFRAGA_HEIGHT;
    ...
    fraga5.addChild(
        new FkLabel(getText("FRG_13.RBK"))
            .offset(0, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_RUBRIK_HEIGHT)
            .withBorders(Rectangle.BOX));
    fraga5YOffset += FRAGA_5_DELFRAGA_RUBRIK_HEIGHT;
    ...
    fraga5.addChild(
        new FkOverflowableValueField(
                intyg.getFunktionsnedsattningBalansKoordination(), getText("FRG_13.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
    fraga5YOffset += FRAGA_5_DELFRAGA_HEIGHT;
    ...
    fraga5.addChild(
        new FkLabel(getText("FRG_14.RBK"))
            .offset(0, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_RUBRIK_HEIGHT)
            .withBorders(Rectangle.BOX));
    fraga5YOffset += FRAGA_5_DELFRAGA_RUBRIK_HEIGHT;
    ...
    fraga5.addChild(
        new FkOverflowableValueField(intyg.getFunktionsnedsattningAnnan(), getText("FRG_14.RBK"))
            .offset(0f, fraga5YOffset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_5_DELFRAGA_HEIGHT));
    ...
    // Ge konkreta exempel
    fraga6.addChild(
        new FkOverflowableValueField(intyg.getAktivitetsbegransning(), getText("DFR_17.1.RBK"))
            .offset(0f, 0f)
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga7 =
        new FkFieldGroup("7. " + getText("KAT_7.RBK"))
    ...
    fraga7.addChild(
        new FkLabel(getText("FRG_18.RBK") + ". " + getText("DFR_18.1.RBK"))
    ...
    fraga7.addChild(
        new FkOverflowableValueField(
                intyg.getAvslutadBehandling(),
                getText("FRG_18.RBK") + ". " + getText("DFR_18.1.RBK"))
    ...
    fraga7.addChild(
        new FkLabel(getText("FRG_19.RBK") + ". " + getText("DFR_19.1.RBK"))
            .offset(0, fraga7Offset)
    ...
    fraga7.addChild(
        new FkLabel(getText("FRG_20.RBK") + ". " + getText("DFR_20.1.RBK"))
            .offset(0, fraga7Offset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_7_DELFRAGA_RUBRIK_HEIGHT));
    fraga7Offset += FRAGA_7_DELFRAGA_RUBRIK_HEIGHT;
    ...
    fraga7.addChild(
        new FkLabel(getText("FRG_21.RBK") + " (" + getText("DFR_21.1.RBK") + ")")
            .offset(0, fraga7Offset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_7_DELFRAGA_RUBRIK_HEIGHT));
    fraga7Offset += FRAGA_7_DELFRAGA_RUBRIK_HEIGHT;
    ...
    fraga7.addChild(
        new FkOverflowableValueField(
                intyg.getSubstansintag(),
                getText("FRG_21.RBK") + " (" + getText("DFR_21.1.RBK") + ")")
            .offset(0f, fraga7Offset)
            .size(KATEGORI_FULL_WIDTH, FRAGA_7_DELFRAGA_HEIGHT));
  ...
  private FkPage createPage4(LuaenaUtlatandeV1 intyg) throws IOException, DocumentException {
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga8 =
        new FkFieldGroup("8. " + getText("KAT_8.RBK"))
            .offset(KATEGORI_OFFSET_X, 26f)
            .size(KATEGORI_FULL_WIDTH, 81f) // 27*3
            .withBorders(Rectangle.BOX);

    fraga8.addChild(
        new FkLabel(getText("FRG_22.RBK"))
            .offset(0, 0)
    ...
    fraga8.addChild(
        new FkOverflowableValueField(
                intyg.getMedicinskaForutsattningarForArbete(), getText("FRG_22.RBK"))
            .offset(0f, 6.5f)
            .size(KATEGORI_FULL_WIDTH, FRAGA_8_DELFRAGA_HEIGHT - 6.5f));

    fraga8.addChild(
        new FkLabel(getText("FRG_23.RBK"))
            ...
            .withBorders(Rectangle.TOP));
    fraga8.addChild(
        new FkOverflowableValueField(intyg.getFormagaTrotsBegransning(), getText("FRG_23.RBK"))
            .offset(0f, FRAGA_8_DELFRAGA_HEIGHT + 4f)
            .size(KATEGORI_FULL_WIDTH, FRAGA_8_DELFRAGA_HEIGHT - 4f));

    fraga8.addChild(
        new FkLabel(getText("FRG_24.RBK"))
            ...
            .withBorders(Rectangle.TOP));
    fraga8.addChild(
        new FkOverflowableValueField(intyg.getForslagTillAtgard(), getText("FRG_24.RBK"))
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga9 =
        new FkFieldGroup("9. " + getText("FRG_25.RBK"))
    ...
    FkFieldGroup fraga10 =
        new FkFieldGroup("10. " + getText("FRG_26.RBK"))
    ...
    FkFieldGroup fraga11 =
        new FkFieldGroup("11. Underskrift")
    ...
    fraga11.addChild(
        new FkLabel("Underskriften omfattar samtliga uppgifter i intyget.")
            .offset(3f, 92f)
