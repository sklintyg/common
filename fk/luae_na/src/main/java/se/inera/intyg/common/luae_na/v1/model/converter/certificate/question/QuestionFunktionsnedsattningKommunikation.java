...
public class QuestionFunktionsnedsattningKommunikation {
    ...
    public static CertificateDataElement toCertificate(String funktionsnedsattningKommunikation, int index,
        ...
        return CertificateDataElement.builder()
            .id(FUNKTIONSNEDSATTNING_KOMMUNIKATION_DELSVAR_ID_9)
            .parent(FUNKTIONSNEDSATTNING_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigTextArea.builder()
                    .text(textProvider.get(FUNKTIONSNEDSATTNING_KOMMUNIKATION_TEXT_ID))
                    .description(textProvider.get(FUNKTIONSNEDSATTNING_KOMMUNIKATION_DESCRIPTION_ID))
                    .accordion(
                        Accordion.builder()
                            .openText(FUNKTIONSNEDSATTNING_ACCORDION_OPEN_TEXT)
                            .closeText(FUNKTIONSNEDSATTNING_ACCORDION_CLOSE_TEXT)
                            .header(textProvider.get(FUNKTIONSNEDSATTNING_KOMMUNIKATION_DELSVAR_TEXT_ID))
                            .build()
                    )
                    .id(FUNKTIONSNEDSATTNING_KOMMUNIKATION_SVAR_JSON_ID_9)
                    .build()
            )
            .value(
                CertificateDataTextValue.builder()
                    .id(FUNKTIONSNEDSATTNING_KOMMUNIKATION_SVAR_JSON_ID_9)
                    .text(funktionsnedsattningKommunikation)
                    .build()
            )
            .validation(
    ...
    public static String toInternal(Certificate certificate) {
        return ValueToolkit.textValue(certificate.getData(), FUNKTIONSNEDSATTNING_KOMMUNIKATION_DELSVAR_ID_9,
