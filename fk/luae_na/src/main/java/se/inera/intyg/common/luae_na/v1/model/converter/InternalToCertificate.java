...
import se.inera.intyg.common.luae_na.v1.model.converter.certificate.category.CategoryAktivitetsbegransningar;
...
import se.inera.intyg.common.luae_na.v1.model.converter.certificate.question.QuestionAktivitetsbegransningarHeader;
...
public class InternalToCertificate {
  ...
  public static Certificate toCertificate(
      LuaenaUtlatandeV1 internalCertificate, CertificateTextProvider textProvider) {
    int index = 0;
    return CertificateBuilder.create()
        ...
        .addElement(
            QuestionNyBedomningDiagnosgrund.toCertificate(
                internalCertificate.getNyBedomningDiagnosgrund(), index++, textProvider))
        .addElement(
            QuestionDiagnosForNyBedomning.toCertificate(
        ...
        .addElement(CategoryMedicinskaForutsattningarArbete.toCertificate(index++, textProvider))
        .addElement(
        ...
        .addElement(
            QuestionForslagTillAtgard.toCertificate(
                internalCertificate.getForslagTillAtgard(), index++, textProvider))
