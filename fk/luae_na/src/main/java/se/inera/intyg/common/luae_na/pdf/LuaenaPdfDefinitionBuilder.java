...
public class LuaenaPdfDefinitionBuilder extends FkBasePdfDefinitionBuilder {
    ...
    public FkPdfDefinition buildPdfDefinition(LuaenaUtlatande intyg, List<Status> statuses, ApplicationOrigin applicationOrigin, IntygTexts intygTexts)
    ...
    private FkPage createPage1(LuaenaUtlatande intyg, List<Status> statuses, ApplicationOrigin applicationOrigin) throws IOException, DocumentException {
    ...
    private void addPage1MiscFields(LuaenaUtlatande intyg, boolean showFkAddress, List<PdfComponent> allElements) throws IOException {
    ...
    private FkPage createPage2(LuaenaUtlatande intyg) throws IOException, DocumentException {
    ...
    private FkPage createPage3(LuaenaUtlatande intyg) throws IOException, DocumentException {
    ...
    private FkPage createPage4(LuaenaUtlatande intyg) throws IOException, DocumentException {
