...
public class InternalDraftValidatorImpl implements InternalDraftValidator<LuaenaUtlatandeV1> {
  ...
  private void validateGrundForMU(
      LuaenaUtlatandeV1 utlatande, List<ValidationMessage> validationMessages) {
      ...
      if (dateIsValid && checkIfNotFuture(utlatande.getKannedomOmPatient().asLocalDate())) {
        if (utlatande.getUndersokningAvPatienten() != null
          ...
          ValidatorUtil.addValidationErrorWithQuestionId(
              ...
              "luae_na.validation.grund-for-mu.kannedom.after",
      ...
      if (underlag.getTyp() == null) {
        ValidatorUtil.addValidationErrorWithQuestionId(
          ...
          && !underlag
              .getTyp()
              .getId()
              .equals(Underlag.UnderlagsTyp.UNDERLAG_FRANSKOLHALSOVARD.getId())
          && !underlag
              .getTyp()
              .getId()
  ...
  private void validateDiagnosgrund(
    ...
    if (Strings.nullToEmpty(utlatande.getDiagnosgrund()).trim().isEmpty()) {
      ValidatorUtil.addValidationErrorWithQuestionId(
          validationMessages,
          CATEGORY_DIAGNOS,
          DIAGNOSGRUND_SVAR_JSON_ID_7,
          ValidationMessageType.EMPTY,
          DIAGNOSGRUND_SVAR_ID_7);
    }
    ...
    if (utlatande.getNyBedomningDiagnosgrund() == null) {
      ValidatorUtil.addValidationErrorWithQuestionId(
          validationMessages,
          CATEGORY_DIAGNOS,
          DIAGNOSGRUND_NY_BEDOMNING_SVAR_JSON_ID_45,
          ValidationMessageType.EMPTY,
    ...
    if (utlatande.getNyBedomningDiagnosgrund() != null
      ...
      ValidatorUtil.addValidationErrorWithQuestionId(
          ...
          ValidationMessageType.EMPTY,
          DIAGNOS_FOR_NY_BEDOMNING_DELSVAR_ID_45);
    }
  ...
  private void validateBlanksForOptionalFields(
    ...
    if (ValidatorUtil.isBlankButNotNull(utlatande.getForslagTillAtgard())) {
      ValidatorUtil.addValidationErrorWithQuestionId(
          validationMessages,
          CATEGORY_MEDICINSKAFORUTSATTNINGARFORARBETE,
          FORSLAG_TILL_ATGARD_SVAR_JSON_ID_24,
    ...
    if (ValidatorUtil.isBlankButNotNull(utlatande.getSubstansintag())) {
      ValidatorUtil.addValidationErrorWithQuestionId(
          validationMessages,
          CATEGORY_MEDICINSKABEHANDLINGAR,
          SUBSTANSINTAG_SVAR_JSON_ID_21,
          ValidationMessageType.BLANK,
          SUBSTANSINTAG_SVAR_ID_21);
    }
