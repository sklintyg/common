...
@Component(value = "luae_na.SvarIdHelperImpl.v1")
public class SvarIdHelperImpl implements SvarIdHelper<LuaenaUtlatandeV1> {

    @Override
    public List<String> calculateFrageIdHandleForGrundForMU(LuaenaUtlatandeV1 utlatande) {
