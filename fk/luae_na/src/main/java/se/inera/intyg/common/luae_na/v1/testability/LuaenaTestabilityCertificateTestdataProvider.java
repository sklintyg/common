 ...
 */
package se.inera.intyg.common.luae_na.v1.testability;
...
public class LuaenaTestabilityCertificateTestdataProvider
  ...
  public Map<String, CertificateDataValue> getMinimumValues() {
    ...
    final var nyBedomningDiagnosgrund =
        getDataValueBoolean(DIAGNOSGRUND_NY_BEDOMNING_SVAR_JSON_ID_45, false);
    ...
    final var aktivitetsbegransning =
        getDataValueText(AKTIVITETSBEGRANSNING_SVAR_JSON_ID_17, "aktivitetsbegransning");
  ...
  public Map<String, CertificateDataValue> getMaximumValues() {
    ...
    final var motivering =
        getDataValueText(
            se.inera.intyg.common.luae_na.v1.model.converter.RespConstants
    ...
    final var nyBedomningDiagnosgrund =
        getDataValueBoolean(DIAGNOSGRUND_NY_BEDOMNING_SVAR_JSON_ID_45, true);
    values.put(NYDIAGNOS_SVAR_ID_45, nyBedomningDiagnosgrund);

    final var vilkaDiagnoser =
        getDataValueText(
            DIAGNOS_FOR_NY_BEDOMNING_SVAR_JSON_ID_45,
    ...
    final var funktionsnedsattningKoncentration =
        getDataValueText(
            FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_JSON_ID_10,
    ...
    final var funktionsnedsattningPsykisk =
        getDataValueText(
            FUNKTIONSNEDSATTNING_PSYKISK_SVAR_JSON_ID_11, "funktionsnedsattning psykisk");
    values.put(FUNKTIONSNEDSATTNING_PSYKISK_SVAR_ID_11, funktionsnedsattningPsykisk);

    final var funktionsnedsattningSynHorselTal =
        getDataValueText(
            FUNKTIONSNEDSATTNING_SYNHORSELTAL_SVAR_JSON_ID_12, "funktionsnedsattning synHorselTal");
    ...
    values.put(
        FUNKTIONSNEDSATTNING_BALANSKOORDINATION_SVAR_ID_13, funktionsnedsattningbalansKoordination);

    final var funktionsnedsattningAnnan =
        getDataValueText(
            FUNKTIONSNEDSATTNING_ANNAN_SVAR_JSON_ID_14, "funktionsnedsattning synHorselTal");
    ...
    final var avslutadBehandling =
        getDataValueText(AVSLUTADBEHANDLING_SVAR_JSON_ID_18, "avslutad behandling");
    values.put(AVSLUTADBEHANDLING_DELSVAR_ID_18, avslutadBehandling);

    final var pagaendeBehandling =
        getDataValueText(PAGAENDEBEHANDLING_SVAR_JSON_ID_19, "pågående behandling");
    values.put(PAGAENDEBEHANDLING_DELSVAR_ID_19, pagaendeBehandling);

    final var planeradBehandling =
        getDataValueText(PLANERADBEHANDLING_SVAR_JSON_ID_20, "planerad behandling");
    ...
    final var trotsBegransningar =
        getDataValueText(FORMAGATROTSBEGRANSNING_SVAR_JSON_ID_23, "förmåga trots begränsningar");
    values.put(FORMAGATROTSBEGRANSNING_SVAR_ID_23, trotsBegransningar);

    final var forslagTillAtgard =
        getDataValueText(FORSLAG_TILL_ATGARD_SVAR_JSON_ID_24, "förslag till åtgärd");
    ...
    final var kontaktOnskas =
        getDataValueBoolean(
            se.inera.intyg.common.luae_na.v1.model.converter.RespConstants
                .KONTAKT_ONSKAS_SVAR_JSON_ID_26,
            true);
    values.put(
        se.inera.intyg.common.luae_na.v1.model.converter.RespConstants.KONTAKT_ONSKAS_SVAR_ID_26,
        kontaktOnskas);

    final var anledningTillKontakt =
        getDataValueText(ANLEDNING_TILL_KONTAKT_DELSVAR_JSON_ID_26, "anledning till kontakt");
    values.put(ANLEDNING_TILL_KONTAKT_DELSVAR_ID_26, anledningTillKontakt);

    return values;
  }

  private static CertificateDataValueMedicalInvestigation getValueMedicalInvestigation(
      int id, String code, String text) {
