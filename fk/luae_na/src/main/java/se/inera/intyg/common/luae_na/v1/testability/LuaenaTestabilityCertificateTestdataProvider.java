...
public class LuaenaTestabilityCertificateTestdataProvider implements TestabilityCertificateTestdataProvider {
    ...
    public Map<String, CertificateDataValue> getMaximumValues() {
        ...
        final var motivering = getDataValueText(
            se.inera.intyg.common.luae_na.v1.model.converter.RespConstants.MOTIVERING_TILL_INTE_BASERAT_PA_UNDERLAG_ID_1, "motivering");
        ...
        final var kontaktOnskas = getDataValueBoolean(
            se.inera.intyg.common.luae_na.v1.model.converter.RespConstants.KONTAKT_ONSKAS_SVAR_JSON_ID_26, true);
        values.put(se.inera.intyg.common.luae_na.v1.model.converter.RespConstants.KONTAKT_ONSKAS_SVAR_ID_26, kontaktOnskas);
