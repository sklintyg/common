...
@Component(value = "luae_na.LuaefsModelCompareUtil.v1")
public class LuaenaModelCompareUtil extends FkParentModelCompareUtil implements ModelCompareUtil<LuaenaUtlatandeV1> {

    @Override
    public boolean isValidForNotification(LuaenaUtlatandeV1 utlatande) {
