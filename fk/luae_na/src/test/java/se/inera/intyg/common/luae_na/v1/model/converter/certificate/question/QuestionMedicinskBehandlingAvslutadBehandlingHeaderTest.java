...
import static se.inera.intyg.common.luae_na.v1.model.converter.RespConstants.AVSLUTADBEHANDLING_SVAR_TEXT;
...
class QuestionMedicinskBehandlingAvslutadBehandlingHeaderTest {
  ...
  class ToCertificate {
    ...
    void shouldIncludeId() {
      final var question =
          QuestionMedicinskBehandlingAvslutadBehandlingHeader.toCertificate(0, texts);
      assertEquals(AVSLUTADBEHANDLING_SVAR_ID_18, question.getId());
    }
    ...
    void shouldIncludeIndex() {
      ...
      final var question =
          QuestionMedicinskBehandlingAvslutadBehandlingHeader.toCertificate(expectedIndex, texts);
    ...
    void shouldIncludeText() {
      ...
      verify(texts, atLeastOnce()).get(AVSLUTADBEHANDLING_SVAR_TEXT);
    }
