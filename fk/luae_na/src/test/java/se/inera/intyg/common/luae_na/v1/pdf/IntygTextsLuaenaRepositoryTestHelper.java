    ...
    try {
      Document e =
          DocumentBuilderFactory.newInstance()
              .newDocumentBuilder()
              .parse(new ClassPathResource("v1/text/texterMU_LUAE_NA_v1.0.xml").getInputStream());
      ...
      prop.putAll(
          ImmutableMap.of(
              "formId", "FK 7801 (001 F 001) Fastställd av Försäkringskassan",
              "blankettId", "7801",
              "blankettVersion", "01"));
      ...
      prop.putAll(
          ImmutableMap.of(
              "formId", "FK 7801 (003 F 001) Fastställd av Försäkringskassan",
