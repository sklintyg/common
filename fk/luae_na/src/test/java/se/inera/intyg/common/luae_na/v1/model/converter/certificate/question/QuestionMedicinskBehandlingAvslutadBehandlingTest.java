...
class QuestionMedicinskBehandlingAvslutadBehandlingTest {
  ...
  class ToCertificate {
    ...
    void shouldIncludeId() {
      final var question =
          QuestionMedicinskBehandlingAvslutadBehandling.toCertificate(null, 0, texts);

      assertEquals(AVSLUTADBEHANDLING_DELSVAR_ID_18, question.getId());
    }
    ...
    void shouldIncludeIndex() {
      ...
      final var question =
          QuestionMedicinskBehandlingAvslutadBehandling.toCertificate(null, expectedIndex, texts);
    ...
    void shouldIncludeConfigId() {
      ...
      assertEquals(AVSLUTADBEHANDLING_SVAR_JSON_ID_18, config.getId());
    }
    ...
    void shouldIncludeConfigText() {
      ...
      verify(texts, atLeastOnce()).get(AVSLUTADBEHANDLING_DELSVAR_TEXT);
    }
    ...
    void shouldIncludeValueText() {
      ...
      final var question =
          QuestionMedicinskBehandlingAvslutadBehandling.toCertificate(expectedText, 0, texts);
      final var value = (CertificateDataValueText) question.getValue();
  ...
  class ToInternal {
    ...
    void shouldIncludeTextValue(String expectedValue) {
      ...
      final var actualValue = QuestionMedicinskBehandlingAvslutadBehandling.toInternal(certificate);
