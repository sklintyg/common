...
class QuestionMedicinskBehandlingAvslutadBehandlingTest {
    ...
    class ToCertificate {
        ...
        void shouldIncludeIndex() {
            ...
            final var question = QuestionMedicinskBehandlingAvslutadBehandling.toCertificate(null, expectedIndex, texts);
    ...
    class ToInternal {
        ...
        void shouldIncludeTextValue(String expectedValue) {
            final var certificate = CertificateBuilder.create()
                .addElement(QuestionMedicinskBehandlingAvslutadBehandling.toCertificate(expectedValue, 0, texts))
                .build();
