 ...
 */
package se.inera.intyg.common.luae_na.v1.model.util;
...
import se.inera.intyg.common.luae_na.v1.model.internal.LuaenaUtlatandeV1.Builder;
...
public class LuaenaModelCompareUtilTest {
    ...
    public void testModelIsValid() throws Exception {
        LuaenaUtlatandeV1 utlatande = getUtlatandeFromFile("utlatande");
    ...
    public void testModelIsValidDiagnoskodChanged() throws Exception {
        LuaenaUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld.toBuilder();
        LuaenaUtlatandeV1 utlatandeNew = builder.setDiagnoser(Arrays.asList(Diagnos.create("A00-", "KSH_97_P", "Kolera", ""))).build();
    ...
    public void testModelIsInvalidDiagnosInvalid() throws Exception {
        LuaenaUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld.toBuilder();
        LuaenaUtlatandeV1 utlatandeNew = builder.setDiagnoser(Arrays.asList(Diagnos.create("BLAH", "ICD_10_SE", "Klämskada skuldra", ""))).build();
    ...
    public void testModelIsInvalidWithInvalidDate() throws Exception {
        LuaenaUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld .toBuilder();
        LuaenaUtlatandeV1 utlatandeNew = builder.setUndersokningAvPatienten(new InternalDate("2016-1")).build();

        assertFalse(modelCompareUtil.isValidForNotification(utlatandeNew));
    }


    private LuaenaUtlatandeV1 getUtlatandeFromFile(String file) throws IOException {
        return objectMapper.readValue(new ClassPathResource(
                "v1/LuaenaModelCompareUtil/" + file + ".json").getFile(), LuaenaUtlatandeV1.class);
    }
