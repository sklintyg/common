...
class QuestionFunktionsnedsattningKommunikationTest {
    ...
    class ToCertificate {
        ...
        void shouldIncludeId() {
            ...
            assertEquals(FUNKTIONSNEDSATTNING_KOMMUNIKATION_DELSVAR_ID_9, question.getId());
        }
        ...
        void shouldIncludeConfigAccordionHeader() {
            ...
            verify(texts, atLeastOnce()).get(FUNKTIONSNEDSATTNING_KOMMUNIKATION_DELSVAR_TEXT_ID);
        }
