...
class QuestionMedicinskBehandlingPagaendeBehandlingTest {
    ...
    class ToCertificate {
        ...
        void shouldIncludeId() {
            ...
            assertEquals(PAGAENDEBEHANDLING_DELSVAR_ID_19, question.getId());
        }
        ...
        void shouldIncludeIndex() {
            ...
            final var question = QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(null, expectedIndex, texts);
        ...
        void shouldIncludeConfigId() {
            ...
            assertEquals(PAGAENDEBEHANDLING_SVAR_JSON_ID_19, config.getId());
        }
        ...
        void shouldIncludeConfigText() {
            ...
            verify(texts, atLeastOnce()).get(PAGAENDEBEHANDLING_DELSVAR_TEXT);
        }
        ...
        void shouldIncludeValueId() {
            ...
            assertEquals(PAGAENDEBEHANDLING_SVAR_JSON_ID_19, value.getId());
        }

        @Test
        void shouldIncludeValueText() {
            final var expectedText = "Annan text";
            final var question = QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(expectedText, 0, texts);
            final var value = (CertificateDataTextValue) question.getValue();
    ...
    class ToInternal {
        ...
        void shouldIncludeTextValue(String expectedValue) {
            final var certificate = CertificateBuilder.create()
                .addElement(QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(expectedValue, 0, texts))
                .build();
