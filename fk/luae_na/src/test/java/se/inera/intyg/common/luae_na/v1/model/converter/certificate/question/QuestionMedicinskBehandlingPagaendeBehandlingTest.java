...
class QuestionMedicinskBehandlingPagaendeBehandlingTest {
  ...
  class ToCertificate {
    ...
    void shouldIncludeId() {
      final var question =
          QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(null, 0, texts);
    ...
    void shouldIncludeIndex() {
      ...
      final var question =
          QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(null, expectedIndex, texts);
    ...
    void shouldIncludeValueText() {
      ...
      final var question =
          QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(expectedText, 0, texts);
      final var value = (CertificateDataValueText) question.getValue();
