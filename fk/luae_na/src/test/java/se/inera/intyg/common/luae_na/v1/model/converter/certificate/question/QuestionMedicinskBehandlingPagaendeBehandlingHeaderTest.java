...
class QuestionMedicinskBehandlingPagaendeBehandlingHeaderTest {
  ...
  class ToCertificate {
    ...
    void shouldIncludeId() {
      final var question =
          QuestionMedicinskBehandlingPagaendeBehandlingHeader.toCertificate(0, texts);
    ...
    void shouldIncludeIndex() {
      ...
      final var question =
          QuestionMedicinskBehandlingPagaendeBehandlingHeader.toCertificate(expectedIndex, texts);
