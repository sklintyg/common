...
import static se.inera.intyg.common.fkparent.model.converter.RespConstants.FUNKTIONSNEDSATTNING_INTELLEKTUELL_DELSVAR_TEXT_ID;
import static se.inera.intyg.common.fkparent.model.converter.RespConstants.FUNKTIONSNEDSATTNING_INTELLEKTUELL_DESCRIPTION_ID;
...
import static se.inera.intyg.common.fkparent.model.converter.RespConstants.FUNKTIONSNEDSATTNING_INTELLEKTUELL_TEXT_ID;
...
class QuestionFunktionsnedsattningIntellektuellTest {
    ...
    class ToCertificate {
        ...
        void shouldIncludeIndex() {
            ...
            final var question = QuestionFunktionsnedsattningIntellektuell.toCertificate(null, expectedIndex, texts);
        ...
        void shouldIncludeConfigId() {
            ...
            assertEquals(FUNKTIONSNEDSATTNING_INTELLEKTUELL_SVAR_JSON_ID_8, config.getId());
        }
        ...
        void shouldIncludeConfigText() {
            ...
            verify(texts, atLeastOnce()).get(FUNKTIONSNEDSATTNING_INTELLEKTUELL_TEXT_ID);
        }
        ...
        void shouldIncludeConfigDescription() {
            ...
            verify(texts, atLeastOnce()).get(FUNKTIONSNEDSATTNING_INTELLEKTUELL_DESCRIPTION_ID);
        }
        ...
        void shouldIncludeValueId() {
            ...
            assertEquals(FUNKTIONSNEDSATTNING_INTELLEKTUELL_SVAR_JSON_ID_8, value.getId());
        }

        @Test
        void shouldIncludeValueText() {
            final var expectedText = "Annan text";
            final var question = QuestionFunktionsnedsattningIntellektuell.toCertificate(expectedText, 0, texts);
            final var value = (CertificateDataTextValue) question.getValue();
    ...
    class ToInternal {
        ...
        void shouldIncludeTextValue(String expectedValue) {
            final var certificate = CertificateBuilder.create()
                .addElement(QuestionFunktionsnedsattningIntellektuell.toCertificate(expectedValue, 0, texts))
                .build();

            final var actualValue = QuestionFunktionsnedsattningIntellektuell.toInternal(certificate);
