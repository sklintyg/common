...
@Component(value = "luse.LuseModelCompareUtil.v1")
public class LuseModelCompareUtil extends FkParentModelCompareUtil implements ModelCompareUtil<LuseUtlatandeV1> {

    @Override
    public boolean isValidForNotification(LuseUtlatandeV1 utlatande) {
