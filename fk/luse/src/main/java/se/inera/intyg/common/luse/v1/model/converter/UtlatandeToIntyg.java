...
public final class UtlatandeToIntyg {
  ...
  public static Intyg convert(
      LuseUtlatandeV1 utlatande, WebcertModuleService webcertModuleService) {
  ...
  private static List<Svar> getSvar(
      LuseUtlatandeV1 source, WebcertModuleService webcertModuleService) {
  ...
  private static String buildOvrigaUpplysningar(LuseUtlatandeV1 source) {
