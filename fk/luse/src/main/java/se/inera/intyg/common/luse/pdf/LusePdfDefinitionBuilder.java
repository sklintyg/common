...
public class LusePdfDefinitionBuilder extends FkBasePdfDefinitionBuilder {
    ...
    public FkPdfDefinition buildPdfDefinition(LuseUtlatande intyg, List<Status> statuses, ApplicationOrigin applicationOrigin,
    ...
    private FkPage createPage1(LuseUtlatande intyg, boolean isUtkast, boolean isLocked, List<Status> statuses,
    ...
    private void addPage1MiscFields(LuseUtlatande intyg, boolean isUtkast, boolean isLocked, boolean showFkAddress,
    ...
    private FkPage createPage5(LuseUtlatande intyg) {
