...
public final class TransportToInternal {
  ...
  private static void setSvar(LuseUtlatandeV1.Builder utlatande, Intyg source)
  ...
  private static void handleGrundForMedicinsktUnderlag(LuseUtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
  ...
  private static void handleFunktionsNedsattningIntellektuell(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningKommunikation(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningKoncentration(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningPsykisk(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningSynHorselTal(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningBalansKoordination(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleFunktionsNedsattningAnnan(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
  ...
  private static void handleMedicinskaForutsattningarForArbete(
      LuseUtlatandeV1.Builder utlatande, Svar svar) {
    Delsvar delsvar = svar.getDelsvar().get(0);
    switch (delsvar.getId()) {
