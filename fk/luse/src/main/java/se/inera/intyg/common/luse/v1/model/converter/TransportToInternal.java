...
public final class TransportToInternal {
    ...
    public static LuseUtlatandeV1 convert(Intyg source) throws ConverterException {
    ...
    private static void setSvar(LuseUtlatandeV1.Builder utlatande, Intyg source) throws ConverterException {
    ...
    private static void handleGrundForMedicinsktUnderlag(LuseUtlatandeV1.Builder utlatande, Svar svar) throws ConverterException {
    ...
    private static void handleKannedom(LuseUtlatandeV1.Builder utlatande, Svar svar) {
    ...
    private static void handleUnderlagFinns(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleSjukdomsForlopp(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleDiagnosgrund(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleNyDiagnos(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningIntellektuell(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningKommunikation(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningKoncentration(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningPsykisk(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningSynHorselTal(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningBalansKoordination(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningAnnan(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleAktivitetsbegransning(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handlePagaendeBehandling(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleAvslutadBehandling(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handlePlaneradBehandling(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleSubstansintag(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleMedicinskaForutsattningarForArbete(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFormagaTrotsBegransning(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOvrigt(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOnskarKontakt(LuseUtlatandeV1.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
