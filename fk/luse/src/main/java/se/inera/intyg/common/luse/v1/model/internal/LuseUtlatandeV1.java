 ...
 */
package se.inera.intyg.common.luse.v1.model.internal;
...
@AutoValue
@JsonDeserialize(builder = AutoValue_LuseUtlatandeV1.Builder.class)
public abstract class LuseUtlatandeV1 implements Utlatande {
  ...
  @Nullable public abstract InternalDate getAnhorigsBeskrivningAvPatienten();
  ...
  // Fråga 2
  @Nullable public abstract InternalDate getKannedomOmPatient();

  // Kategori 2 – Andra medicinska utredningar och underlag
  // Fråga 3
  @Nullable public abstract Boolean getUnderlagFinns();
  ...
  // Fråga 5
  @Nullable public abstract String getSjukdomsforlopp();
  ...
  // Delfråga 7.1
  @Nullable public abstract String getDiagnosgrund();

  // Delfråga45.1
  @Nullable public abstract Boolean getNyBedomningDiagnosgrund();

  // Delfråga 45.2
  @Nullable public abstract String getDiagnosForNyBedomning();

  // Kategori 5 – Funktionsnedsättning
  // Fråga 8
  @Nullable public abstract String getFunktionsnedsattningIntellektuell();

  // Fråga 9
  @Nullable public abstract String getFunktionsnedsattningKommunikation();

  // Fråga 10
  @Nullable public abstract String getFunktionsnedsattningKoncentration();

  // Fråga 11
  @Nullable public abstract String getFunktionsnedsattningPsykisk();

  // Fråga 12
  @Nullable public abstract String getFunktionsnedsattningSynHorselTal();

  // Fråga 13
  @Nullable public abstract String getFunktionsnedsattningBalansKoordination();

  // Fråga 14
  @Nullable public abstract String getFunktionsnedsattningAnnan();
  ...
  // Fråga 18
  @Nullable public abstract String getAvslutadBehandling();

  // Fråga 20
  @Nullable public abstract String getPlaneradBehandling();

  // Fråga 21
  @Nullable public abstract String getSubstansintag();

  // Kategori 8 – Medicinska förutsättningar för arbete
  // Fråga 22.1
  @Nullable public abstract String getMedicinskaForutsattningarForArbete();

  // Fråga 23.1
  @Nullable public abstract String getFormagaTrotsBegransning();
  ...
  public static Builder builder() {
    return new AutoValue_LuseUtlatandeV1.Builder()
  ...
  public abstract static class Builder {
    ...
    public abstract LuseUtlatandeV1 build();
    ...
    public abstract Builder setAnhorigsBeskrivningAvPatienten(
        InternalDate anhorigsBeskrivningAvPatienten);
    ...
    public abstract Builder setFunktionsnedsattningIntellektuell(
        String funktionsnedsattningIntellektuell);

    @JsonProperty(FUNKTIONSNEDSATTNING_KOMMUNIKATION_SVAR_JSON_ID_9)
    public abstract Builder setFunktionsnedsattningKommunikation(
        String funktionsnedsattningKommunikation);

    @JsonProperty(FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_JSON_ID_10)
    public abstract Builder setFunktionsnedsattningKoncentration(
        String funktionsnedsattningKoncentration);
    ...
    public abstract Builder setFunktionsnedsattningSynHorselTal(
        String funktionsnedsattningSynHorselTal);

    @JsonProperty(FUNKTIONSNEDSATTNING_BALANSKOORDINATION_SVAR_JSON_ID_13)
    public abstract Builder setFunktionsnedsattningBalansKoordination(
    ...
    public abstract Builder setMedicinskaForutsattningarForArbete(
        String medicinskaForutsattningarForArbete);
