...
public class QuestionFunktionsnedsattningKoncentration extends AbstractQuestionFunktionsnedsattning {
    ...
    public static CertificateDataElement toCertificate(String funktionsnedsattningKoncentration, int index,
        ...
        return toCertificate(
            ...
            FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_ID,
            ...
            FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_JSON_ID,
            index,
            textProvider
        );
    }
    ...
    public static String toInternal(Certificate certificate) {
        return ValueToolkit.textValue(certificate.getData(), FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_ID,
            FUNKTIONSNEDSATTNING_KONCENTRATION_SVAR_JSON_ID);
    }
}
