...
public class LuseTestabilityCertificateTestdataProvider implements TestabilityCertificateTestdataProvider {
    ...
    public Map<String, CertificateDataValue> getMaximumValues() {
        ...
        final var motivering = getDataValueText(
            se.inera.intyg.common.luse.v1.model.converter.RespConstants.MOTIVERING_TILL_INTE_BASERAT_PA_UNDERLAG_ID_1, "motivering");
        ...
        final var underlag = CertificateDataValueMedicalInvestigationList.builder()
            .list(
                List.of(
                    getValueMedicalInvestigation(UNDERLAG_SVAR_JSON_ID_4, 0, "NEUROPSYKIATRISKT", "neuropsykiatriskt"),
                    getValueMedicalInvestigation(UNDERLAG_SVAR_JSON_ID_4, 1, "ARBETSTERAPEUT", "arbetsterapeut"),
