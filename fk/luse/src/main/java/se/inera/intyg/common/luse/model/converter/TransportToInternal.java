...
public final class TransportToInternal {
    ...
    public static LuseUtlatande convert(Intyg source) throws ConverterException {
        ...
        utlatande.setSignature(TransportConverterUtil.signatureTypeToBase64(source.getSignature()));
        setSvar(utlatande, source);
        return utlatande.build();
    }

    private static void setSvar(LuseUtlatande.Builder utlatande, Intyg source) throws ConverterException {
    ...
    private static void handleGrundForMedicinsktUnderlag(LuseUtlatande.Builder utlatande, Svar svar) throws ConverterException {
    ...
    private static void handleKannedom(LuseUtlatande.Builder utlatande, Svar svar) {
    ...
    private static void handleUnderlagFinns(LuseUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleSjukdomsForlopp(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleDiagnosgrund(LuseUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningIntellektuell(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningKommunikation(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningKoncentration(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningPsykisk(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningSynHorselTal(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningBalansKoordination(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFunktionsNedsattningAnnan(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleAktivitetsbegransning(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handlePagaendeBehandling(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleAvslutadBehandling(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handlePlaneradBehandling(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleSubstansintag(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleMedicinskaForutsattningarForArbete(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleFormagaTrotsBegransning(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOvrigt(LuseUtlatande.Builder utlatande, Svar svar) {
        Delsvar delsvar = svar.getDelsvar().get(0);
        switch (delsvar.getId()) {
    ...
    private static void handleOnskarKontakt(LuseUtlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
