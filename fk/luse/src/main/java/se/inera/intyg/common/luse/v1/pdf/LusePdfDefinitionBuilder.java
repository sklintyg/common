...
/**
 * Contructs a object graph of PdfComponents that represents a LUSE intyg. Created by marced on
 * 18/08/16.
 */
...
public class LusePdfDefinitionBuilder extends FkBasePdfDefinitionBuilder {
    ...
    try {
      ...
      def.addPageEvent(
          new FkDynamicPageDecoratorEventHandler(
              5, def.getPageMargins(), "Läkarutlåtande", "för sjukersättning"));
  ...
  private void addPage1MiscFields(
    ...
    FkLabel subHeader =
        new FkLabel("för sjukersättning")
            .offset(107.5f, 14f)
            .size(40, 15)
            .withVerticalAlignment(Element.ALIGN_TOP)
            .withFont(PdfConstants.FONT_BOLD_9);
  ...
  private FkPage createPage5(LuseUtlatandeV1 intyg) {
