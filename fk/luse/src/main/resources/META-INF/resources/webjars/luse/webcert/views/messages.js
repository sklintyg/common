...
angular.module('luse').constant('luse.messages', {
  'sv': {
    'luse.modal.ersatt.text': '<p>' +
        ...
        'Uppgifterna i det nya utkastet går att ändra innan det signeras. ' +
        'Invånaren kommer på Mina intyg, som nås via 1177.se, se att intyget är ersatt. ' +
        'Ett ersatt intyg är endast tillgängligt att läsa och skriva ut. ' +
