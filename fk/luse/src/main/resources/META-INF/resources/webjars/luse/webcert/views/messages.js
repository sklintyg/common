...
angular.module('luse').constant('luse.messages', {
    'sv': {
        ...
        'luse.modal.fornya.text': 'Förnya intyg innebär att ett nytt intygsutkast skapas med samma information som i det ursprungliga intyget. Uppgifterna i det nya intygsutkastet går att ändra innan det signeras.<br><br>' +
