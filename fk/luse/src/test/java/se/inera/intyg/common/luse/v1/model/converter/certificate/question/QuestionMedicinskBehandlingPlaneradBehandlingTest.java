...
class QuestionMedicinskBehandlingPlaneradBehandlingTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionMedicinskBehandlingPlaneradBehandling.toCertificate(null, 0, texts);
        }
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return PLANERADBEHANDLING_DELSVAR_TEXT;
        }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionMedicinskBehandlingPlaneradBehandling.toCertificate(expectedText, 0, texts);
        }
    ...
    class InternalTextValueTests extends InternalTextValueTest {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionMedicinskBehandlingPlaneradBehandling.toCertificate(expectedValue, 0, texts);
        }

        @Override
        protected String toInternalTextValue(Certificate certificate) {
            return QuestionMedicinskBehandlingPlaneradBehandling.toInternal(certificate);
        }
    }
}
