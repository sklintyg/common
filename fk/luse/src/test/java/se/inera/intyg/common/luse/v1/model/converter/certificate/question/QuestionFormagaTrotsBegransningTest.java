...
class QuestionFormagaTrotsBegransningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionFormagaTrotsBegransning.toCertificate(null, 0, texts);
        }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionFormagaTrotsBegransning.toCertificate(expectedText, 0, texts);
        }
    ...
    class InternalTextValueTests extends InternalTextValueTest {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionFormagaTrotsBegransning.toCertificate(expectedValue, 0, texts);
        }
