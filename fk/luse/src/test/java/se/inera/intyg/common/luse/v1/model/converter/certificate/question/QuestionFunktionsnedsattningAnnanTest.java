...
class QuestionFunktionsnedsattningAnnanTest {
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return FUNKTIONSNEDSATTNING_ANNAN_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return FUNKTIONSNEDSATTNING_ANNAN_DESCRIPTION_ID;
        }
    ...
    class IncludeAccordionTests {
        ...
        void shouldIncludeConfigAccordionHeader() {
            ...
            verify(texts, atLeastOnce()).get(FUNKTIONSNEDSATTNING_ANNAN_DELSVAR_TEXT_ID);
        }
    }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattningAnnan.toCertificate(expectedValue, 0, texts);
        }
