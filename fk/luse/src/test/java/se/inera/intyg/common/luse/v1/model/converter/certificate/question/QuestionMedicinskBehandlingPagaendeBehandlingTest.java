...
class QuestionMedicinskBehandlingPagaendeBehandlingTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(null, 0, texts);
        }

        @Override
        protected String getId() {
            return PAGAENDEBEHANDLING_DELSVAR_ID;
        }
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return PAGAENDEBEHANDLING_DELSVAR_TEXT;
        }
        ...
        protected String getJsonId() {
            return PAGAENDEBEHANDLING_SVAR_JSON_ID;
        }
    }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(expectedText, 0, texts);
        }
    ...
    class InternalTextValueTests extends InternalTextValueTest {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionMedicinskBehandlingPagaendeBehandling.toCertificate(expectedValue, 0, texts);
        }

        @Override
        protected String toInternalTextValue(Certificate certificate) {
            return QuestionMedicinskBehandlingPagaendeBehandling.toInternal(certificate);
        }
    }
}
