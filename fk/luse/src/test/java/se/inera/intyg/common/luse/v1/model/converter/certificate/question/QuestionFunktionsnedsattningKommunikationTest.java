...
class QuestionFunktionsnedsattningKommunikationTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected String getId() {
            return FUNKTIONSNEDSATTNING_KOMMUNIKATION_SVAR_ID;
        }
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return FUNKTIONSNEDSATTNING_KOMMUNIKATION_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return FUNKTIONSNEDSATTNING_KOMMUNIKATION_DESCRIPTION_ID;
        }

        @Override
        protected String getJsonId() {
            return FUNKTIONSNEDSATTNING_KOMMUNIKATION_SVAR_JSON_ID;
        }
    }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        private final String expectedText = "test";

        @Override
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattningKommunikation.toCertificate(expectedText, 0, texts);
        }
    ...
    class IncludeInternalTextValueTests extends InternalTextValueTest {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionFunktionsnedsattningKommunikation.toCertificate(expectedValue, 0, texts);
        }

        @Override
        protected String toInternalTextValue(Certificate certificate) {
            return QuestionFunktionsnedsattningKommunikation.toInternal(certificate);
        }
    }
}
