 ...
 */
package se.inera.intyg.common.luse.v1.model.util;
...
import se.inera.intyg.common.luse.v1.model.internal.LuseUtlatandeV1.Builder;
...
public class LuseModelCompareUtilTest {
    ...
    public void testModelIsValid() throws Exception {
        LuseUtlatandeV1 utlatande = getUtlatandeFromFile("utlatande");
    ...
    public void testModelIsValidDiagnoskodChanged() throws Exception {
        LuseUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld.toBuilder();
        LuseUtlatandeV1 utlatandeNew = builder.setDiagnoser(Arrays.asList(Diagnos.create("A00-", "KSH_97_P", "Kolera", ""))).build();
    ...
    public void testModelIsInvalidDiagnosInvalid() throws Exception {
        LuseUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld.toBuilder();
        LuseUtlatandeV1 utlatandeNew = builder.setDiagnoser(Arrays.asList(Diagnos.create("BLAH", "ICD_10_SE", "Klämskada skuldra", ""))).build();
    ...
    public void testModelIsInvalidWithInvalidDate() throws Exception {
        LuseUtlatandeV1 utlatandeOld = getUtlatandeFromFile("utlatande");
        Builder builder = utlatandeOld .toBuilder();
        LuseUtlatandeV1 utlatandeNew = builder.setUndersokningAvPatienten(new InternalDate("2016-1")).build();

        assertFalse(modelCompareUtil.isValidForNotification(utlatandeNew));
    }


    private LuseUtlatandeV1 getUtlatandeFromFile(String file) throws IOException {
        return objectMapper.readValue(new ClassPathResource(
                "v1/LuseModelCompareUtil/" + file + ".json").getFile(), LuseUtlatandeV1.class);
    }
}
