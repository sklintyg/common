 ...
 */
package se.inera.intyg.common.luse.utils;
...
public final class ScenarioFinder {
    ...
    private static final class FileBasedScenario implements Scenario {
         ...
         */
        @Override
        public LuseUtlatande asInternalModel()
                throws ScenarioNotFoundException {
            try {
                return new CustomObjectMapper().readValue(getInternalModelFor(scenarioFile), LuseUtlatande.class);
            } catch (IOException e) {
