...
import static se.inera.intyg.common.luse.v1.model.converter.RespConstants.FUNKTIONSNEDSATTNING_SYNHORSELTAL_DELSVAR_TEXT_ID;
import static se.inera.intyg.common.luse.v1.model.converter.RespConstants.FUNKTIONSNEDSATTNING_SYNHORSELTAL_DESCRIPTION_ID;
...
import static se.inera.intyg.common.luse.v1.model.converter.RespConstants.FUNKTIONSNEDSATTNING_SYNHORSELTAL_TEXT_ID;
...
class QuestionFunktionsnedsattningSynHorselTalTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattningSynHorselTal.toCertificate(null, 0, texts);
        }

        @Override
        protected String getId() {
            return FUNKTIONSNEDSATTNING_SYNHORSELTAL_SVAR_ID;
        }
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return FUNKTIONSNEDSATTNING_SYNHORSELTAL_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return FUNKTIONSNEDSATTNING_SYNHORSELTAL_DESCRIPTION_ID;
        }

        @Override
        protected String getJsonId() {
            return FUNKTIONSNEDSATTNING_SYNHORSELTAL_SVAR_JSON_ID;
        }
    }
    ...
    class IncludeAccordionTests extends AccordionTest {
        ...
        protected String getExpectedAccordionHeader() {
            return FUNKTIONSNEDSATTNING_SYNHORSELTAL_DELSVAR_TEXT_ID;
        }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattningSynHorselTal.toCertificate(expectedValue, 0, texts);
        }
    ...
    class IncludeInternalTextValueTests extends InternalTextValueTest {
        ...
        protected String toInternalTextValue(Certificate certificate) {
            return QuestionFunktionsnedsattningSynHorselTal.toInternal(certificate);
        }
    }
}
