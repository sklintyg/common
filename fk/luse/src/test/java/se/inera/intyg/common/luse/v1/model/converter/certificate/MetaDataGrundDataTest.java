...
package se.inera.intyg.common.luse.v1.model.converter.certificate;
...
import static se.inera.intyg.common.luse.v1.model.converter.certificate.MetaDataGrundData.toInternal;
    ...
    class ToCertificate {
        ...
        class IncludeTestCommonMetadata extends CommonMetaDataTest {
            ...
            protected CertificateMetadata getMetaData() {
                return MetaDataGrundData.toCertificate((LuseUtlatandeV1) getInternalCertificate(), texts);
            }
