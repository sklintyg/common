...
class QuestionFunktionsnedsattningBalansKoordinationTest {
    ...
    class IncludeConfigTextAreaTests extends ConfigTextAreaTest {
        ...
        protected String getTextId() {
            return FUNKTIONSNEDSATTNING_BALANSKOORDINATION_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return FUNKTIONSNEDSATTNING_BALANSKOORDINATION_DESCRIPTION_ID;
        }
    ...
    class IncludeValueTextTests extends ValueTextTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattningBalansKoordination.toCertificate(expectedValue, 0, texts);
        }
    ...
    class IncludeInternalTextValueTests extends InternalTextValueTest {
        ...
        protected String toInternalTextValue(Certificate certificate) {
            return QuestionFunktionsnedsattningBalansKoordination.toInternal(certificate);
        }
    }
}
