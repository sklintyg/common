...
class QuestionMedicinskBehandlingPagaendeBehandlingHeaderTest {
    ...
    @Nested
    class IncludeCommmonElementTests extends CommonElementTest {

        @Override
        protected CertificateDataElement getElement() {
            return QuestionMedicinskBehandlingPagaendeBehandlingHeader.toCertificate(0, texts);
        }
    ...
    class IncludeConfigHeaderTests extends ConfigHeaderTest {
        ...
        protected String getTextId() {
            return PAGAENDEBEHANDLING_SVAR_TEXT;
        }
