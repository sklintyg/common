...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.ATGARDER_CATEGORY_TEXT;
...
public class CategoryAtgarder {
  ...
  public static CertificateDataElement toCertificate(int index, CertificateTextProvider texts) {
    return CertificateDataElement.builder()
        ...
        .index(index)
        .config(
            CertificateDataConfigCategory.builder().text(texts.get(ATGARDER_CATEGORY_TEXT)).build())
        .validation(
