...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.ARBETSLIVSINRIKTADE_ATGARDER_SVAR_JSON_ID_40;
...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.BEHOV_AV_SJUKSKRIVNING_SVAR_JSON_ID_32;
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.DIAGNOS_SVAR_JSON_ID_6;
...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.GRUNDDATA_SVAR_JSON_ID;
...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.ID_JSON_ID;
...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.PAGAENDEBEHANDLING_SVAR_JSON_ID_19;
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.PLANERADBEHANDLING_SVAR_JSON_ID_20;
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.PROGNOS_SVAR_JSON_ID_39;
...
public abstract class LisjpUtlatandeV1 implements Utlatande {
  ...
  // Fråga 27
  @Nullable public abstract Boolean getAvstangningSmittskydd();

  // Kategori 1 – Grund för medicinskt underlag
  // Fråga 1
  @Nullable public abstract InternalDate getUndersokningAvPatienten();

  @Nullable public abstract InternalDate getTelefonkontaktMedPatienten();

  @Nullable public abstract InternalDate getJournaluppgifter();

  @Nullable public abstract InternalDate getAnnatGrundForMU();

  // Fråga 1.3 Annan grund för MU
  @Nullable public abstract String getAnnatGrundForMUBeskrivning();

  @Nullable public abstract String getMotiveringTillInteBaseratPaUndersokning();

  // Kategori 2 - Sysselsättning
  // Fråga 28
  // Fråga 28.1
  @Nullable public abstract ImmutableList<Sysselsattning> getSysselsattning();

  // Fråga 29 - Nuvarande arbete
  // Fråga 29.1
  @Nullable public abstract String getNuvarandeArbete();
  ...
  @Nullable public abstract String getPagaendeBehandling();

  // Fråga 20 - Planerad medicinsk behandling
  // Fråga 20.1
  @Nullable public abstract String getPlaneradBehandling();
  ...
  @Nullable public abstract String getMotiveringTillTidigtStartdatumForSjukskrivning();

  // Fråga 37 - försäkringsmedicinskt beslutsstöd
  // 37.1
  @Nullable public abstract String getForsakringsmedicinsktBeslutsstod();

  // Fråga 33 - Arbetstidsförläggning
  // 33.1
  @Nullable public abstract Boolean getArbetstidsforlaggning();

  // 33.2
  @Nullable public abstract String getArbetstidsforlaggningMotivering();

  // Fråga 34 - Arbetsresor
  // 34.1
  @Nullable public abstract Boolean getArbetsresor();
  ...
  // Kategori 9 - Kontakt
  // Fråga 26.1
  @Nullable public abstract Boolean getKontaktMedFk();

  // Fråga 26.2
  @Nullable public abstract String getAnledningTillKontakt();

  // Tilläggsfrågor
  @Nullable public abstract ImmutableList<Tillaggsfraga> getTillaggsfragor();

  @Nullable public abstract List<String> getFunktionsKategorier();

  @Nullable public abstract List<String> getAktivitetsKategorier();
  ...
  public abstract static class Builder {
    ...
    public abstract Builder setMotiveringTillInteBaseratPaUndersokning(
        String motiveringTillInteBaseratPaUndersokning);
    ...
    public abstract Builder setMotiveringTillTidigtStartdatumForSjukskrivning(
        String motiveringTillTidigtStartdatumForSjukskrivning);

    @JsonProperty(FORSAKRINGSMEDICINSKT_BESLUTSSTOD_SVAR_JSON_ID_37)
    public abstract Builder setForsakringsmedicinsktBeslutsstod(
        String forskningsmedicinsktBeslutsstod);
    ...
    public abstract Builder setArbetstidsforlaggningMotivering(
        String arbetstidsforlaggningMotivering);
    ...
    public Builder setArbetslivsinriktadeAtgarder(
        List<ArbetslivsinriktadeAtgarder> arbetslivsinriktadeAtgarder) {
      return setArbetslivsinriktadeAtgarder(ImmutableList.copyOf(arbetslivsinriktadeAtgarder));
    }

    /* package private */
    abstract Builder setArbetslivsinriktadeAtgarder(
    ...
    public abstract Builder setArbetslivsinriktadeAtgarderBeskrivning(
        String arbetslivsinriktadeAtgarderBeskrivning);
