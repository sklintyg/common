...
public final class TransportToInternal {
  ...
  private static void setSvar(LisjpUtlatandeV1.Builder utlatande, Intyg source)
  ...
  private static void handleArbetslivsinriktadeAtgarderBeskrivning(
      LisjpUtlatandeV1.Builder utlatande, Svar svar) throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handlePrognos(LisjpUtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
  ...
  private static void handleForsakringsmedicinsktBeslutsstod(
      LisjpUtlatandeV1.Builder utlatande, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
