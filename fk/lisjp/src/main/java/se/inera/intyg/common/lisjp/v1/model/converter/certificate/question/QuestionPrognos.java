...
public class QuestionPrognos extends AbstractQuestionPrognos {
  ...
  public static CertificateDataElement toCertificate(
    ...
    final var prognosConfigProvider = new QuestionPrognosConfigProvider(convertValue(prognos));
    return toCertificate(
        prognosConfigProvider, PROGNOS_SVAR_ID_39, BEDOMNING_CATEGORY_ID, index, texts);
  }

  private static QuestionPrognosValue convertValue(Prognos prognos) {
    return (prognos != null && prognos.getTyp() != null)
        ? new QuestionPrognosValue(prognos.getTyp().getId())
        : null;
  }
