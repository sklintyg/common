        ...
        function _getConfig(viewState) {
          ...
          var config = [
            ...
            kategori(categoryIds[2], 'KAT_2.RBK', 'KAT_2.HLP', {hideExpression: 'model.avstangningSmittskydd'}, [
              fraga(28, 'FRG_28.RBK', 'FRG_28.HLP', {
                required: true, requiredProp: ['sysselsattning["NUVARANDE_ARBETE"]',
              ...
              }]), fraga(29, 'FRG_29.RBK', 'FRG_29.HLP', {
                required: true, hideExpression: '!model.sysselsattning["NUVARANDE_ARBETE"]',
            ...
            kategori(categoryIds[6], 'KAT_6.RBK', 'KAT_6.HLP', {}, [
              fraga(32, 'FRG_32.RBK', 'FRG_32.HLP', {
                required: true, requiredProp: ['sjukskrivningar["EN_FJARDEDEL"].period.from', 'sjukskrivningar["HALFTEN"].period.from',
              ...
              fraga(39, 'FRG_39.RBK', 'FRG_39.HLP',
                  {required: true, requiredProp: 'prognos.typ', hideExpression: 'model.avstangningSmittskydd'}, [{
                    type: 'ue-prognos',
                    modelProp: 'prognos',
                    code: 'KV_FKMU_0006',
            ...
            kategori(categoryIds[7], 'KAT_7.RBK', 'KAT_7.HLP', {hideExpression: 'model.avstangningSmittskydd'}, [
              fraga(40, 'FRG_40.RBK', 'FRG_40.HLP', {
                required: true, requiredProp: ['arbetslivsinriktadeAtgarder["EJ_AKTUELLT"]', 'arbetslivsinriktadeAtgarder["ARBETSTRANING"]',
                  'arbetslivsinriktadeAtgarder["ARBETSANPASSNING"]', 'arbetslivsinriktadeAtgarder["SOKA_NYTT_ARBETE"]',
                  'arbetslivsinriktadeAtgarder["BESOK_ARBETSPLATS"]',
                  'arbetslivsinriktadeAtgarder["ERGONOMISK"]', 'arbetslivsinriktadeAtgarder["HJALPMEDEL"]',
                  'arbetslivsinriktadeAtgarder["KONFLIKTHANTERING"]',
                  'arbetslivsinriktadeAtgarder["KONTAKT_FHV"]', 'arbetslivsinriktadeAtgarder["OMFORDELNING"]',
                  'arbetslivsinriktadeAtgarder["OVRIGA_ATGARDER"]']
              }, [{
                type: 'ue-checkgroup',
