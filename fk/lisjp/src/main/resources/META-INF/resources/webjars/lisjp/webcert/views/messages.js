...
angular.module('lisjp').constant('lisjp.messages', {
  'sv': {
    ...
    'lisjp.label.sjukskrivningar.tidigtstartdatum.motivering.help':
        'Detta är ett stöd för ifyllnad och ingen fråga från Försäkringskassan. ' +
        ' Informationen du anger här kan vara till hjälp för Försäkringskassan i deras handläggning.\n' +
        '\n' +
    ...
    'lisjp.modal.ersatt.text': '<p>' +
        ...
        'Uppgifterna i det nya utkastet går att ändra innan det signeras. Invånaren kommer på Mina intyg, som nås via 1177.se, ' +
        'se att intyget är ersatt. Ett ersatt intyg är endast tillgängligt att läsa och skriva ut. ' +
    ...
    'lisjp.modal.fornya.text': 'Förnya intyg kan användas vid förlängning av en sjukskrivning. ' +
        'När ett intyg förnyas skapas ett nytt intygsutkast med viss information från det ursprungliga intyget.<br><br>' +
