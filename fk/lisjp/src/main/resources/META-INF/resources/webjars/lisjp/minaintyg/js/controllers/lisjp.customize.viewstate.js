...
angular.module('lisjp').factory('lisjp.customizeViewstate', function() {
  ...
  var _fieldConfig = {
    ...
    'sysselsattningOptional': {
      id: 'sysselsattningOptional', mandatory: false, selected: true,
      fields: [sysselsattningsTypResolver(['STUDIER', 'ARBETSSOKANDE', 'FORALDRALEDIG'])]
    },

    //Mandatory fields
    'sysselsattningMandatory': {
      id: 'sysselsattningMandatory',
      mandatory: true,
      selected: true,
      fields: [sysselsattningsTypResolver(['NUVARANDE_ARBETE'])]
    },
