...
angular.module('lisjp').controller('lisjp.CustomizePdfCtrl',
    ['$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope', 'lisjp.customizeViewstate',
      ...
      function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService,
        ...
        $scope.downloadAsPdfLink =
            '/moduleapi/certificate/lisjp/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId + '/pdf/arbetsgivarutskrift';
