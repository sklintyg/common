...
import static se.inera.intyg.common.lisjp.v1.model.converter.RespConstants.GRUNDFORMEDICINSKTUNDERLAG_CATEGORY_TEXT_ID;
...
import se.inera.intyg.common.support.facade.testsetup.model.validation.ValidationHideTest;
...
class CategoryGrundForMUTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryGrundForMU.toCertificate(0, texts);
        }
    ...
    @Nested
    class IncludeValidationHideTests extends ValidationHideTest {
