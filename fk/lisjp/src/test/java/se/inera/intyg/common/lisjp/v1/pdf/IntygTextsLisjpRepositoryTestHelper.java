...
public class IntygTextsLisjpRepositoryTestHelper extends IntygTextsRepositoryImpl {

    public IntygTextsLisjpRepositoryTestHelper() {
    ...
    public void update()  {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ClassPathResource("v1/text/texterMU_LISJP_v1.0.xml").getInputStream());
