...
class MetaDataGrundDataTest {
  ...
  class CommonMetadata {
    ...
    void shouldIncludeCertificateTypeVersion() {
      ...
      assertEquals(
          internalCertificate.getTextVersion(), certificate.getMetadata().getTypeVersion());
    }
    ...
    void shouldIncludeCertificateDescription() {
      ...
      assertTrue(
          certificate.getMetadata().getDescription().trim().length() > 0,
  ...
  class GrundDataTest {
    ...
    void shouldIncludeUnitAddress(String expectedValue) {
      ...
      assertEquals(
          expectedValue,
          updatedCertificate.getGrundData().getSkapadAv().getVardenhet().getPostadress());
    }
    ...
    void shouldIncludeUnitCity(String expectedValue) {
      ...
      assertEquals(
          expectedValue,
          updatedCertificate.getGrundData().getSkapadAv().getVardenhet().getPostort());
    }
    ...
    void shouldIncludeUnitZipCode(String expectedValue) {
      ...
      assertEquals(
          expectedValue,
          updatedCertificate.getGrundData().getSkapadAv().getVardenhet().getPostnummer());
    }
    ...
    void shouldIncludeUnitPhonenumber(String expectedValue) {
      ...
      assertEquals(
          expectedValue,
          updatedCertificate.getGrundData().getSkapadAv().getVardenhet().getTelefonnummer());
    }
  }
}
