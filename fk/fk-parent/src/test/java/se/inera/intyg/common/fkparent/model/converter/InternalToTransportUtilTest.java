...
public class InternalToTransportUtilTest {
  ...
  public void setup() {
    ...
    when(webcertModuleService.validateDiagnosisCode(eq(DIAGNOSIS_CODE_Z731), anyString()))
        .thenReturn(true);
    when(webcertModuleService.validateDiagnosisCodeFormat(DIAGNOSIS_CODE_Z731)).thenReturn(true);
    when(webcertModuleService.validateDiagnosisCode(eq(DIAGNOSIS_CODE_A039), anyString()))
        .thenReturn(true);
    when(webcertModuleService.validateDiagnosisCodeFormat(DIAGNOSIS_CODE_A039)).thenReturn(true);
    when(webcertModuleService.validateDiagnosisCode(eq(DIAGNOSIS_CODE_A00DASH), anyString()))
        .thenReturn(true);
    when(webcertModuleService.validateDiagnosisCodeFormat(DIAGNOSIS_CODE_A00DASH)).thenReturn(true);
    when(webcertModuleService.validateDiagnosisCode(eq(DIAGNOSIS_CODE_INVALID), anyString()))
        .thenReturn(false);
    when(webcertModuleService.validateDiagnosisCodeFormat(DIAGNOSIS_CODE_INVALID)).thenReturn(true);
    when(webcertModuleService.validateDiagnosisCodeFormat(DIAGNOSIS_CODE_INVALID_DOT))
        .thenReturn(false);
  }
  ...
  public void handleDiagnosSvarTest() throws Exception {
    ...
    internal.add(
        Diagnos.create(diagnosKod1, diagnosKodSystem1, diagnosBeskrivning1, diagnosDisplayName1));
    internal.add(
        Diagnos.create(diagnosKod2, diagnosKodSystem2, diagnosBeskrivning2, diagnosDisplayName2));
    internal.add(
        Diagnos.create(diagnosKod3, diagnosKodSystem3, diagnosBeskrivning3, diagnosDisplayName3));
    ...
    assertEquals(
        diagnosBeskrivning1,
        TransportConverterUtil.getStringContent(res.get(0).getDelsvar().get(1)));
    ...
    assertEquals(
        diagnosBeskrivning2,
        TransportConverterUtil.getStringContent(res.get(0).getDelsvar().get(3)));
    ...
    assertEquals(
        diagnosBeskrivning3,
        TransportConverterUtil.getStringContent(res.get(0).getDelsvar().get(5)));
  }
