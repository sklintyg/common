...
public final class FkDataValueUtil {
  ...
  public static CertificateDataValueDiagnosisList getDataValueMinimalDiagnosisListFk(
      String id, Diagnos diagnos) {
    final var certificateDataValueDiagnosis =
    ...
    return CertificateDataValueDiagnosisList.builder()
        .list(List.of(certificateDataValueDiagnosis))
        .build();
  }

  public static CertificateDataValueDiagnosisList getDataValueMaximalDiagnosisListFk(
      List<String> ids, List<Diagnos> diagnosis) {
    ...
    return CertificateDataValueDiagnosisList.builder().list(certificateDataValueDiagnoses).build();
  }

  public static CertificateDataValueMedicalInvestigation getValueMedicalInvestigation(
      String jsonId, int id, String code, String text) {
    return CertificateDataValueMedicalInvestigation.builder()
        .date(
            CertificateDataValueDate.builder()
                ...
                .build())
        .investigationType(
            CertificateDataValueCode.builder().id(jsonId + "[" + id + "].typ").code(code).build())
        .informationSource(
