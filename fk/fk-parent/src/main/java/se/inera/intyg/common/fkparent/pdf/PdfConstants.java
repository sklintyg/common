...
public final class PdfConstants {
  ...
  public static final String ELECTRONIC_COPY_WATERMARK_TEXT_SIGNATURE =
      "Detta är en utskrift av ett elektroniskt intyg. Intyget har signerats elektroniskt av intygsutfärdaren.";
  public static final String MINIMAL_ELECTRONIC_COPY_WATERMARK_TEXT =
      "Detta är en utskrift av ett elektroniskt intyg med minimalt innehåll. Det uppfyller sjuklönelagens krav, om inget annat regleras i kollektivavtal. Det minimala intyget kan ge arbetsgivaren sämre möjligheter att bedöma behovet av rehabilitering än ett fullständigt intyg. Intyget har signerats elektroniskt av intygsutfärdaren.";

  public static final String ELECTRONIC_COPY_WATERMARK_TEXT_TITLE =
      "Intyget har skickats digitalt till Försäkringskassan";

  /** * Fonts that will be used in FK SIT-type PDFs. */
  private static final String ARIAL_REGULAR_COMPATIBLE_FONT_PATH =
      "/fonts/LiberationSans-Regular.ttf";

  private static final String ARIAL_BOLD_COMPATIBLE_FONT_PATH = "/fonts/LiberationSans-Bold.ttf";

  private static final String TREBUCHET_REGULAR_COMPATIBLE_FONT_PATH =
  ...
  static {
    try {
      ...
      FONT_VALUE_TEXT =
          new Font(
              createFont(
                  TREBUCHET_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              10.5f,
              Font.NORMAL);
      FONT_VALUE_TEXT_ARIAL_COMPATIBLE =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              10f,
              Font.NORMAL);
      FONT_VALUE_TEXT_OVERFLOWINFO_ARIAL_COMPATIBLE =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              10f,
      ...
      FONT_INLINE_FIELD_LABEL =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              8.5f,
              Font.NORMAL);
      FONT_INLINE_FIELD_LABEL_SMALL =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              8f,
              Font.NORMAL);
      FONT_INLINE_FIELD_LABEL_LARGE =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              10f,
      ...
      FONT_ELECTRONICALLY_SIGNED_SIGNATURE =
          new Font(
              createFont(ARIAL_BOLD_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              8f,
              Font.NORMAL,
      ...
      FONT_ELECTRONICALLY_SIGNED_TITLE =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              21f,
              Font.NORMAL,
              BaseColor.GRAY);
      FONT_ELECTRONICALLY_SIGNED_SUBTITLE =
          new Font(
              createFont(
                  ARIAL_REGULAR_COMPATIBLE_FONT_PATH, BaseFont.IDENTITY_H, BaseFont.EMBEDDED),
              14f,
