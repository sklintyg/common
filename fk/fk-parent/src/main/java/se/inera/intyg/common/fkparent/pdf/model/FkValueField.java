...
public class FkValueField extends PdfComponent<FkValueField> {
  ...
  public void render(Document document, PdfWriter writer, float x, float y)
    ...
    table.setTotalWidth(
        new float[] {
          Utilities.millimetersToPoints(fieldLabelWidth), Utilities.millimetersToPoints(width)
        });
    ...
    table.writeSelectedRows(
        0, -1, Utilities.millimetersToPoints(x), Utilities.millimetersToPoints(adjustedY), canvas);
