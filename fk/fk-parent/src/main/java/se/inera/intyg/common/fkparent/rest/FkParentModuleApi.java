...
public abstract class FkParentModuleApi<T extends Utlatande> implements ModuleApi2 {
    ...
    @Override
    public RegisterCertificateType getTransportFromInternal(String internalModel) throws ModuleException, ConverterException {
        return internalToTransport(getInternal(internalModel));
    }
