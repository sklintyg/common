...
/**
 * An implementation of a generic label component. Besides the common configuration properties,
 * other adjustments can be made to padding and leading etc.
 */
public class FkLabel extends PdfComponent<FkLabel> {
  ...
  /**
   * Implementation of PdfPCellEvent that renders a colored background with Rounded borders for the
   * attached PdfPCell.
   *
   * <p>Uses sensible defaults, but may need to be augmented with builder or constructor for
   * fine-granular control of offsets and rounding.
   *
   * <p>The color is read from the outer class.
   */
  private static class RoundedBorder implements PdfPCellEvent {
    ...
    private float leftOffset = DEFAULT_LEFT_OFFSET,
        bottomOffset = DEFAULT_BOTTOM_OFFSET,
        widthPadding = WIDTH_PADDING,
        heightPadding = HEIGHT_PADDING,
        cornerRadius = CORDER_RADIUS;
