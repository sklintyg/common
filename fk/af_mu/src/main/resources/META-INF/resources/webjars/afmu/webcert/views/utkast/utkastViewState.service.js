 ...
 */
angular.module('afmu').service('afmu.EditCertCtrl.ViewStateService',
    ['$log', '$state', 'common.UtkastViewStateService', 'afmu.Domain.IntygModel',
        function($log, $state, CommonViewState, IntygModel) {
            ...
            this.reset = function() {
                ...
                CommonViewState.intyg.type = 'afmu';
