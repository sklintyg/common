                        ...
                        fraga(null, '', '', { hideExpression: function(scope) {
                            ...
                            if (warnings) {
                                angular.forEach(warnings.sjukskrivningar, function(w) {
                                    if (w.message ===
                                        'afmu.validation.bedomning.sjukskrivningar.tidigtstartdatum') {
                                        hide = false;
                                    }
                                });
                            }
                            ...
                            label: {
                                bold: 'bold',
                                key: 'afmu.label.sjukskrivningar.tidigtstartdatum.motivering',
                                helpKey: 'afmu.label.sjukskrivningar.tidigtstartdatum.motivering.help',
                                required: true,
                                type: 'label',
                            ...
                            label : {
                                htmlClass: 'info-transfer',
                                key: 'afmu.label.sjukskrivningar.tidigtstartdatum.motivering.info',
                                variableLabelKey: 'FRG_25.RBK'
                            }
                        }]),
