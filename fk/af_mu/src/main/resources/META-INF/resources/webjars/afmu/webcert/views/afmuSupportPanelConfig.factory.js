 ...
 */
/**
 * Creates the supportpanel config related to working with afmu intyg and utkast
 *
 * Created by marced on 2018-01-16.
 */
angular.module('afmu').factory('afmu.supportPanelConfigFactory', [ 'common.featureService', function(featureService) {
    'use strict';
