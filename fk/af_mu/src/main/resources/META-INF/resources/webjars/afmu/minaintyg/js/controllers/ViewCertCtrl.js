 ...
 */
angular.module('afmu').controller(
        'afmu.ViewCertCtrl',
        [ '$location', '$log', '$stateParams', '$scope', 'common.IntygService', 'afmu.customizeViewstate', 'afmu.viewConfigFactory',
                function($location, $log, $stateParams, $scope, certificateService, customizeViewstate, viewConfigFactory) {
                    ...
                    $scope.send = function() {
                        $location.path('/send/afmu/' + $stateParams.certificateId + '/FKASSA');
                    };

                    $scope.customizeCertificate = function() {
                        customizeViewstate.resetModel();
                        $location.path('/afmu/customize/' + $stateParams.certificateId + '/step1');
                    };
