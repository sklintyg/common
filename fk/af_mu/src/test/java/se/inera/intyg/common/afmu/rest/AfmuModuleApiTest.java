...
import se.inera.intyg.common.afmu.model.converter.SvarIdHelperImpl;
...
import static se.inera.intyg.common.afmu.rest.AfmuModuleApi.PREFIX;

@RunWith(MockitoJUnitRunner.class)
public class AfmuModuleApiTest {
    ...
    public void testSendCertificateShouldUseXml() {
        ...
        try {
            String xmlContents = Resources.toString(Resources.getResource("transport/afmu.xml"), Charsets.UTF_8);
    ...
    public void testValidateShouldUseValidator() throws Exception {
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue("internal model", AfmuUtlatande.class);
    ...
    public void testRegisterCertificate() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(internalModel, AfmuUtlatande.class);
    ...
    public void testGetUtlatandeFromJson() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(utlatandeJson, AfmuUtlatande.class);
    ...
    public void testCreateRevokeRequest() throws Exception {
        ...
        Utlatande utlatande = AfmuUtlatande.builder().setId(intygId).setGrundData(gd).setTextVersion("").build();
    ...
    public void testCreateCompletionFromTemplateWithComment() throws Exception {
        ...
        AfmuUtlatande utlatande = AfmuUtlatande
                .builder()
                .setId("utlatande-id")
        ...
        AfmuUtlatande utlatandeFromJson = (AfmuUtlatande) moduleApi.getUtlatandeFromJson(result);
