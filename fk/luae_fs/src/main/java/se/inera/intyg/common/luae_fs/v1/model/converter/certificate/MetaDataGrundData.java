...
public class MetaDataGrundData {
    ...
    public static CertificateMetadata toCertificate(LuaefsUtlatandeV1 internalCertificate, CertificateTextProvider texts) {
        return CertificateMetadata.builder()
            .id(internalCertificate.getId())
            .type(internalCertificate.getTyp())
            .typeName(LuaefsEntryPoint.ISSUER_TYPE_ID)
