...
@AutoValue
@JsonDeserialize(builder = AutoValue_LuaefsUtlatandeV1.Builder.class)
public abstract class LuaefsUtlatandeV1 implements Utlatande {
  ...
  @Nullable public abstract ImmutableList<Underlag> getUnderlag();
  ...
  @Nullable public abstract String getFunktionsnedsattningDebut();

  // Fråga 16 - Funktionsnedsättningens påverkan på skolgången?
  // Fråga 16.1 - På vilket sätt har skolgången påverkats?
  @Nullable public abstract String getFunktionsnedsattningPaverkan();
  ...
  public abstract static class Builder {
    ...
    public abstract LuaefsUtlatandeV1 build();
