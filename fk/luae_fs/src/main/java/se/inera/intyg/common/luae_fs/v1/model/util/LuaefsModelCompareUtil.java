...
@Component(value = "luae_fs.LuaefsModelCompareUtil.v1")
public class LuaefsModelCompareUtil extends FkParentModelCompareUtil implements ModelCompareUtil<LuaefsUtlatandeV1> {

    @Override
    public boolean isValidForNotification(LuaefsUtlatandeV1 utlatande) {
