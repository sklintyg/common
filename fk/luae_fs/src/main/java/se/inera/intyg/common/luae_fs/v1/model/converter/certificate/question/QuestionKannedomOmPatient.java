...
import se.inera.intyg.common.fkparent.model.converter.certificate.AbstractQuestionKannedomOmPatient;
import se.inera.intyg.common.services.texts.CertificateTextProvider;
import se.inera.intyg.common.support.facade.model.Certificate;
import se.inera.intyg.common.support.facade.model.CertificateDataElement;
import se.inera.intyg.common.support.model.InternalDate;

public class QuestionKannedomOmPatient extends AbstractQuestionKannedomOmPatient {
    ...
    public static CertificateDataElement toCertificate(InternalDate kannedomOmPatient, int index, CertificateTextProvider texts) {
        return toCertificate(kannedomOmPatient, index, texts, KANNEDOM_SVAR_ID_2, GRUNDFORMU_CATEGORY_ID, KANNEDOM_SVAR_TEXT_ID);
    }

    public static InternalDate toInternal(Certificate certificate) {
        return toInternal(certificate, KANNEDOM_SVAR_ID_2);
    }
}
