 ...
 */
package se.inera.intyg.common.luae_fs.v1.testability;
...
public class LuaefsTestabilityCertificateTestdataProvider
  ...
  public Map<String, CertificateDataValue> getMinimumValues() {
    ...
    final var funktionsnedsattningDebut =
        getDataValueText(FUNKTIONSNEDSATTNING_DEBUT_SVAR_JSON_ID_15, "funktionsnedsattning debut");
    values.put(FUNKTIONSNEDSATTNING_DEBUT_SVAR_ID_15, funktionsnedsattningDebut);

    final var funktionsnedsattningPaverkan =
        getDataValueText(
            FUNKTIONSNEDSATTNING_PAVERKAN_SVAR_JSON_ID_16, "funktionsnedsattning påverkan");
  ...
  public Map<String, CertificateDataValue> getMaximumValues() {
    ...
    final var motivering =
        getDataValueText(MOTIVERING_TILL_INTE_BASERAT_PA_UNDERLAG_ID_1, "motivering");
