...
/**
 * Contructs a object graph of PdfComponents that represents a LUAE_FS intyg. Created by eriklup on
 * 16/01/17.
 */
...
public class LuaefsPdfDefinitionBuilder extends FkBasePdfDefinitionBuilder {
    ...
    try {
      ...
      def.addPageEvent(
          new FkOverflowPagePersonnummerEventHandlerImpl(
              intyg.getGrundData().getPatient().getPersonId().getPersonnummer(), 3));
  ...
  private void addPage1MiscFields(
    ...
    FkLabel subHeader =
        new FkLabel("för aktivitetsersättning vid förlängd skolgång")
            .offset(105.5f, 14f)
            .size(80, 15)
            .withVerticalAlignment(Element.ALIGN_TOP)
            .withFont(PdfConstants.FONT_BOLD_9);
  ...
  private boolean isBeforeTextChangesInOneDotOne(LuaefsUtlatandeV1 certificate) {
  ...
  private FkPage createPage2(LuaefsUtlatandeV1 intyg) throws IOException, DocumentException {
    ...
    FkFieldGroup fraga4 =
        new FkFieldGroup("4. " + getText("KAT_4.RBK"))
            .offset(KATEGORI_OFFSET_X, 66.5f)
            .size(KATEGORI_FULL_WIDTH, 58.5f)
            .withBorders(Rectangle.BOX);

    // När och var ställdes diagnosen/diagnoserna?
    FkOverflowableValueField narOchHur =
        new FkOverflowableValueField(intyg.getFunktionsnedsattningDebut(), getText("FRG_15.RBK"))
            .size(KATEGORI_FULL_WIDTH, 29.25f)
            .offset(0f, 0f)
            .withBorders(Rectangle.BOTTOM)
            .showLabelOnTop();
    fraga4.addChild(narOchHur);

    FkOverflowableValueField paverkan =
        new FkOverflowableValueField(intyg.getFunktionsnedsattningPaverkan(), getText("FRG_16.RBK"))
            .size(KATEGORI_FULL_WIDTH, 29.25f)
            .offset(0f, 29.25f)
            .withBorders(Rectangle.BOTTOM)
            .showLabelOnTop();
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga5 =
        new FkFieldGroup("5. " + getText("FRG_25.RBK"))
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga6 =
        new FkFieldGroup("6. " + getText("FRG_26.RBK"))
    ...
    // --------------------------------------------------------------------------
    FkFieldGroup fraga7 =
        new FkFieldGroup("7. Underskrift")
