...
public final class UtlatandeToIntyg {
  ...
  public static Intyg convert(
      LuaefsUtlatandeV1 utlatande, WebcertModuleService webcertModuleService) {
  ...
  private static List<Svar> getSvar(
      LuaefsUtlatandeV1 source, WebcertModuleService webcertModuleService) {
    ...
    addIfNotBlank(
        ...
        FUNKTIONSNEDSATTNING_DEBUT_DELSVAR_ID_15,
        source.getFunktionsnedsattningDebut());
    addIfNotBlank(
        svars,
        FUNKTIONSNEDSATTNING_PAVERKAN_SVAR_ID_16,
        FUNKTIONSNEDSATTNING_PAVERKAN_DELSVAR_ID_16,
