 ...
 */
public class IntygTextsLuaefsRepositoryTestHelper extends IntygTextsRepositoryImpl {

    public IntygTextsLuaefsRepositoryTestHelper() {
    ...
    public void update()  {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ClassPathResource("text/texterMU_LUAE_FS_v1.0.xml").getInputStream());
