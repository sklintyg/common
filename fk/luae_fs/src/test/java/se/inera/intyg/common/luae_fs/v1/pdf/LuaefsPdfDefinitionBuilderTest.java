...
public class LuaefsPdfDefinitionBuilderTest {
  ...
  private void generate(
    ...
    FkPdfDefinition pdfDefinition =
        luaefsPdfDefinitionBuilder.buildPdfDefinition(
            utlatandeV1,
            statuses,
            origin,
            intygTextsService.getIntygTextsPojo("luae_fs", textVersion),
            utkastStatus,
            "printedByText");
  ...
  private void writePdfToFile(
    ...
    File file =
        new File(
            String.format(
                "%s/%s-%s-%s-%s", dir, origin.name(), scenarioName, namingPrefix, "luae_fs.pdf"));
