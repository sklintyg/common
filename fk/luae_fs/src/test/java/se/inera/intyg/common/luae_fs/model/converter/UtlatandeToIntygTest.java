...
public class UtlatandeToIntygTest {
    ...
    public void testConvert() throws Exception {
        ...
        LuaefsUtlatande utlatande = buildUtlatande(intygsId, textVersion, enhetsId, enhetsnamn, patientPersonId,
    ...
    public void testConvertWithRelation() {
        ...
        LuaefsUtlatande utlatande = buildUtlatande(relationKod, relationIntygsId);
    ...
    public void testConvertDoesNotAddSvarForDiagnosWithoutCode() {
        ...
        LuaefsUtlatande utlatande = buildUtlatande().toBuilder().setDiagnoser(Arrays.asList(diagnos)).build();
    ...
    public void testConvertUnderlagEmptyUnderlagsTyp() {
        LuaefsUtlatande utlatande = buildUtlatande().toBuilder()
    ...
    private LuaefsUtlatande buildUtlatande() {
    ...
    private LuaefsUtlatande buildUtlatande(String intygsId, String textVersion, String enhetsId, String enhetsnamn,
