...
public class InternalValidatorTest {
    ...
    public void test() throws ScenarioNotFoundException {
        int numErrors = 0;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel();
    ...
    public void failsWhenNoDiagnosis() throws ScenarioNotFoundException {
        int numErrors = 1;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-diagnos-saknas").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
    ...
    public void failsWhenBaseratPaSaknas() throws ScenarioNotFoundException {
        int numErrors = 1;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-baseratpa-saknas").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
    ...
    public void failsWhenUnderlagFinnesIsTrueAndHamtasFranHasOnlyWhitespaces() throws ScenarioNotFoundException {
        int numErrors = 1;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-underlagfinnes-whitespace").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
    ...
    public void failsWhenUnderlagFinnesMenEjAngivet() throws ScenarioNotFoundException {
        int numErrors = 1;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-underlagfinnes-ej-men-angivet").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
    ...
    public void failsWhenUnderlagFinnesIsFalseAndUnderlagExists() throws ScenarioNotFoundException {
        int numErrors = 1;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-underlagfinnes-men-ej-angivet").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
    ...
    public void failsWhenFunktionsnedsattningHasOnlyWhitespaces() throws ScenarioNotFoundException {
        int numErrors = 2;
        LuaefsUtlatandeV1 utlatandeFromJson = ScenarioFinder.getInternalScenario("fail-funktionsnedsattning-whitespace").asInternalModel();
        ValidateDraftResponse internalValidationResponse = internalValidator.validateDraft(utlatandeFromJson);
        assertEquals(numErrors, getNumberOfInternalValidationErrors(internalValidationResponse));
    }
