        ...
        function _getConfig(viewState) {
          ...
          var config = [
            ...
            kategori(categoryIds[1], 'KAT_1.RBK', 'KAT_1.HLP', {}, [
              ...
              fraga(null, '', '',
                  {hideExpression: '!(model.syn.progressivOgonsjukdom || model.syn.nattblindhet || model.syn.synfaltsdefekter)'}, [{
                    type: 'ue-alert',
                    alertType: 'warning',
                    key: 'FRG_3-5.INF'
                  }]),
            ...
            kategori(categoryIds[2], 'KAT_2.RBK', 'KAT_2.HLP', {}, [
              ...
              fraga(11, 'FRG_11.RBK', 'FRG_11.HLP',
                  {required: true, hideExpression: korkortHogreBehorighet, requiredProp: 'horselBalans.svartUppfattaSamtal4Meter'}, [{
                    type: 'ue-radio',
            ...
            kategori(categoryIds[3], 'KAT_3.RBK', 'KAT_3.HLP', {}, [
              ...
              fraga(13, 'FRG_13.RBK', 'FRG_13.HLP', {
                required: true, hideExpression: korkortHogreBehorighet,
            ...
            kategori(categoryIds[5], 'KAT_5.RBK', 'KAT_5.HLP', {}, [
              ...
              fraga(18, 'FRG_18.RBK', 'FRG_18.HLP',
                  {required: true, hideExpression: '!model.diabetes.harDiabetes', requiredProp: 'diabetes.diabetesTyp'}, [{
                    type: 'ue-radiogroup',
            ...
            kategori(categoryIds[11], 'KAT_11.RBK', 'KAT_11.HLP', {}, [
              ...
              fraga(25, 'DFR_25.3.RBK', '', {
                required: true,
                hideExpression: '!(model.narkotikaLakemedel.teckenMissbruk || model.narkotikaLakemedel.foremalForVardinsats)',
