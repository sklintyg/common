 ...
 */
package se.inera.intyg.common.ts_bas.v7.testability;
...
public class TsBasV7TestabilityCertificateTestdataProvider
  ...
  public Map<String, CertificateDataValue> getMinimumValues() {
    ...
    final var intygetAvser =
        getDataValueCodeList(IntygAvserKategori.IAV1.name(), IntygAvserKategori.IAV1.name());
    ...
    final var funktionsnedsattning =
        getDataValueBoolean(SJUKDOM_FUNKTIONSNEDSATTNING_JSON_ID, false);
    ...
    final var kognitivFormoga =
        getDataValueBoolean(TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_JSON_ID, false);
    values.put(TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_SVAR_ID, kognitivFormoga);

    final var somnOchVakenhetsstorningar =
        getDataValueBoolean(TECKEN_SOMN_ELLER_VAKENHETSSTORNING_JSON_ID, false);
    ...
    final var alkoholVardinsats =
        getDataValueBoolean(VARDINSATSER_MISSBRUK_BEROENDE_JSON_ID, false);
    values.put(VARDINSATSER_MISSBRUK_BEROENDE_DELSVAR_ID, alkoholVardinsats);

    final var alhoholLakarordinerat =
        getDataValueBoolean(REGELBUNDET_LAKARORDINERAT_BRUK_LAKEMEDEL_JSON_ID, false);
    values.put(REGELBUNDET_LAKARORDINERAT_BRUK_LAKEMEDEL_DELSVAR_ID, alhoholLakarordinerat);

    final var psykiskStorning =
        getDataValueBoolean(PSYKISK_SJUKDOM_STORNING_DELSVAR_JSON_ID, false);
    values.put(PSYKISK_SJUKDOM_STORNING_DELSVAR_ID, psykiskStorning);

    final var utvecklingsStorning =
        getDataValueBoolean(PSYKISK_UTVECKLINGSSTORNING_DELSVAR_JSON_ID, false);
    values.put(PSYKISK_UTVECKLINGSSTORNING_DELSVAR_ID, utvecklingsStorning);

    final var symptom =
        getDataValueBoolean(ADHD_ADD_DAMP_ASPERGERS_TOURETTES_DELSVAR_JSON_ID, false);
    values.put(ADHD_ADD_DAMP_ASPERGERS_TOURETTES_DELSVAR_ID, symptom);

    final var sjukhusVard =
        getDataValueBoolean(FOREKOMST_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_JSON_ID, false);
    values.put(FOREKOMST_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_ID, sjukhusVard);

    final var stadigvarandeMedicinering =
        getDataValueBoolean(FOREKOMST_STADIGVARANDE_MEDICINERING_DELSVARSVAR_JSON_ID, false);
    values.put(FOREKOMST_STADIGVARANDE_MEDICINERING_DELSVARSVAR_ID, stadigvarandeMedicinering);

    final var bedomning =
        getDataValueCodeList(BedomningKorkortstyp.VAR11.name(), BedomningKorkortstyp.VAR11.name());
  ...
  public Map<String, CertificateDataValue> getMaximumValues() {
    ...
    final var korrektionsglasensStyrka =
        getDataValueBoolean(UNDERSOKNING_8_DIOPTRIERS_KORREKTIONSGRAD_JSON_ID, true);
    ...
    final var funktionsnedsattning =
        getDataValueBoolean(SJUKDOM_FUNKTIONSNEDSATTNING_JSON_ID, true);
    values.put(SJUKDOM_FUNKTIONSNEDSATTNING_SVAR_ID, funktionsnedsattning);

    final var funktionsnedsattningBeskrivning =
        getDataValueText(TYP_SJUKDOM_FUNKTIONSNEDSATTNING_JSON_ID, "beskrivning");
    values.put(TYP_SJUKDOM_FUNKTIONSNEDSATTNING_DELSVAR_ID, funktionsnedsattningBeskrivning);

    final var funktionsnedsattningRoresleformoga =
        getDataValueBoolean(OTILLRACKLIG_RORELSEFORMAGA_JSON_ID, false);
    ...
    final var typAvSjukdom =
        getDataValueText(TYP_AV_SJUKDOM_RISKFAKTORER_STROKE_JSON_ID, "typ av sjukdom");
    ...
    final var diabetesKod =
        getDataValueCode(DiabetesKod.DIABETES_TYP_2.name(), DiabetesKod.DIABETES_TYP_2.name());
    ...
    final var medvetandestorningBeskrivning =
        getDataValueText(FOREKOMST_MEDVETANDESTORNING_JSON_ID, "ange när den inträffade och orsak");
    ...
    final var kognitivFormoga =
        getDataValueBoolean(TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_JSON_ID, true);
    values.put(TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_SVAR_ID, kognitivFormoga);

    final var somnOchVakenhetsstorningar =
        getDataValueBoolean(TECKEN_SOMN_ELLER_VAKENHETSSTORNING_JSON_ID, true);
    values.put(TECKEN_SOMN_ELLER_VAKENHETSSTORNING_SVAR_ID, somnOchVakenhetsstorningar);
    ...
    final var alkoholProvtagning =
        getDataValueBoolean(PROVTAGNING_AVSEENDE_AKTUELLT_BRUK_JSON_ID, true);
    values.put(PROVTAGNING_AVSEENDE_AKTUELLT_BRUK_DELSVAR_ID, alkoholProvtagning);

    final var alhoholLakarordinerat =
        getDataValueBoolean(REGELBUNDET_LAKARORDINERAT_BRUK_LAKEMEDEL_JSON_ID, true);
    values.put(REGELBUNDET_LAKARORDINERAT_BRUK_LAKEMEDEL_DELSVAR_ID, alhoholLakarordinerat);

    final var alkoholOrdineradDos =
        getDataValueText(LAKEMEDEL_ORDINERAD_DOS_DELSVAR_JSON_ID, "Läkemedel och ordinerad dos");
    ...
    final var utvecklingsStorning =
        getDataValueBoolean(PSYKISK_UTVECKLINGSSTORNING_DELSVAR_JSON_ID, true);
    values.put(PSYKISK_UTVECKLINGSSTORNING_DELSVAR_ID, utvecklingsStorning);

    final var symptom =
        getDataValueBoolean(ADHD_ADD_DAMP_ASPERGERS_TOURETTES_DELSVAR_JSON_ID, true);
    values.put(ADHD_ADD_DAMP_ASPERGERS_TOURETTES_DELSVAR_ID, symptom);

    final var sjukhusVard =
        getDataValueBoolean(FOREKOMST_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_JSON_ID, true);
    values.put(FOREKOMST_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_ID, sjukhusVard);

    final var sjukhusVardTidpunkt =
        getDataValueText(TIDPUNKT_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_JSON_ID, "tidpunkt");
    values.put(TIDPUNKT_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_ID, sjukhusVardTidpunkt);

    final var sjukhusVardVardinrattningensNamn =
        getDataValueText(PLATS_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_JSON_ID, "enhetens namn");
    values.put(PLATS_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_ID, sjukhusVardVardinrattningensNamn);

    final var sjukhusVardOrsak =
        getDataValueText(ORSAK_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_JSON_ID, "orsak");
    values.put(ORSAK_VARD_SJUKHUS_KONTAKT_LAKARE_DELSVAR_ID, sjukhusVardOrsak);

    final var stadigvarandeMedicinering =
        getDataValueBoolean(FOREKOMST_STADIGVARANDE_MEDICINERING_DELSVARSVAR_JSON_ID, true);
    values.put(FOREKOMST_STADIGVARANDE_MEDICINERING_DELSVARSVAR_ID, stadigvarandeMedicinering);

    final var ovrigBeskrivning =
        getDataValueText(
