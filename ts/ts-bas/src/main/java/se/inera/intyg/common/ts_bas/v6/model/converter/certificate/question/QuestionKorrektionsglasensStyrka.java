...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.UNDERSOKNING_8_DIOPTRIERS_KORREKTIONSGRAD_TEXT_ID;
        ...
        return CertificateDataElement.builder()
            ...
            .value(
                CertificateDataValueViewText.builder()
                    .text(booleanValue(korrektionsglasensStyrka))
                    .build()
            )
            .build();
    }
