...
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionStadigvarandeMedicineringBeskrivning;
...
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionTidpunktVardPaSjukhus;
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionUppfattaSamtalFyraMeter;
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionVardatsPaSjukhus;
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionVardatsPaSjukhusOrsak;
import se.inera.intyg.common.ts_bas.v6.model.converter.certificate.question.QuestionVardinrattningensNamn;
...
public class InternalToCertificate {
  ...
  public Certificate convert(TsBasUtlatandeV6 internalCertificate, CertificateTextProvider texts) {
    ...
    return CertificateBuilder.create()
        ...
        .addElement(
            QuestionHjartOchKarlsjukdomar.toCertificate(
        ...
        .addElement(CategoryAlkoholNarkotikaOchLakemedel.toCertificate(index++, texts))
        .addElement(
            QuestionAlkoholNarkotikaTeckenMissbruk.toCertificate(
        ...
        .addElement(
            QuestionAlkoholNarkotikaProvtagningMessage.toCertificate(
                internalCertificate.getNarkotikaLakemedel(), index++, texts))
        .addElement(
            QuestionAlkoholNarkotikaLakarordineratLakemedelsbruk.toCertificate(
                internalCertificate.getNarkotikaLakemedel(), index++, texts))
        .addElement(
            QuestionAlkoholNarkotikaLakarordineratDos.toCertificate(
                internalCertificate.getNarkotikaLakemedel(), index++, texts))
        .addElement(CategoryPsykiskSjukdom.toCertificate(index++, texts))
        .addElement(
        ...
        .addElement(
            QuestionPsykiskSyndrom.toCertificate(
                internalCertificate.getUtvecklingsstorning(), index++, texts))
        ...
        .addElement(
            QuestionStadigvarandeMedicineringBeskrivning.toCertificate(
                internalCertificate.getMedicinering(), index++, texts))
        .addElement(CategoryOvrigKommentar.toCertificate(index++, texts))
        .addElement(
            QuestionOvrigKommentar.toCertificate(
                internalCertificate.getKommentar(), index++, texts))
