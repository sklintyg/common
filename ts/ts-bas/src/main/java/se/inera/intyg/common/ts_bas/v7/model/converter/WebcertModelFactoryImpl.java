...
public class WebcertModelFactoryImpl implements WebcertModelFactory<TsBasUtlatandeV7> {
   ...
   */
  @Override
  public TsBasUtlatandeV7 createNewWebcertDraft(CreateNewDraftHolder newDraftData)
  ...
  @Override
  public TsBasUtlatandeV7 createCopy(CreateDraftCopyHolder copyData, Utlatande template)
      throws ConverterException {
  ...
  private void populateWithId(TsBasUtlatandeV7.Builder utlatande, String utlatandeId)
      throws ConverterException {
