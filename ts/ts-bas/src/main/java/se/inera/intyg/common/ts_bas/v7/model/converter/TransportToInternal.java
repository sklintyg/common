...
public final class TransportToInternal {
    ...
    private static void setSvar(TsBasUtlatandeV7.Builder utlatande, Intyg source) throws ConverterException {
    ...
    private static void handleIntygAvser(TsBasUtlatandeV7.Builder utlatande, Svar svar,
    ...
    private static void handleIdentitetStyrktGenom(TsBasUtlatandeV7.Builder utlatande, Svar svar) throws ConverterException {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleTeckenNeurologiskSjukdom(TsBasUtlatandeV7.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleTeckenSviktandeKognitivFunktion(TsBasUtlatandeV7.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleTeckenSomnEllerVakenhetsstorning(TsBasUtlatandeV7.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleVardSjukhusKontaktLakare(TsBasUtlatandeV7.Builder utlatande, Svar svar) {
    ...
    private static void handleStadigvarandeMedicinering(TsBasUtlatandeV7.Builder utlatande, Svar svar) {
