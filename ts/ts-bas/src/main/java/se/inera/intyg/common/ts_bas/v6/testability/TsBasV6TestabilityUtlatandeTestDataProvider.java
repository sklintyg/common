...
public class TsBasV6TestabilityUtlatandeTestDataProvider
    implements TestabilityUtlatandeTestDataProvider<TsBasUtlatandeV6> {
    ...
    return utlatande.toBuilder()
        ...
        .setSyn(
            Syn.builder()
                ...
                .setDiplopi(false)
                .setNystagmus(false)
                .setHogerOga(Synskarpevarden.builder().setUtanKorrektion(2.0).build())
                .setVansterOga(Synskarpevarden.builder().setUtanKorrektion(2.0).build())
                .setBinokulart(Synskarpevarden.builder().setUtanKorrektion(2.0).build())
                .build())
        .setHorselBalans(HorselBalans.builder().setBalansrubbningar(false).build())
        .setFunktionsnedsattning(
            Funktionsnedsattning.builder().setFunktionsnedsattning(false).build())
        .setHjartKarl(
            HjartKarl.builder()
                ...
                .build())
        .setDiabetes(Diabetes.builder().setHarDiabetes(false).build())
        .setNeurologi(Neurologi.create(false))
        .setMedvetandestorning(Medvetandestorning.builder().setMedvetandestorning(false).build())
        .setNjurar(Njurar.create(false))
        .setKognitivt(Kognitivt.create(false))
        .setSomnVakenhet(SomnVakenhet.create(false))
        .setNarkotikaLakemedel(
            NarkotikaLakemedel.builder()
                ...
                .build())
        .setPsykiskt(Psykiskt.create(false))
        .setUtvecklingsstorning(
            Utvecklingsstorning.builder()
                .setPsykiskUtvecklingsstorning(false)
                .setHarSyndrom(false)
                .build())
        .setSjukhusvard(Sjukhusvard.builder().setSjukhusEllerLakarkontakt(false).build())
        .setMedicinering(Medicinering.builder().setStadigvarandeMedicinering(false).build())
        .setBedomning(
            Bedomning.builder()
            ...
            Syn.builder()
                ...
                .setVansterOga(
                    Synskarpevarden.builder()
                        ...
                        .build())
                .setBinokulart(
                    Synskarpevarden.builder().setUtanKorrektion(0.1).setMedKorrektion(2.0).build())
