...
public class QuestionSynskarpa {
    ...
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigVisualAcuity.builder()
                ...
                .rightEye(getRightEyeConfig(textProvider))
                .leftEye(getLeftEyeConfig(textProvider))
                .binocular(getBinocularConfig(textProvider))
                .build())
        .value(
            CertificateDataValueVisualAcuities.builder()
                .rightEye(getRightEyeValue(hogerOga))
                .leftEye(getLeftEyeValue(vansterOga))
                .binocular(getBinocularValue(binokulart))
                .build())
        .validation(
    ...
    return CertificateDataValueVisualAcuity.builder()
        .withoutCorrection(
            CertificateDataValueDouble.builder()
                ...
                .value(
                    binokulart != null && binokulart.getUtanKorrektion() != null
                        ? binokulart.getUtanKorrektion()
                        : null)
                .build())
        .withCorrection(
            CertificateDataValueDouble.builder()
                ...
                .value(
                    binokulart != null && binokulart.getMedKorrektion() != null
                        ? binokulart.getMedKorrektion()
                        : null)
                .build())
        .build();
  }
    ...
    return CertificateDataValueVisualAcuity.builder()
        .withoutCorrection(
            CertificateDataValueDouble.builder()
                ...
                .value(
                    vansterOga != null && vansterOga.getUtanKorrektion() != null
                        ? vansterOga.getUtanKorrektion()
                        : null)
                .build())
        .withCorrection(
            CertificateDataValueDouble.builder()
                ...
                .value(
                    vansterOga != null && vansterOga.getMedKorrektion() != null
                        ? vansterOga.getMedKorrektion()
                        : null)
                .build())
        .contactLenses(
            CertificateDataValueBoolean.builder()
                ...
                .selected(
                    vansterOga != null && vansterOga.getKontaktlins() != null
                        ? vansterOga.getKontaktlins()
                        : null)
                .build())
        .build();
  }
    ...
    return CertificateDataValueVisualAcuity.builder()
        ...
        .contactLenses(
            CertificateDataValueBoolean.builder()
                ...
                .selected(
                    hogerOga != null && hogerOga.getKontaktlins() != null
                        ? hogerOga.getKontaktlins()
                        : null)
                .build())
        .build();
  }
  ...
  public static Synskarpevarden toInternal(Certificate certificate, VisualAcuityEnum type) {
    ...
    return Synskarpevarden.builder()
        .setUtanKorrektion(visualAcuityValue.getWithoutCorrection().getValue())
        .setMedKorrektion(visualAcuityValue.getWithCorrection().getValue())
        .setKontaktlins(
