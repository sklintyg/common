...
public class QuestionIdentitetStyrktGenom {
  ...
  public static CertificateDataElement toCertificate(
      Vardkontakt vardkontakt, int index, CertificateTextProvider textProvider) {
    final var identitetStyrktGenom =
        vardkontakt != null && vardkontakt.getIdkontroll() != null
            ? vardkontakt.getIdkontroll()
            : null;
                ...
                .list(
                    Arrays.asList(
                        ...
                        RadioMultipleCode.builder()
                            ...
                            .label(
                                textProvider.get(
                                    IDENTITET_STYRKT_GENOM_FORETAG_ELLER_TJANSTEKORT_TEXT_ID))
                            .build(),
                        RadioMultipleCode.builder()
