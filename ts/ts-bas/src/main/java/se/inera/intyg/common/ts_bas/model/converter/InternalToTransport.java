...
public final class InternalToTransport {
    ...
    private static IdentitetStyrkt buildIdentitetStyrkt(se.inera.intyg.common.ts_bas.model.internal.Vardkontakt source)
            throws ConverterException {
    ...
    private static Medvetandestorning buildMedvetandestorning(se.inera.intyg.common.ts_bas.model.internal.Medvetandestorning source) {
    ...
    private static Sjukhusvard buildSjukhusvard(se.inera.intyg.common.ts_bas.model.internal.Sjukhusvard source) {
    ...
    private static Utvecklingsstorning buildUtvecklingsstorning(
            se.inera.intyg.common.ts_bas.model.internal.Utvecklingsstorning source) {
