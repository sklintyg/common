...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.TECKEN_NEUROLOGISK_SJUKDOM_SVAR_TEXT_ID;
    ...
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(
            CertificateDataValueViewText.builder().text(booleanValue(neurologiskSjukdom)).build())
        .build();
  }
}
