...
public class QuestionAlkoholNarkotikaOrdineratLakamedel {
    ...
    public static CertificateDataElement toCertificate(String lakamedelOrdineradDos, int index, CertificateTextProvider textProvider) {
