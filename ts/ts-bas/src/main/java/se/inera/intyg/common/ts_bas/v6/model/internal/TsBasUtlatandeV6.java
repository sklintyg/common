...
public abstract class TsBasUtlatandeV6 implements Utlatande {
  ...
  @Nullable public abstract Vardkontakt getVardkontakt();

  @Nullable public abstract IntygAvser getIntygAvser();

  @Nullable public abstract Syn getSyn();

  @Nullable public abstract HorselBalans getHorselBalans();

  @Nullable public abstract Funktionsnedsattning getFunktionsnedsattning();

  @Nullable public abstract HjartKarl getHjartKarl();

  @Nullable public abstract Diabetes getDiabetes();

  @Nullable public abstract Neurologi getNeurologi();

  @Nullable public abstract Medvetandestorning getMedvetandestorning();

  @Nullable public abstract Njurar getNjurar();

  @Nullable public abstract Kognitivt getKognitivt();

  @Nullable public abstract SomnVakenhet getSomnVakenhet();

  @Nullable public abstract NarkotikaLakemedel getNarkotikaLakemedel();

  @Nullable public abstract Psykiskt getPsykiskt();

  @Nullable public abstract Utvecklingsstorning getUtvecklingsstorning();

  @Nullable public abstract Sjukhusvard getSjukhusvard();

  @Nullable public abstract Medicinering getMedicinering();
  ...
  public abstract static class Builder {
    ...
    public abstract TsBasUtlatandeV6 build();
