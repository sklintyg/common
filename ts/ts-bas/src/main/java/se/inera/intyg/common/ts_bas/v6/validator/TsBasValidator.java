...
@Component("ts-bas.v6.TsBasValidator")
public class TsBasValidator implements InternalDraftValidator<TsBasUtlatandeV6> {

    /**
     * Validates an internal Utlatande.
     *
     * @param utlatande TsBasUtlatandeV6
     * @return List of validation errors, or an empty string if validated correctly.
     */
    @Override
    public ValidateDraftResponse validateDraft(TsBasUtlatandeV6 utlatande) {
