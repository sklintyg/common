...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.INTYG_AVSER_CATEGORY_DESCRIPTION_ID;
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.INTYG_AVSER_CATEGORY_ID;
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.INTYG_AVSER_CATEGORY_TEXT_ID;
        ...
        return CertificateDataElement.builder()
            ...
            .config(
                CertificateDataConfigCategory.builder()
                    ...
                    .description(texts.get(INTYG_AVSER_CATEGORY_DESCRIPTION_ID))
                    .build()
            )
            .build();
    }
