...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.VARD_SJUKHUS_KONTAKT_LAKARE_CATEGORY_TEXT_ID;

import se.inera.intyg.common.services.texts.CertificateTextProvider;
import se.inera.intyg.common.support.facade.model.CertificateDataElement;
import se.inera.intyg.common.support.facade.model.config.CertificateDataConfigCategory;

public class CategorySjukhusvard {

    public static CertificateDataElement toCertificate(int index, CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            .id(VARD_SJUKHUS_KONTAKT_LAKARE_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigCategory.builder()
                    .text(textProvider.get(VARD_SJUKHUS_KONTAKT_LAKARE_CATEGORY_TEXT_ID))
                    .build()
            )
            .build();
    }
