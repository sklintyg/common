...
import static se.inera.intyg.common.ts_bas.v7.codes.RespConstantsV7.TECKEN_SOMN_ELLER_VAKENHETSSTORNING_DELSVAR_JA_TEXT_ID;
import static se.inera.intyg.common.ts_bas.v7.codes.RespConstantsV7.TECKEN_SOMN_ELLER_VAKENHETSSTORNING_DELSVAR_NEJ_TEXT_ID;
        ...
        return CertificateDataElement.builder()
            ...
            .config(
                CertificateDataConfigRadioBoolean.builder()
                    ...
                    .selectedText(textProvider.get(TECKEN_SOMN_ELLER_VAKENHETSSTORNING_DELSVAR_JA_TEXT_ID))
                    .unselectedText(textProvider.get(TECKEN_SOMN_ELLER_VAKENHETSSTORNING_DELSVAR_NEJ_TEXT_ID))
                    .build()
            )
            .value(
