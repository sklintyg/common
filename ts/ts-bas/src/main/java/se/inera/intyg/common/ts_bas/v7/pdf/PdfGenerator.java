...
@Component("ts-bas.v7.PdfGenerator")
public class PdfGenerator {

  private static final String PDF_LOGOTYPE_CLASSPATH_URI = "transportstyrelsens_logotyp_rgb.png";
  private static final String PDF_UP_MODEL_CLASSPATH_URI = "ts-bas-uv-viewmodel.v7.js";
  private static final String PDF_SUMMARY_HEADER =
  ...
  private String getCleanModuleDescription(IntygTexts intygTexts) {
    ...
    return rawText != null
        ? rawText.replace("<LINK:transportstyrelsen>", "www.transportstyrelsen.se")
        : rawText;
  }
  ...
  private String buildFilename() {
    ...
    return CERTIFICATE_FILE_PREFIX
        + now.format(DateTimeFormatter.ofPattern("yy-MM-dd_HHmm"))
        + ".pdf";
  }
