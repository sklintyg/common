...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.BEHORIGHET_LAKARE_SPECIALKOMPETENS_SVAR_TEXT_ID;
...
class QuestionBedomningLakareSpecialKompetensTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionBedomningLakareSpecialKompetens.toCertificate(null, 0, textProvider);
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<Bedomning> {

    @Override
    protected CertificateDataElement getElement(Bedomning expectedValue) {
      return QuestionBedomningLakareSpecialKompetens.toCertificate(expectedValue, 0, textProvider);
    }
    ...
    protected List<InputExpectedValuePair<Bedomning, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Bedomning.builder().setLakareSpecialKompetens("lakareSpecialkompetens").build(),
