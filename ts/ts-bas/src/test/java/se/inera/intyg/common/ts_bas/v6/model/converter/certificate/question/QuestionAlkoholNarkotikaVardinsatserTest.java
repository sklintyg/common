...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.VARDINSATSER_MISSBRUK_BEROENDE_TEXT_ID;
...
class QuestionAlkoholNarkotikaVardinsatserTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionAlkoholNarkotikaVardinsatser.toCertificate(null, 0, textProvider);
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return VARDINSATSER_MISSBRUK_BEROENDE_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<NarkotikaLakemedel> {

    @Override
    protected CertificateDataElement getElement(NarkotikaLakemedel expectedValue) {
      return QuestionAlkoholNarkotikaVardinsatser.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<NarkotikaLakemedel, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              NarkotikaLakemedel.builder().setForemalForVardinsats(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              NarkotikaLakemedel.builder().setForemalForVardinsats(false).build(),
