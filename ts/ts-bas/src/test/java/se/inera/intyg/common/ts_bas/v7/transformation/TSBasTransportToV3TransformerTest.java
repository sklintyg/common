...
public class TSBasTransportToV3TransformerTest {
    ...
    public void testTransformation() throws Exception {
        ...
        for (String xmlFile : testFiles) {
            ...
            String xmlContents = Resources.toString(getResource("v7/scenarios/transport/" + xmlFile), Charsets.UTF_8);
            ...
            String expectedXmlContents = Resources.toString(getResource("v7/scenarios/rivtav3/" + xmlFile), Charsets.UTF_8);
