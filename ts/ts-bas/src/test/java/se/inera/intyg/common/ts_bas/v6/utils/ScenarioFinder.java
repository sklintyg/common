...
public final class ScenarioFinder {
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    public RegisterTSBasType asTransportModel() throws ScenarioNotFoundException {
      try {
        JAXBElement<RegisterTSBasType> el =
    ...
    public se.riv
      ...
      try {
        JAXBElement<
            ...
            el =
                XmlMarshallerHelper.unmarshal(
                    getTransportModelFor(getName(), RIVTA_V1_TRANSPORT_MODEL_PATH));
        return el.getValue();
      } catch (IOException e) {
    ...
    /** {@inheritDoc} */
    @Override
    public TsBasUtlatandeV6 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), TsBasUtlatandeV6.class);
      } catch (IOException e) {
