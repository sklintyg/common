...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.SJUKDOM_FUNKTIONSNEDSATTNING_CATEGORY_TEXT_ID;
...
class CategoryFunktionsnedsattningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryFunktionsnedsattning.toCertificate(0,
                textProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return CategoryFunktionsnedsattning.toCertificate(0, textProvider);
        }

        @Override
        protected String getTextId() {
            return SJUKDOM_FUNKTIONSNEDSATTNING_CATEGORY_TEXT_ID;
        }
