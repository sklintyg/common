...
public final class XPathExpressionsV1 {
    ...
    public static final String REKOMMENDATION_VARDE_TEMPLATE = "utlatande/p:rekommendation/p2:varde/@code = '%s'";

    public static final String REKOMMENDATION_BESKRIVNING_TEMPLATE = "utlatande/p:rekommendation/p:beskrivning[parent::p:rekommendation/p:rekommendationskod/@code='%s']";
