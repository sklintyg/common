...
class QuestionHjarnskadaEfterTraumaTest {
    ...
    class ToCertificate {
        ...
        class IncludeCommonElementTests extends CommonElementTest {
            ...
            protected CertificateDataElement getElement() {
                return QuestionHjarnskadaEfterTrauma.toCertificate(null, 0, textProvider);
            }

            @Override
            protected String getId() {
                return TECKEN_PA_HJARNSKADA_SVAR_ID;
            }
        ...
        class IncludeConfigRadioBooleanTests extends ConfigRadioBooleanTest {
            ...
            @Override
            protected String getId() {
                return TECKEN_PA_HJARNSKADA_JSON_ID;
            }
            ...
            protected String getTextId() {
                return TECKEN_PA_HJARNSKADA_SVAR_TEXT_ID;
            }
        ...
        class IncludeValidationMandatory extends ValidationMandatoryTest {
            ...
            protected String getExpression() {
                return "exists(" + TECKEN_PA_HJARNSKADA_JSON_ID + ")";
            }
    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                final var hjartKarl = HjartKarl.builder().setHjarnskadaEfterTrauma(expectedValue).build();
                return QuestionHjarnskadaEfterTrauma.toCertificate(hjartKarl, 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionHjarnskadaEfterTrauma.toInternal(certificate);
            }
        }
    }
}