...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.NEDSATT_NJURFUNKTION_SVAR_TEXT_ID;
...
class QuestionNedsattNjurfunktionTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionNedsattNjurfunktion.toCertificate(null, 0, textProvider);
    }

    @Override
    protected String getId() {
      return NEDSATT_NJURFUNKTION_SVAR_ID;
    }

    @Override
    protected String getParent() {
      return NJURFUNKTION_CATEGORY_ID;
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return NEDSATT_NJURFUNKTION_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<Njurar> {

    @Override
    protected CertificateDataElement getElement(Njurar expectedValue) {
      return QuestionNedsattNjurfunktion.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<Njurar, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              Njurar.create(true), CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Njurar.create(false), CertificateDataValueViewText.builder().text("Nej").build()));
    }
  }
}
