...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.TECKEN_SOMN_ELLER_VAKENHETSSTORNING_CATEGORY_TEXT_ID;
...
class CategorySomnOchVakenhetsstorningarTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategorySomnOchVakenhetsstorningar.toCertificate(0, textProvider);
        }
    ...
    class IncludeConfigCategoryTest extends ConfigCategoryTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return CategorySomnOchVakenhetsstorningar.toCertificate(1, textProvider);
        }

        @Override
        protected String getTextId() {
            return TECKEN_SOMN_ELLER_VAKENHETSSTORNING_CATEGORY_TEXT_ID;
        }
