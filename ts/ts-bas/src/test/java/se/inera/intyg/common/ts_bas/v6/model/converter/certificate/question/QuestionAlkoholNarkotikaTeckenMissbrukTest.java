...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.TECKEN_MISSBRUK_BEROENDE_JOURNAL_TEXT_ID;
...
class QuestionAlkoholNarkotikaTeckenMissbrukTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionAlkoholNarkotikaTeckenMissbruk.toCertificate(null, 0, textProvider);
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<NarkotikaLakemedel> {
    ...
    protected CertificateDataElement getElement(NarkotikaLakemedel expectedValue) {
      return QuestionAlkoholNarkotikaTeckenMissbruk.toCertificate(expectedValue, 0, textProvider);
    }
    ...
    protected List<InputExpectedValuePair<NarkotikaLakemedel, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              NarkotikaLakemedel.builder().setTeckenMissbruk(false).build(),
