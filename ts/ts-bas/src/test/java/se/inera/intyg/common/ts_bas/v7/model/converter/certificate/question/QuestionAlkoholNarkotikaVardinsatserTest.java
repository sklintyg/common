...
class QuestionAlkoholNarkotikaVardinsatserTest {
    ...
    class ToCertificate {
        ...
        class IncludeValueRadioBooleanTest extends ValueBooleanTest {
            ...
            @Override
            protected CertificateDataElement getElement() {
                return QuestionAlkoholNarkotikaVardinsatser.toCertificate(
                    NarkotikaLakemedel.builder().setForemalForVardinsats(true).build(), 0, textProvider);
            }
        }
    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                return QuestionAlkoholNarkotikaVardinsatser.toCertificate(
                    NarkotikaLakemedel.builder().setForemalForVardinsats(expectedValue).build(), 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionAlkoholNarkotikaVardinsatser.toInternal(certificate);
            }
        }
    }
}