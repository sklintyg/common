...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.REGELBUNDET_LAKARORDINERAT_BRUK_LAKEMEDEL_TEXT_ID;
...
class QuestionAlkoholNarkotikaLakarordineratLakemedelsbrukTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionAlkoholNarkotikaLakarordineratLakemedelsbruk.toCertificate(null, 0, textProvider);
        }
    ...
    class IncludeValueViewText extends ValueViewTextTest<NarkotikaLakemedel> {
        ...
        protected CertificateDataElement getElement(NarkotikaLakemedel expectedValue) {
            return QuestionAlkoholNarkotikaLakarordineratLakemedelsbruk.toCertificate(expectedValue, 0, textProvider);
        }
        ...
        protected List<InputExpectedValuePair<NarkotikaLakemedel, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(
                    ...
                    NarkotikaLakemedel.builder().setLakarordineratLakemedelsbruk(false).build(),
