...
import static se.inera.intyg.common.ts_bas.v7.codes.RespConstantsV7.RISKFAKTORER_STROKE_SVAR_TEXT_ID;
...
class QuestionRiskfaktorerForStrokeTest {
    ...
    class ToCertificate {
        ...
        class IncludeCommonElementTests extends CommonElementTest {
            ...
            protected CertificateDataElement getElement() {
                return QuestionRiskfaktorerForStroke.toCertificate(null, 0, textProvider);
            }
    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                final var hjartKarl = HjartKarl.builder().setRiskfaktorerStroke(expectedValue).build();
                return QuestionRiskfaktorerForStroke.toCertificate(hjartKarl, 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionRiskfaktorerForStroke.toInternal(certificate);
            }
        }
    }
}