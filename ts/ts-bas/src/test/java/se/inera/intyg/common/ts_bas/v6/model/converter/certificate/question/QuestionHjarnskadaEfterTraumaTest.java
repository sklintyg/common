    ...
    class IncludeValueViewText extends ValueViewTextTest<HjartKarl> {
        ...
        protected List<InputExpectedValuePair<HjartKarl, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(HjartKarl.builder().setHjarnskadaEfterTrauma(true).build(),
                    CertificateDataValueViewText.builder().text("Ja").build()),
                new InputExpectedValuePair<>(HjartKarl.builder().setHjarnskadaEfterTrauma(false).build(),
