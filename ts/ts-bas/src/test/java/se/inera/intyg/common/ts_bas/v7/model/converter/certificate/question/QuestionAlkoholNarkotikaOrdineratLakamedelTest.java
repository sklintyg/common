...
class QuestionAlkoholNarkotikaOrdineratLakamedelTest {
    ...
    class ToCertificate {
        ...
        class IncludeValueTextTest extends ValueTextTest {
            ...
            @Override
            protected CertificateDataElement getElement() {
                return QuestionAlkoholNarkotikaOrdineratLakamedel.toCertificate(getText(), 0, textProvider);
            }
    ...
    class ToInternal {
        ...
        class IncludeInternalTextValue extends InternalTextValueTest {
            ...
            protected CertificateDataElement getElement(String expectedValue) {
                return QuestionAlkoholNarkotikaOrdineratLakamedel.toCertificate(expectedValue, 0, textProvider);
            }
