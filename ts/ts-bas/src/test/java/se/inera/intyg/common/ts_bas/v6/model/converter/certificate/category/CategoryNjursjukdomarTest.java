...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.NJURFUNKTION_CATEGORY_TEXT_ID;
...
class CategoryNjursjukdomarTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryNjursjukdomar.toCertificate(0, textProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return NJURFUNKTION_CATEGORY_TEXT_ID;
        }
