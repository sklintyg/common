...
class QuestionDiabetesBehandlingTest {
  ...
  class IncludeValueViewText extends ValueViewTextTest<Diabetes> {
    ...
    protected CertificateDataElement getElement(Diabetes expectedValue) {
      return QuestionDiabetesBehandling.toCertificate(expectedValue, 0, textProvider);
    }
    ...
    protected List<InputExpectedValuePair<Diabetes, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Diabetes.builder().setInsulin(true).build(),
              CertificateDataValueViewText.builder().text("Insulin").build()),
          new InputExpectedValuePair<>(
              Diabetes.builder().setInsulin(true).setTabletter(true).build(),
              CertificateDataValueViewText.builder().text("Tabletter, Insulin").build()),
          new InputExpectedValuePair<>(
              Diabetes.builder().setInsulin(true).setTabletter(true).setKost(true).build(),
              CertificateDataValueViewText.builder().text("Kost, Tabletter, Insulin").build()));
    }
  }
}
