...
class QuestionBeskrivningRiskfaktorerTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected String getId() {
      return HJART_ELLER_KARLSJUKDOM_TYP_AV_SJUKDOM_RISKFAKTORER_STROKE_DELSVAR_ID;
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return HJART_ELLER_KARLSJUKDOM_TYP_AV_SJUKDOM_RISKFAKTORER_STROKE_DELSVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<HjartKarl> {
    ...
    protected List<InputExpectedValuePair<HjartKarl, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              HjartKarl.builder().setBeskrivningRiskfaktorer("beskrivning").build(),
