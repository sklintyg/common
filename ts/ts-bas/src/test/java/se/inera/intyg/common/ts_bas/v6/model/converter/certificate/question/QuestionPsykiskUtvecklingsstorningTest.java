...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.PSYKISK_UTVECKLINGSSTORNING_DELSVAR_TEXT_ID;
  ...
  class IncludeValueViewText extends ValueViewTextTest<Utvecklingsstorning> {
    ...
    protected List<InputExpectedValuePair<Utvecklingsstorning, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Utvecklingsstorning.builder().setPsykiskUtvecklingsstorning(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Utvecklingsstorning.builder().setPsykiskUtvecklingsstorning(false).build(),
