...
import static se.inera.intyg.common.ts_bas.v7.codes.RespConstantsV7.HJART_ELLER_KARLSJUKDOM_SVAR_TEXT_ID;
    ...
    class ToCertificate {
        ...
        class IncludeCommonElementTests extends CommonElementTest {
            ...
            protected String getId() {
                return HJART_ELLER_KARLSJUKDOM_SVAR_ID;
            }
        ...
        class IncludeConfigRadioBooleanTests extends ConfigRadioBooleanTest {
            ...
            protected String getTextId() {
                return HJART_ELLER_KARLSJUKDOM_SVAR_TEXT_ID;
            }
    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                final var hjartKarl = HjartKarl.builder().setHjartKarlSjukdom(expectedValue).build();
                return QuestionHjartOchKarlsjukdom.toCertificate(hjartKarl, 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionHjartOchKarlsjukdom.toInternal(certificate);
            }
        }
    }
}