...
class QuestionAlkoholNarkotikaLakarordineratDosTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionAlkoholNarkotikaLakarordineratDos.toCertificate(null, 0, textProvider);
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<NarkotikaLakemedel> {
    ...
    protected CertificateDataElement getElement(NarkotikaLakemedel expectedValue) {
      return QuestionAlkoholNarkotikaLakarordineratDos.toCertificate(
