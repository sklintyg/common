    ...
    class IncludeValueViewText extends ValueViewTextTest<Utvecklingsstorning> {
        ...
        protected List<InputExpectedValuePair<Utvecklingsstorning, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(Utvecklingsstorning.builder().setHarSyndrom(true).build(),
                    CertificateDataValueViewText.builder().text("Ja").build()),
                new InputExpectedValuePair<>(Utvecklingsstorning.builder().setHarSyndrom(false).build(),
