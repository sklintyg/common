...
class QuestionPsykiskSjukdomTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionPsykiskSjukdom.toCertificate(null, 0, textProvider);
    }
    ...
    protected String getParent() {
      return PSYKISK_SJUKDOM_STORNING_CATEGORY_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<Psykiskt> {

    @Override
    protected CertificateDataElement getElement(Psykiskt expectedValue) {
      return QuestionPsykiskSjukdom.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<Psykiskt, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              Psykiskt.create(true), CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Psykiskt.create(false), CertificateDataValueViewText.builder().text("Nej").build()));
    }
  }
}
