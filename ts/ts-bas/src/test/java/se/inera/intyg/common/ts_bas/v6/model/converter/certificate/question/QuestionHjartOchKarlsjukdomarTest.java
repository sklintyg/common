...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.HJART_ELLER_KARLSJUKDOM_SVAR_TEXT_ID;
  ...
  class IncludeValueViewText extends ValueViewTextTest<HjartKarl> {
    ...
    protected List<InputExpectedValuePair<HjartKarl, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              HjartKarl.builder().setHjartKarlSjukdom(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              HjartKarl.builder().setHjartKarlSjukdom(false).build(),
