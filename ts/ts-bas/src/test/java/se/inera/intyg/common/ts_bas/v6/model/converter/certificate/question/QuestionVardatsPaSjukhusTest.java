    ...
    class IncludeValueViewText extends ValueViewTextTest<Sjukhusvard> {
        ...
        protected List<InputExpectedValuePair<Sjukhusvard, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(Sjukhusvard.builder().setSjukhusEllerLakarkontakt(true).build(),
                    CertificateDataValueViewText.builder().text("Ja").build()),
                new InputExpectedValuePair<>(Sjukhusvard.builder().setSjukhusEllerLakarkontakt(false).build(),
