...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.SJUKDOM_FUNKTIONSNEDSATTNING_SVAR_TEXT_ID;
...
class QuestionFunktionsnedsattningTest {
  ...
  class IncludeValueViewText extends ValueViewTextTest<Funktionsnedsattning> {
    ...
    protected CertificateDataElement getElement(Funktionsnedsattning expectedValue) {
      return QuestionFunktionsnedsattning.toCertificate(expectedValue, 0, textProvider);
    }
    ...
    protected List<InputExpectedValuePair<Funktionsnedsattning, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Funktionsnedsattning.builder().setFunktionsnedsattning(true).build(),
