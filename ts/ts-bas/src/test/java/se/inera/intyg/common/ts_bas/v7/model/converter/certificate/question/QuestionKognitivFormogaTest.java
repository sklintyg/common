...
class QuestionKognitivFormogaTest {
    ...
    class ToCertificate {
        ...
        class IncludeConfigRadioBooleanTests extends ConfigRadioBooleanTest {
            ...
            @Override
            protected String getId() {
                return TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_JSON_ID;
            }
        ...
        class IncludeValidationMandatory extends ValidationMandatoryTest {
            ...
            protected String getExpression() {
                return "exists(" + TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_JSON_ID + ")";
            }
    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                final var kognitivt = Kognitivt.create(expectedValue);
                return QuestionKognitivFormoga.toCertificate(kognitivt, 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionKognitivFormoga.toInternal(certificate);
            }
        }
    }
}