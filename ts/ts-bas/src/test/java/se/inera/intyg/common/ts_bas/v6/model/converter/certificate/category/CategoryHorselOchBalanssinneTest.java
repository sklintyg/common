...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.BALANSRUBBNINGAR_YRSEL_CATEGORY_TEXT_ID;
...
class CategoryHorselOchBalanssinneTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryHorselOchBalanssinne.toCertificate(0,
                texts);
        }
    ...
    class IncludeConfigCategoryTest extends ConfigCategoryTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return CategoryHorselOchBalanssinne.toCertificate(0, texts);
        }

        @Override
        protected String getTextId() {
            return BALANSRUBBNINGAR_YRSEL_CATEGORY_TEXT_ID;
        }
