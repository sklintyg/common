...
public final class ScenarioFinder {
  ...
  public static List<Scenario> getTransportScenarios(String scenarioWithWildcards)
    ...
    return getScenarios(
        scenarioWithWildcards + TRANSPORT_MODEL_EXT, RIVTA_V3_TRANSPORT_MODEL_PATH, "transport");
  }
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    /** {@inheritDoc} */
    @Override
    public TsBasUtlatandeV7 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), TsBasUtlatandeV7.class);
      } catch (IOException e) {
