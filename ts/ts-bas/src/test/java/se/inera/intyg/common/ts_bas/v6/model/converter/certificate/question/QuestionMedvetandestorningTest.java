...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.MEDVETANDESTORNING_SVAR_TEXT_ID;
...
class QuestionMedvetandestorningTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionMedvetandestorning.toCertificate(null, 0, textProvider);
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return MEDVETANDESTORNING_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<Medvetandestorning> {
    ...
    protected CertificateDataElement getElement(Medvetandestorning expectedValue) {
      return QuestionMedvetandestorning.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<Medvetandestorning, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              Medvetandestorning.builder().setMedvetandestorning(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Medvetandestorning.builder().setMedvetandestorning(false).build(),
