...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_SVAR_TEXT_ID;
...
class QuestionKognitivFormogaTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionKognitivFormoga.toCertificate(null, 0, textProvider);
    }

    @Override
    protected String getId() {
      return TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_SVAR_ID;
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return TECKEN_SVIKTANDE_KOGNITIV_FUNKTION_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<Kognitivt> {

    @Override
    protected CertificateDataElement getElement(Kognitivt expectedValue) {
      return QuestionKognitivFormoga.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<Kognitivt, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              Kognitivt.create(true), CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Kognitivt.create(false), CertificateDataValueViewText.builder().text("Nej").build()));
    }
  }
}
