...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.STADIGVARANDE_MEDICINERING_CATEGORY_TEXT_ID;
...
class CategoryOvrigMedicineringTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryOvrigMedicinering.toCertificate(0, textProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return STADIGVARANDE_MEDICINERING_CATEGORY_TEXT_ID;
        }
