 ...
 */
package se.inera.intyg.common.ts_bas.v7.model.validator;
...
import se.inera.intyg.common.ts_bas.v7.validator.TsBasValidator;
...
public class InternalValidatorTest {
    ...
    public void testValidate() throws Exception {
        for (Scenario scenario : ScenarioFinder.getInternalScenarios("valid-*")) {
            TsBasUtlatandeV7 utlatande = scenario.asInternalModel();
    ...
    public void testInvalidDiabetesTyp2MissingBehandling() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("invalid-diabetes-typ2-missing-behandling")
            .asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
    ...
    public void testInvalidSynskarpa() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("invalid-korrigerad-synskarpa").asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
    ...
    public void testFunktionshinderBeskrivningMissing() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("invalid-funktionshinder-beskrivning-missing")
            .asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
    ...
    public void testIdentitetMissing() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("invalid-missing-identitet")
            .asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
    ...
    public void testSjukhusvardValidationOrder() throws ScenarioNotFoundException {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("valid-sjukhusvard").asInternalModel();
    ...
    public void testInvalidMinimalR35TestFails() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("fail-minimal-r35")
            .asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
        int index = 0;
    ...
    public void testInvalidMinimalTestFails() throws Exception {
        TsBasUtlatandeV7 utlatande = ScenarioFinder.getInternalScenario("fail-annat-felsynskarpa")
            .asInternalModel();
        ValidateDraftResponse validationResponse = validator.validateDraft(utlatande);
        int index = 0;
        assertEquals("syn.hogerOga.medKorrektion", validationResponse.getValidationErrors().get(index++).getField());
    ...
    public static <T> T getSingleElement(Collection<T> collection) {
        if (collection.size() != 1) {
            throw new IllegalArgumentException("Expected collection with exactly one element");
        }
