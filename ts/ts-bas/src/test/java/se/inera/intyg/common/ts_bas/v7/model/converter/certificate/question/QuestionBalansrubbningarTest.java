  ...
  class ToInternal {
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
      ...
      protected CertificateDataElement getElement(Boolean expectedValue) {
        final var horselBalans = HorselBalans.builder().setBalansrubbningar(expectedValue).build();
        return QuestionBalansrubbningar.toCertificate(horselBalans, 0, textProvider);
      }

      @Override
      protected Boolean toInternalBooleanValue(Certificate certificate) {
        return QuestionBalansrubbningar.toInternal(certificate);
      }
    }
  }
}
