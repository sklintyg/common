    ...
    class ToInternal {
        ...
        class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
            ...
            protected CertificateDataElement getElement(Boolean expectedValue) {
                final var medvetandestorning = Medvetandestorning.builder().setMedvetandestorning(expectedValue).build();
                return QuestionMedvetandestorning.toCertificate(medvetandestorning, 0, textProvider);
            }

            @Override
            protected Boolean toInternalBooleanValue(Certificate certificate) {
                return QuestionMedvetandestorning.toInternal(certificate);
            }
        }
    }
}