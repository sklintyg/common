...
class CategoryOvrigKommentarTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return se.inera.intyg.common.ts_bas.v7.model.converter.certificate.category.CategoryOvrigt
          .toCertificate(0, textProvider);
    }
  ...
  class IncludeConfigCategoryTests extends ConfigCategoryTest {
    ...
    @Override
    protected CertificateDataElement getElement() {
      return CategoryOvrigKommentar.toCertificate(0, textProvider);
    }
