...
public class IntygTextsTsBasRepositoryTestHelper extends IntygTextsRepositoryImpl {

    public IntygTextsTsBasRepositoryTestHelper() {
    ...
    public void update() {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder()
                .parse(new ClassPathResource("v7/text/texterTS_TSTRK_1007_v7.0.xml").getInputStream());
