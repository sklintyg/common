...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.BALANSRUBBNINGAR_YRSEL_SVAR_TEXT_ID;
...
class QuestionBalansrubbningarTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionBalansrubbningar.toCertificate(null, 0, textProvider);
    }

    @Override
    protected String getId() {
      return BALANSRUBBNINGAR_YRSEL_SVAR_ID;
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return BALANSRUBBNINGAR_YRSEL_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<HorselBalans> {
    ...
    protected CertificateDataElement getElement(HorselBalans expectedValue) {
      return QuestionBalansrubbningar.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<HorselBalans, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              HorselBalans.builder().build(),
              CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              HorselBalans.builder().setBalansrubbningar(false).build(),
              CertificateDataValueViewText.builder().text("Nej").build()),
          new InputExpectedValuePair<>(
              HorselBalans.builder().setBalansrubbningar(true).build(),
