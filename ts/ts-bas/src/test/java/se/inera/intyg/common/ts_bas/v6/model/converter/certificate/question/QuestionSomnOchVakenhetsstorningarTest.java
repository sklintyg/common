...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.TECKEN_SOMN_ELLER_VAKENHETSSTORNING_SVAR_TEXT_ID;
...
class QuestionSomnOchVakenhetsstorningarTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionSomnOchVakenhetsstorningar.toCertificate(null, 0, textProvider);
    }
    ...
    protected String getParent() {
      return TECKEN_SOMN_ELLER_VAKENHETSSTORNING_CATEGORY_ID;
    }
  ...
  class IncludeConfigViewText extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return TECKEN_SOMN_ELLER_VAKENHETSSTORNING_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewText extends ValueViewTextTest<SomnVakenhet> {

    @Override
    protected CertificateDataElement getElement(SomnVakenhet expectedValue) {
      return QuestionSomnOchVakenhetsstorningar.toCertificate(expectedValue, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<SomnVakenhet, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              SomnVakenhet.create(true), CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
