...
import static se.inera.intyg.common.ts_bas.v6.model.converter.certificate.MetaDataGrundData.toInternal;
    ...
    class ToCertificate {
        ...
        class IncludeTestCommonMetadata extends CommonMetaDataTest {
            ...
            protected CertificateMetadata getMetaData() {
                return MetaDataGrundData.toCertificate((TsBasUtlatandeV6) getInternalCertificate(), texts);
            }

            @Override
            protected Utlatande getInternalCertificate() {
                return TsBasUtlatandeV6.builder()
                    .setId("id")
                    .setTextVersion("1.0")
