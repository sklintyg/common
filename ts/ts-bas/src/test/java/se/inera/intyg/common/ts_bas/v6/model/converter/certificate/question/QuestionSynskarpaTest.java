  ...
  class IncludeValueViewTableTests {
    ...
    class RightEye {
      ...
      void shouldIncludeWithCorrection() {
        ...
        final var syn =
            Syn.builder()
                .setHogerOga(Synskarpevarden.builder().setMedKorrektion(2.0).build())
                .setVansterOga(Synskarpevarden.builder().build())
                .setBinokulart(Synskarpevarden.builder().build())
                .build();
      ...
      void shouldIncludeContactLenses() {
        ...
        final var syn =
            Syn.builder()
                .setHogerOga(Synskarpevarden.builder().setKontaktlins(true).build())
                .setVansterOga(Synskarpevarden.builder().build())
                .setBinokulart(Synskarpevarden.builder().build())
                .build();
    ...
    class LeftEye {
      ...
      void shouldIncludeWithCorrection() {
        ...
        final var syn =
            Syn.builder()
                .setHogerOga(Synskarpevarden.builder().build())
                .setVansterOga(Synskarpevarden.builder().setMedKorrektion(2.0).build())
                .setBinokulart(Synskarpevarden.builder().build())
                .build();
      ...
      void shouldIncludeContactLenses() {
        ...
        final var syn =
            Syn.builder()
                .setHogerOga(Synskarpevarden.builder().build())
                .setVansterOga(Synskarpevarden.builder().setKontaktlins(true).build())
                .setBinokulart(Synskarpevarden.builder().build())
                .build();
      ...
      void shouldIncludeWithCorrection() {
        ...
        final var syn =
            Syn.builder()
                .setHogerOga(Synskarpevarden.builder().build())
                .setVansterOga(Synskarpevarden.builder().build())
                .setBinokulart(Synskarpevarden.builder().setMedKorrektion(2.0).build())
                .build();
