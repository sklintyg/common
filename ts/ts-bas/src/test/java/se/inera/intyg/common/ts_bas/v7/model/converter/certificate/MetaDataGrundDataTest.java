 ...
 */
package se.inera.intyg.common.ts_bas.v7.model.converter.certificate;
...
import static se.inera.intyg.common.ts_bas.v7.model.converter.certificate.MetaDataGrundData.toInternal;
    ...
    class ToCertificate {
        ...
        class IncludeTestCommonMetadata extends CommonMetaDataTest {
            ...
            protected CertificateMetadata getMetaData() {
                return MetaDataGrundData.toCertificate((TsBasUtlatandeV7) getInternalCertificate(), texts);
            }
