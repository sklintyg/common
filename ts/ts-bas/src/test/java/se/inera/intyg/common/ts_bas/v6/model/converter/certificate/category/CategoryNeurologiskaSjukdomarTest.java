...
import static se.inera.intyg.common.ts_bas.v6.codes.RespConstantsV6.NEUROLOGISK_SJUKDOM_CATEGORY_TEXT_ID;
...
class CategoryNeurologiskaSjukdomarTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryNeurologiskaSjukdomar.toCertificate(0, textProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return NEUROLOGISK_SJUKDOM_CATEGORY_TEXT_ID;
        }
