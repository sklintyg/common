...
import static se.inera.intyg.common.ts_bas.v7.codes.RespConstantsV7.PSYKISK_UTVECKLINGSSTORNING_CATEGORY_TEXT_ID;
...
class CategoryPsykiskUtvecklingsstorningTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryPsykiskUtvecklingsstorning.toCertificate(0, texts);
        }
    ...
    class IncludeConfigCategoryTest extends ConfigCategoryTest {
        ...
        protected String getTextId() {
            return PSYKISK_UTVECKLINGSSTORNING_CATEGORY_TEXT_ID;
        }
