...
public class WebcertModelFactoryImpl implements WebcertModelFactory<TsTrk1062UtlatandeV1> {
  ...
  @Override
  public TsTrk1062UtlatandeV1 createNewWebcertDraft(CreateNewDraftHolder newDraftData)
    ...
    template.setTextVersion(
        intygTexts.getLatestVersionForSameMajorVersion(
            TsTrk1062EntryPoint.MODULE_ID, newDraftData.getIntygTypeVersion()));
  ...
  @Override
  public TsTrk1062UtlatandeV1 createCopy(CreateDraftCopyHolder copyData, Utlatande template)
      throws ConverterException {
  ...
  private void populateWithId(TsTrk1062UtlatandeV1.Builder utlatande, String utlatandeId)
      throws ConverterException {
