...
public class InternalValidatorInstanceImplTest {
    ...
    builderTemplate =
        TsTrk1062UtlatandeV1.builder()
            ...
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(false, false, "", false, false, false, null, ""))
  ...
  public void validateNullDiagnosKodad() {
    ...
    assertOneValidationMessages(
        validationMessages, ALLMANT_KATEGORI, ALLMANT_DIAGNOSKOD_KODAD_SVAR_JSON_ID);
  }
  ...
  public void validateFirstDiagnosMissing() {
    ...
    final DiagnosKodad diagnosKodadTwo =
        DiagnosKodad.create(
            "A01", "ICD10", "Diagnosbeskrivning", "A01 - Diagnosbeskrivning", "2019");
  ...
  public void validateFutureDiagnosArtal() {
    ...
    final DiagnosKodad diagnosKodad =
        DiagnosKodad.create(
            "A01", "ICD10", "Diagnosbeskrivning", "A01 - Diagnosbeskrivning", futureYear);
  ...
  public void validateNullLakemedelsbehandlingHarHaft() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(null, null, null, null, null, null, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingPagar() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, null, null, null, null, null, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingAktuell() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, true, null, false, false, false, null, null))
            .build();
  ...
  public void validateEmptyLakemedelsbehandlingAktuell() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, true, "", false, false, false, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingPagatt() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, true, "Aktuell", null, false, false, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingEffekt() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, true, "Aktuell", false, null, false, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingFoljsamhet() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, true, "Aktuell", false, false, null, null, null))
            .build();
  ...
  public void validateNullLakemedelsbehandlingAvslutadTidpunkt() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, false, null, null, null, null, null, "Orsak"))
            .build();
  ...
  public void validateEmptyLakemedelsbehandlingAvslutadTidpunkt() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, false, null, null, null, null, "", "Orsak"))
            .build();
        ...
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(
                    true, false, null, null, null, null, "Förra året", null))
            .build();
  ...
  public void validateEmptyLakemedelsbehandlingAvslutadOrsak() {
    final TsTrk1062UtlatandeV1 utlatande =
        builderTemplate
            .setLakemedelsbehandling(
                Lakemedelsbehandling.create(true, false, null, null, null, null, "Förra året", ""))
            .build();
  ...
  public void validateNullBedomningAvSymptom() {
    ...
    assertOneValidationMessages(
        validationMessages, SYMPTOM_KATEGORI, SYMPTOM_BEDOMNING_DELSVAR_JSON_ID);
  }
            ...
            .setBedomning(
                Bedomning.builder()
                    .setUppfyllerBehorighetskrav(
                        EnumSet.of(Bedomning.BehorighetsTyp.VAR6, Bedomning.BehorighetsTyp.VAR11))
                    .build())
            .build();
  ...
  private Map<String, ValidationMessage> buildMapFromMessages(
  ...
  private void assertValidationMessage(
      Map<String, ValidationMessage> validationMessageMap, String category, String field) {
    assertValidationMessage(validationMessageMap, ValidationMessageType.EMPTY, category, field);
  }

  private void assertValidationMessage(
      Map<String, ValidationMessage> validationMessageMap,
  ...
  private void assertOneValidationMessages(
      List<ValidationMessage> validationMessage, String category, String field) {
