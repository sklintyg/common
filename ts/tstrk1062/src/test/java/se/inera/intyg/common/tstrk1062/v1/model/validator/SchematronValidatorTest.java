...
public class SchematronValidatorTest {
  ...
  public void failOnRule1() throws Exception {
    ...
    assertOneError(
        validationErrors, "'Läkemedelsbehandling för angivna diagnoser pågår' besvaras.");
  }
  ...
  public void failOnRule4() throws Exception {
    ...
    assertOneError(
        validationErrors, "'Behandlingseffekten har varit god under senaste två åren' besvaras.");
  }
  ...
  public void failOnRule6And7() throws Exception {
    ...
    assertTrue(
        validationErrors.get(0).contains("'Orsak till att läkemedelsbehandling avslutades'"));
  }
  ...
  public void failOnMissingQ60() throws Exception {
    ...
    assertOneError(
        validationErrors,
        "'Bedömning av symptom, funktionshinder och prognos för fortsatt stabilitet'");
  }
