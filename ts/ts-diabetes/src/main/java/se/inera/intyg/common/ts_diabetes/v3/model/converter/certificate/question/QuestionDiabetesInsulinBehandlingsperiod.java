...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.ALLMANT_BEHANDLING_INSULIN_TEXT_ID;
...
public class QuestionDiabetesInsulinBehandlingsperiod {
  ...
  public static CertificateDataElement toCertificate(
    ...
    final var behandlingsperiod =
        allmant != null && allmant.getBehandling() != null
            ? allmant.getBehandling().getInsulinSedanAr()
            : null;
