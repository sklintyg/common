...
public class QuestionHypoglykemiAllvarligForekomst {
    ...
    public static CertificateDataElement toCertificate(Boolean allvarligForekomst, int index, CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_SVAR_ID)
            .parent(HYPOGLYKEMI_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigViewText.builder()
                    .text(textProvider.get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_SVAR_TEXT_ID))
                    .build()
            )
            .value(
