...
public class QuestionHypoglykemiKunskapOmAtgarder {
  ...
  public static CertificateDataElement toCertificate(
      Boolean kunskapOmAtgarder, int index, CertificateTextProvider textProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(booleanValue(kunskapOmAtgarder)).build())
        .build();
  }
}
