...
public class QuestionHypoglykemiKunskapOmAtgarder {

    public static CertificateDataElement toCertificate(Boolean kunskapOmAtgarder, int index, CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_KUNSKAP_OM_ATGARDER_SVAR_ID)
            .parent(HYPOGLYKEMI_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigViewText.builder()
                    .text(textProvider.get(HYPOGLYKEMI_KUNSKAP_OM_ATGARDER_SVAR_TEXT_ID))
                    .build()
            )
            .value(
                CertificateDataValueViewText.builder()
                    .text(booleanValue(kunskapOmAtgarder))
                    .build()
            )
            .build();
    }
