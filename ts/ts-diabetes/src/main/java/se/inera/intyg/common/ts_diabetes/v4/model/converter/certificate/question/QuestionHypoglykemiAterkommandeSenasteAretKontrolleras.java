...
public class QuestionHypoglykemiAterkommandeSenasteAretKontrolleras {
    ...
    public static CertificateDataElement toCertificate(Hypoglykemi hypoglykemi, int index, CertificateTextProvider textProvider) {
        final var aterkommandeSenasteAretKontrolleras =
            hypoglykemi != null && hypoglykemi.getAterkommandeSenasteAretKontrolleras() != null
                ? hypoglykemi.getAterkommandeSenasteAretKontrolleras() : null;
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_DELSVAR_ID)
            .parent(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_SVAR_ID)
            .index(index)
            .config(
                CertificateDataConfigRadioBoolean.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_JSON_ID)
                    .text(textProvider.get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_TEXT_ID))
            ...
            .value(
                CertificateDataValueBoolean.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_JSON_ID)
                    .selected(aterkommandeSenasteAretKontrolleras)
                    .build()
            )
            .validation(
                new CertificateDataValidation[]{
                    ...
                    CertificateDataValidationMandatory.builder()
                        .questionId(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_DELSVAR_ID)
                        .expression(singleExpression(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_JSON_ID))
                        .build()
                }
            )
            .build();
    ...
    public static Boolean toInternal(Certificate certificate) {
        return booleanValue(certificate.getData(), HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_DELSVAR_ID,
