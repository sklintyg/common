...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TEXT_ID;
...
public class QuestionHypoglykemiAterkommandeSenasteAretTrafik {
    ...
    public static CertificateDataElement toCertificate(Hypoglykemi hypoglykemi, int index, CertificateTextProvider textProvider) {
        final var aterkommandeSenasteAretTrafik =
            hypoglykemi != null && hypoglykemi.getAterkommandeSenasteAretTrafik() != null
                ? hypoglykemi.getAterkommandeSenasteAretTrafik() : null;
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID)
            .parent(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_SVAR_ID)
            .index(index)
            .config(
                CertificateDataConfigRadioBoolean.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_JSON_ID)
                    .text(textProvider.get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TEXT_ID))
            ...
            .value(
                CertificateDataValueBoolean.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_JSON_ID)
                    .selected(aterkommandeSenasteAretTrafik)
                    .build()
            )
            .validation(
                new CertificateDataValidation[]{
                    CertificateDataValidationShow.builder()
                        .questionId(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_SVAR_ID)
                        .expression(singleExpression(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_JSON_ID))
                        .build(),
                    CertificateDataValidationMandatory.builder()
                        .questionId(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID)
                        .expression(singleExpression(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_JSON_ID))
                        .build()
                }
            )
            .build();
    ...
    public static Boolean toInternal(Certificate certificate) {
        return booleanValue(certificate.getData(), HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID,
            HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_JSON_ID);
    }
}
