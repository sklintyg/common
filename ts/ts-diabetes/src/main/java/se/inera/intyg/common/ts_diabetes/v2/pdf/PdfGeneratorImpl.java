...
public class PdfGeneratorImpl extends BasePdfGenerator
    implements PdfGenerator<TsDiabetesUtlatandeV2> {
  ...
  private static final CheckField DIABETIKER_INSULINBEHANDLING_SEDAN_CHECK =
      new CheckField("Falt_37");
  ...
  private static final YesNoField HYPOGLYKEMIER_MED_TECKEN_PA_NEDSATT_HJARNFUNKTION =
      new YesNoField("Falt_44", "Falt_45");
  private static final YesNoField SAKNAR_FORMAGA_KANNA_HYPOGLYKEMI =
      new YesNoField("Falt_48", "Falt_49");
  ...
  private static final YesNoField ALLVARLIG_HYPOGLYKEMI_I_TRAFIKEN =
      new YesNoField("Falt_51", "Falt_52");
  private static final StringField ALLVARLIG_HYPOGLYKEMI_I_TRAFIKEN_BESKRIVNING =
      new StringField("Falt__501");
  private static final YesNoField EGENOVERVAKNING_BLODGLUKOS = new YesNoField("Falt_53", "Falt_54");
  private static final YesNoField ALLVARLIG_HYPOGLYKEMI_VAKET_TILLSTAND =
      new YesNoField("Falt_55", "Falt_56");
  private static final StringField ALLVARLIG_HYPOGLYKEMI_VAKET_TILLSTAND_DATUM =
      new StringField("Falt__61");
  ...
  private static final DecimalField EJ_KORRIGERAD_SYNSKARPA_HOGER =
      new DecimalField("Falt__66", "Falt__67");
  private static final DecimalField EJ_KORRIGERAD_SYNSKARPA_VANSTER =
      new DecimalField("Falt__70", "Falt__71");
  private static final DecimalField EJ_KORRIGERAD_SYNSKARPA_BINOKULART =
      new DecimalField("Falt__74", "Falt__75");
  private static final DecimalField KORRIGERAD_SYNSKARPA_HOGER =
      new DecimalField("Falt__68", "Falt__69");
  private static final DecimalField KORRIGERAD_SYNSKARPA_VANSTER =
      new DecimalField("Falt__72", "Falt__73");
  private static final DecimalField KORRIGERAD_SYNSKARPA_BINOKULART =
      new DecimalField("Falt__76", "Falt__77");
  ...
  private static final YesNoField LAMPLIGHET_INNEHA_BEHORIGHET_TILL_KORNINGAR_OCH_ARBETSFORMER =
      new YesNoField("Falt_92", "Falt_93");
  private static final StringField OVRIG_BESKRIVNING = new StringField("FaltDiv6");
  private static final StringField BEDOMNING_BOR_UNDERSOKAS_SPECIALIST =
      new StringField("Falt__94");
  ...
  @Override
  public String generatePdfFilename(TsDiabetesUtlatandeV2 utlatande) {
   ...
   *
   * @param utlatande {@link TsDiabetesUtlatandeV2} containing data for populating the pdf
   * @param fields The fields of the pdf
   */
  private void populatePdfFields(TsDiabetesUtlatandeV2 utlatande, AcroFields fields)
  ...
  private void populatePatientInfo(Patient patient, AcroFields fields)
      throws IOException, DocumentException {
    INVANARE_ADRESS_FALT1.setField(fields, patient.getFullstandigtNamn());
    String postadress = patient.getPostadress() == null ? "" : patient.getPostadress();
    ...
    INVANARE_ADRESS_FALT2.setField(fields, postadress);
  ...
  private void populateIntygAvser(IntygAvser intygAvser, AcroFields fields)
      throws IOException, DocumentException {
  ...
  private void populateIdkontroll(Vardkontakt vardkontakt, AcroFields fields)
      throws IOException, DocumentException {
  ...
  private void populateAllmant(Diabetes diabetes, AcroFields fields)
      throws IOException, DocumentException {
  ...
  private void populateHypoglykemier(Hypoglykemier hypoglykemier, AcroFields fields)
      throws IOException, DocumentException {
    KUNSKAP_ATGARD_HYPOGLYKEMI.setField(fields, hypoglykemier.getKunskapOmAtgarder());
    HYPOGLYKEMIER_MED_TECKEN_PA_NEDSATT_HJARNFUNKTION.setField(
        fields, hypoglykemier.getTeckenNedsattHjarnfunktion());
    SAKNAR_FORMAGA_KANNA_HYPOGLYKEMI.setField(
        fields, hypoglykemier.getSaknarFormagaKannaVarningstecken());
    ...
    ALLVARLIG_HYPOGLYKEMI_I_TRAFIKEN.setField(
        fields, hypoglykemier.getAllvarligForekomstTrafiken());
    ALLVARLIG_HYPOGLYKEMI_I_TRAFIKEN_BESKRIVNING.setField(
        fields, hypoglykemier.getAllvarligForekomstTrafikBeskrivning());
    EGENOVERVAKNING_BLODGLUKOS.setField(fields, hypoglykemier.getEgenkontrollBlodsocker());
    ALLVARLIG_HYPOGLYKEMI_VAKET_TILLSTAND.setField(
        fields, hypoglykemier.getAllvarligForekomstVakenTid());
    if (hypoglykemier.getAllvarligForekomstVakenTidObservationstid() != null) {
      ALLVARLIG_HYPOGLYKEMI_VAKET_TILLSTAND_DATUM.setField(
          fields,
          hypoglykemier.getAllvarligForekomstVakenTidObservationstid().getDate().replace("-", ""));
    }
  }
  ...
  private void populateBedomning(Bedomning bedomning, AcroFields fields)
      throws IOException, DocumentException {
    ...
    LAMPLIGHET_INNEHA_BEHORIGHET_TILL_KORNINGAR_OCH_ARBETSFORMER.setField(
        fields, bedomning.getLamplighetInnehaBehorighet());
    BEDOMNING_BOR_UNDERSOKAS_SPECIALIST.setField(fields, bedomning.getLakareSpecialKompetens());
  }

  private void populateOvrigt(String kommentar, AcroFields fields)
      throws IOException, DocumentException {
    OVRIG_BESKRIVNING.setField(fields, kommentar);
  }

  private void populateAvslut(TsDiabetesUtlatandeV2 utlatande, AcroFields fields)
      throws IOException, DocumentException {
    INTYGSDATUM.setField(
        fields,
        utlatande.getGrundData().getSigneringsdatum() != null
            ? utlatande
                .getGrundData()
                .getSigneringsdatum()
    ...
    String adressOrt =
        String.format(
            "%s, %s, %s",
            vardenhet.getPostadress(), vardenhet.getPostnummer(), vardenhet.getPostort());
    ...
    NAMNFORTYDLIGANDE.setField(
        fields, utlatande.getGrundData().getSkapadAv().getFullstandigtNamn());

    populateAvslutSpecialist(utlatande, fields);
  }

  private void populateAvslutSpecialist(TsDiabetesUtlatandeV2 utlatande, AcroFields fields)
      throws IOException, DocumentException {
    ...
    if (specialiteter.size() > 0) {
      ...
      if (index > -1) {
        ...
        SPECIALISTKOMPETENS_BESKRVNING.setField(
            fields, specialiteter.stream().collect(Collectors.joining(", ")));
      }
    }
  }
  ...
  private static final class CheckField {
    ...
    public void setField(AcroFields fields, Boolean checkField)
        throws IOException, DocumentException {
  ...
  private static final class StringField {
    ...
    public boolean fieldFits(AcroFields fields, String value)
        throws IOException, DocumentException {
