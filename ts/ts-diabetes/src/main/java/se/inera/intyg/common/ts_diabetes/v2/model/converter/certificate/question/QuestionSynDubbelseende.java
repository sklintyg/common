...
public class QuestionSynDubbelseende {
  ...
  public static CertificateDataElement toCertificate(
      Boolean dubbelseende, int index, CertificateTextProvider textProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                .text(textProvider.get(SYN_DUBBELSEENDE_SVAR_TEXT_ID))
                .build())
        .value(CertificateDataValueViewText.builder().text(booleanValue(dubbelseende)).build())
        .build();
  }
}
