...
public class QuestionSynUtanAnmarkning {
  ...
  public static CertificateDataElement toCertificate(
      Boolean utanAnmarkning, int index, CertificateTextProvider textProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(booleanValue(utanAnmarkning)).build())
        .build();
  }
}
