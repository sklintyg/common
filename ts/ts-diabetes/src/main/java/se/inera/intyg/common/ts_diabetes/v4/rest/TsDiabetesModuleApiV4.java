...
public class TsDiabetesModuleApiV4 extends TsParentModuleApi<TsDiabetesUtlatandeV4> {
  ...
  public PdfResponse pdf(
    ...
    IntygTexts texts =
        getTexts(TsDiabetesEntryPoint.MODULE_ID, tsDiabetesUtlatandeV4.getTextVersion());
  ...
  @Override
  protected Intyg utlatandeToIntyg(TsDiabetesUtlatandeV4 utlatande) throws ConverterException {
  ...
  @Override
  protected RegisterCertificateType internalToTransport(TsDiabetesUtlatandeV4 utlatande)
      throws ConverterException {
    return InternalToTransport.convert(utlatande);
  }

  @Override
  protected TsDiabetesUtlatandeV4 transportToInternal(Intyg intyg) throws ConverterException {
    return TransportToInternal.convert(intyg);
  }

  private TsDiabetesUtlatandeV4 decorateWithSignature(
      TsDiabetesUtlatandeV4 utlatande, String base64EncodedSignatureXml) {
  ...
  private String updateInternalAfterSigning(String internalModel, String base64EncodedSignatureXml)
      throws ModuleException {
    try {
      TsDiabetesUtlatandeV4 utlatande =
  ...
  public String getJsonFromUtlatande(Utlatande utlatande) throws ModuleException {
    ...
    throw new IllegalArgumentException(
        "Utlatande was not instance of class TsDiabetesUtlatandeV4, utlatande was instance of class: "
            + message);
  }
  ...
  public String getUpdatedJsonWithTestData(
    ...
    TestabilityToolkit.fillCertificateWithTestData(
        certificate, fillType, new TsDiabetesV4TestabilityCertificateTestdataProvider());
    final var updateInternalCertificate =
        certificateToInternal.convert(certificate, internalCertificate);
    return toInternalModelResponse(updateInternalCertificate);
  }
  ...
  protected TsDiabetesUtlatandeV4 getInternal(String internalModel) throws ModuleException {
    try {
      final var tsDiabetesUtlatandeV4 =
  ...
  @Override
  protected TsDiabetesUtlatandeV4 getInternal(String internalModel, LocalDateTime created)
      throws ModuleException {
    try {
      final var tsDiabetesUtlatandeV4 =
          objectMapper.readValue(internalModel, TsDiabetesUtlatandeV4.class);
