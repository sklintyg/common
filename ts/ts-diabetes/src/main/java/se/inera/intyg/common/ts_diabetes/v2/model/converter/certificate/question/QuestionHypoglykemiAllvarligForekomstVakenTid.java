...
public class QuestionHypoglykemiAllvarligForekomstVakenTid {

    public static CertificateDataElement toCertificate(Boolean allvarligForekomstVakenTid, int index,
        CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_ID)
            .parent(HYPOGLYKEMI_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigViewText.builder()
                    .text(textProvider.get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_TEXT_ID))
                    .build()
            )
            .value(
                CertificateDataValueViewText.builder()
                    .text(booleanValue(allvarligForekomstVakenTid))
                    .build()
            )
            .build();
    }
