        ...
        return CertificateDataElement.builder()
            ...
            .config(
                CertificateDataConfigRadioBoolean.builder()
                    ...
                    .description(textProvider.get(ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_DESCRIPTION_ID)
                        .equals(ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_DESCRIPTION_ID)
                        ? null : textProvider.get(ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_DESCRIPTION_ID))
