...
public class QuestionHypoglykemiTeckenNedsattHjarnfunktion {
    ...
    public static CertificateDataElement toCertificate(Boolean nedsattHjarnfunktion, int index, CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            ...
            .value(
                CertificateDataValueViewText.builder()
                    .text(booleanValue(nedsattHjarnfunktion))
                    .build()
            )
            .build();
    }
