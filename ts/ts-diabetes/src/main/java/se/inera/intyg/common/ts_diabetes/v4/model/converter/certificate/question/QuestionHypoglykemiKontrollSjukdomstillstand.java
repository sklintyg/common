...
public class QuestionHypoglykemiKontrollSjukdomstillstand {
    ...
    public static CertificateDataElement toCertificate(Hypoglykemi hypoglykemi, int index, CertificateTextProvider textProvider) {
        final var kontroll =
            hypoglykemi != null && hypoglykemi.getKontrollSjukdomstillstand() != null ? hypoglykemi.getKontrollSjukdomstillstand() : null;
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_SVAR_ID)
            .parent(HYPOGLYKEMI_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigRadioBoolean.builder()
                    .id(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DELSVAR_ID)
                    .text(textProvider.get(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_TEXT_ID))
                    .description(textProvider.get(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DESCRIPTION_ID))
            ...
            .value(
                CertificateDataValueBoolean.builder()
                    .id(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_JSON_ID)
                    .selected(kontroll)
                    .build()
            )
            .validation(
                new CertificateDataValidation[]{
                    ...
                    CertificateDataValidationMandatory.builder()
                        ...
                        .expression(singleExpression(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_JSON_ID))
                        .build()
                }
            )
            .build();
    ...
    public static Boolean toInternal(Certificate certificate) {
        return booleanValue(certificate.getData(), HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_SVAR_ID,
