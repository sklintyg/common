...
public class QuestionHypoglykemiKontrollSjukdomstillstand {
  ...
  public static CertificateDataElement toCertificate(
    ...
    final var kontroll =
        hypoglykemi != null && hypoglykemi.getKontrollSjukdomstillstand() != null
            ? hypoglykemi.getKontrollSjukdomstillstand()
            : null;
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigRadioBoolean.builder()
                ...
                .description(
                    textProvider.get(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DESCRIPTION_ID))
