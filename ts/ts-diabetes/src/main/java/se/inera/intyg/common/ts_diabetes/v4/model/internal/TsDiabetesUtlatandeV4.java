...
public abstract class TsDiabetesUtlatandeV4 implements Utlatande {
  ...
  @Nullable public abstract Hypoglykemi getHypoglykemi();

  // Kategori 6 - Övrigt
  @Nullable public abstract Ovrigt getOvrigt();
  ...
  public static Builder builder() {
    return new AutoValue_TsDiabetesUtlatandeV4.Builder().setSignature(null);
  }
