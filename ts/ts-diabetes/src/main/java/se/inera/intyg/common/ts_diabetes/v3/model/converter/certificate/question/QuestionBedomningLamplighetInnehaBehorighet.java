...
public class QuestionBedomningLamplighetInnehaBehorighet {

    public static CertificateDataElement toCertificate(Bedomning bedomning, int index,
        CertificateTextProvider textProvider) {
        final var lamplighetInnehaBehorighet = bedomning != null ? bedomning.getLampligtInnehav() : null;
        return CertificateDataElement.builder()
            .id(BEDOMNING_LAMPLIGHET_SVAR_ID)
            .parent(BEDOMNING_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigViewText.builder()
                    .text(textProvider.get(BEDOMNING_LAMPLIGHET_SVAR_TEXT_ID))
                    .build()
            )
            .value(
                CertificateDataValueViewText.builder()
                    .text(booleanValue(lamplighetInnehaBehorighet))
                    .build()
            )
            .build();
    }
