...
public final class TransportToInternal {
  ...
  public static TsDiabetesUtlatandeV3 convert(Intyg source) throws ConverterException {
  ...
  private static void setSvar(TsDiabetesUtlatandeV3.Builder utlatande, Intyg source)
    ...
    Set<BedomningKorkortstyp> bedomningUppfyllerBehorighetskrav =
  ...
  private static void handleIdentitetStyrkt(TsDiabetesUtlatandeV3.Builder utlatande, Svar svar)
      throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleHypoglykemierEgenkontrollBlodsocker(
      Hypoglykemier.Builder hypoglykemier, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleHypoglykemierNedsattHjarnfunktion(
      Hypoglykemier.Builder hypoglykemier, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleHypoglykemierSjukdomUnderKontroll(
      Hypoglykemier.Builder hypoglykemier, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleHypoglykemierFormagaVarningstecken(
      Hypoglykemier.Builder hypoglykemier, Svar svar) {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
  ...
  private static void handleHypoglykemierAterkommandeSenasteAret(
      Hypoglykemier.Builder hypoglykemier, Svar svar) throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
        ...
        case RespConstants.HYPOGLYKEMIER_ATERKOMMANDE_SENASTE_ARET_TIDPUNKT_DELSVAR_ID:
          hypoglykemier.setAterkommandeSenasteTidpunkt(
  ...
  private static void handleHypoglykemierAterkommandeSenasteKvartalet(
      Hypoglykemier.Builder hypoglykemier, Svar svar) throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
        ...
        case RespConstants.HYPOGLYKEMIER_ATERKOMMANDE_SENASTE_TIDPUNKT_VAKEN_DELSVAR_ID:
          hypoglykemier.setSenasteTidpunktVaken(
              new InternalDate(getPartialDateContent(delsvar).getValue().toString()));
          break;
        default:
          throw new IllegalArgumentException();
  ...
  private static void handleHypoglykemierForekomstSenasteTrafik(
      Hypoglykemier.Builder hypoglykemier, Svar svar) throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
        ...
        case RespConstants.HYPOGLYKEMIER_FOREKOMST_TRAFIK_TIDPUNKT_DELSVAR_ID:
          hypoglykemier.setForekomstTrafikTidpunkt(
              new InternalDate(getPartialDateContent(delsvar).getValue().toString()));
          break;
        default:
          throw new IllegalArgumentException();
