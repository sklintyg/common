...
public class QuestionDiabetesAnnanBehandlingBeskrivning {
  ...
  public static CertificateDataElement toCertificate(
      String annanBehandling, int index, CertificateTextProvider textProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(stringValue(annanBehandling)).build())
        .build();
  }
}
