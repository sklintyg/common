...
public class InternalDraftValidatorImpl implements InternalDraftValidator<TsDiabetesUtlatandeV3> {
  ...
  private static final Set<IntygAvserKategori> RULE_1_14_15_LICENSE_SET =
      ImmutableSet.of(
  ...
  private static boolean eligibleForRule1(TsDiabetesUtlatandeV3 utlatande) {
    ...
    final ImmutableSet<IntygAvserKategori> intygAvser =
        ImmutableSet.copyOf(utlatande.getIntygAvser().getKategorier());
  ...
  private static boolean eligibleForRule13(TsDiabetesUtlatandeV3 utlatande) {
    ...
    Set<IntygAvserKategori> answerRequiringAdditionalData =
        ImmutableSet.of(
    ...
    boolean conditionBinokulartDaligSyn =
        utlatande.getSynfunktion() != null
            && utlatande.getSynfunktion().getBinokulart() != null
  ...
  private static boolean eligibleForRule14(TsDiabetesUtlatandeV3 utlatande) {
    ...
    boolean conditionVansterOgaDaligSyn =
        utlatande.getSynfunktion() != null
            && utlatande.getSynfunktion().getVanster() != null
    ...
    boolean conditionHogerOgaDaligSyn =
        utlatande.getSynfunktion() != null
            && utlatande.getSynfunktion().getHoger() != null
  ...
  private static boolean eligibleForRule16(TsDiabetesUtlatandeV3 utlatande) {
    return utlatande != null
        && utlatande.getAllmant() != null
        && utlatande.getAllmant().getBehandling() != null
  ...
  // R19
  private static boolean eligibleForRule19(
      TsDiabetesUtlatandeV3 utlatande, SynfunktionTyp synfunctionTyp) {
  ...
  public ValidateDraftResponse validateDraft(TsDiabetesUtlatandeV3 utlatande) {
    ...
    if (utlatande.getAllmant() != null) {
      ...
      addValidationError(
          validationMessages, CATEGORY_ALLMANT, ALLMANT_JSON_ID, ValidationMessageType.EMPTY);
    }
    ...
    if (utlatande.getBedomning() != null) {
      ...
      addValidationError(
          validationMessages, CATEGORY_BEDOMNING, BEDOMNING_JSON_ID, ValidationMessageType.EMPTY);
    }
  ...
  private void validateIntygetAvser(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Set<IntygAvserKategori> intygAvser =
        utlatande.getIntygAvser() == null ? null : utlatande.getIntygAvser().getKategorier();
    if (intygAvser == null || intygAvser.isEmpty()) {
      addValidationError(
          validationMessages,
          CATEGORY_INTYGET_AVSER_BEHORIGHET,
          INTYGETAVSER_SVAR_JSON_ID + ".kategorier",
          ValidationMessageType.EMPTY);
    }
  }
  ...
  private void validateDiagnosAr(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    String diabetesSedanArFieldPath =
        ALLMANT_JSON_ID + "." + ALLMANT_DIABETES_DIAGNOS_AR_JSON_ID_11;
    String cleanedDiabetesDiagnosAr =
        Strings.nullToEmpty(utlatande.getAllmant().getDiabetesDiagnosAr()).trim();
  ...
  private void validateTypAvDiabetes(
    ...
    String annanTypAvDiabetesBeskrivningFieldPath =
  ...
  private void validateBehandling(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    String insulinSedanArFieldPath =
        ALLMANT_JSON_ID
            + "."
    ...
    if (eligibleForRule5(utlatande)) {
      String cleanedInsulinSedanArString =
          Strings.nullToEmpty(behandling.getInsulinSedanAr()).trim();
      if (cleanedInsulinSedanArString.isEmpty()) {
        ...
        // R7: Årtal för 'insulinbehandling sedan' måste vara efter patienten är född, och senast
        // innevarande år
        if (ValidatorUtil.isYearBeforeBirth(
            parsedYear, utlatande.getGrundData().getPatient().getPersonId())) {
          addValidationError(
    ...
    if (eligibleForRule16(utlatande)
        && utlatande.getAllmant().getBehandling().getRiskHypoglykemi() == null) {
      addValidationError(
          validationMessages,
          CATEGORY_ALLMANT,
    ...
    if (eligibleForRule18(utlatande)
        && Strings.nullToEmpty(behandling.getAnnanBehandlingBeskrivning()).trim().isEmpty()) {
      addValidationError(
          validationMessages,
          CATEGORY_ALLMANT,
        ...
        && Strings.nullToEmpty(behandling.getAnnanBehandlingBeskrivning()).trim().length()
            > MAX_ANNAN_BEHANDLING_CHARS) {
      addValidationError(
          validationMessages,
          CATEGORY_ALLMANT,
          BEHANDLING_ROOT_FIELD_PATH + ALLMANT_BEHANDLING_ANNAN_BEHANDLING_BESKRIVNING_JSON_ID,
  ...
  private void validateSjukdomenUnderKontroll(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    if (eligibleForRule25(utlatande)
        && utlatande.getHypoglykemier().getSjukdomenUnderKontroll() == null) {
      addValidationError(
          validationMessages,
          CATEGORY_HYPOGLYKEMIER,
  ...
  private void validateNedsattHjarnFunktion(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
  ...
  private void validateFormagaVarningsTecken(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    if (eligibleForRule25(utlatande)
        && utlatande.getHypoglykemier().getFormagaVarningstecken() == null) {
      addValidationError(
          validationMessages,
          CATEGORY_HYPOGLYKEMIER,
  ...
  private void validateEgenkontrollBlodsocker(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
  ...
  private void validateAterkommandeSenasteAret(
    ...
    if (eligibleForRule8(utlatande) || eligibleForRule20(utlatande)) {
      validateDateWithinInterval(
          hypoglykemier.getAterkommandeSenasteTidpunkt(),
  ...
  private void validateAterkommandeSenasteKvartalet(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Hypoglykemier hypoglykemier = utlatande.getHypoglykemier();
    ...
    if (eligibleForRule9(utlatande) || eligibleForRule21(utlatande)) {
      validateDateWithinInterval(
          hypoglykemier.getSenasteTidpunktVaken(),
          ValidatorUtil.getBirthDateFromPersonnummer(
              utlatande.getGrundData().getPatient().getPersonId()),
          LocalDate.now(),
          validationMessages,
  ...
  private void validateForekomstTrafikSenasteAret(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Hypoglykemier hypoglykemier = utlatande.getHypoglykemier();
    ...
    if (eligibleForRule10(utlatande) || eligibleForRule22(utlatande)) {
      validateDateWithinInterval(
          hypoglykemier.getForekomstTrafikTidpunkt(),
          ValidatorUtil.getBirthDateFromPersonnummer(
              utlatande.getGrundData().getPatient().getPersonId()),
          LocalDate.now(),
          validationMessages,
  ...
  private void validateMisstankeOgonSjukdom(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
  ...
  private void validateSynskarpaSkickasSeparat(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    ...
    if (isTrue(utlatande.getSynfunktion().getSkickasSeparat())) {
      ...
      boolean vansterHasValues =
          vanster != null
              && (vanster.getMedKorrektion() != null || vanster.getUtanKorrektion() != null);
      boolean hogerHasValues =
          hoger != null && (hoger.getMedKorrektion() != null || hoger.getUtanKorrektion() != null);
      boolean binokulartHasValues =
          binokulart != null
              && (binokulart.getMedKorrektion() != null || binokulart.getUtanKorrektion() != null);
  ...
  private void validateVanster(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Synskarpevarden vanster = utlatande.getSynfunktion().getVanster();
    validateSynskarpaVarden(
        vanster, "VANSTER", SYNFUNKTION_SYNSKARPA_VANSTER_JSON_ID, utlatande, validationMessages);
  }

  private void validateHoger(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Synskarpevarden hoger = utlatande.getSynfunktion().getHoger();
    validateSynskarpaVarden(
        hoger, "HOGER", SYNFUNKTION_SYNSKARPA_HOGER_JSON_ID, utlatande, validationMessages);
  }

  private void validateBinokulart(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    Synskarpevarden binokulart = utlatande.getSynfunktion().getBinokulart();
    validateSynskarpaVarden(
        binokulart,
        "BINOKULART",
        SYNFUNKTION_SYNSKARPA_BINOKULART_JSON_ID,
        utlatande,
        validationMessages);
  }

  private void validateSynskarpaVarden(
      Synskarpevarden varden,
      String synvardeTyp,
      String field,
    ...
    if (isFalse(utlatande.getSynfunktion().getSkickasSeparat())) {
      ...
      // R19
      if (eligibleForRule19(utlatande, SynfunktionTyp.valueOf(synvardeTyp + "_UTAN_KORREKTION"))
          && invalidSynskarpeVarde(varden.getUtanKorrektion())) {
        addValidationError(
            validationMessages,
            CATEGORY_SYNFUNKTION,
            (SYNFUNKTION_JSON_ID
      ...
      if ((eligibleForRule13(utlatande)
              || eligibleForRule14(utlatande)
              || eligibleForRule15(utlatande))
      ...
      // R19
      if (eligibleForRule19(utlatande, SynfunktionTyp.valueOf(synvardeTyp + "_MED_KORREKTION"))
          && invalidSynskarpeVarde(varden.getMedKorrektion())) {
        addValidationError(
            validationMessages,
            CATEGORY_SYNFUNKTION,
            (SYNFUNKTION_JSON_ID
  ...
  private void validateLampligtInnehav(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    if (eligibleForRule1(utlatande) && utlatande.getBedomning().getLampligtInnehav() == null) {
      addValidationError(
          validationMessages,
          CATEGORY_BEDOMNING,
          BEDOMNING_JSON_ID + "." + BEDOMNING_LAMPLIGHET_ATT_INNEHA_JSON_ID,
          ValidationMessageType.EMPTY);
    }
  }

  private void validateBorUndersokasBeskrivning(
      TsDiabetesUtlatandeV3 utlatande, List<ValidationMessage> validationMessages) {
    if (ValidatorUtil.isBlankButNotNull(utlatande.getBedomning().getBorUndersokasBeskrivning())) {
      addValidationError(
          validationMessages,
          CATEGORY_BEDOMNING,
          BEDOMNING_BOR_UNDERSOKAS_JSON_ID,
    ...
    if (utlatande.getBedomning().getBorUndersokasBeskrivning() != null
        && utlatande.getBedomning().getBorUndersokasBeskrivning().length()
            > MAX_UNDERSOKAS_SPECIALIST_CHARS) {
      addValidationError(
          validationMessages,
          CATEGORY_BEDOMNING,
          BEDOMNING_BOR_UNDERSOKAS_JSON_ID,
  ...
  private void validateOvrigt(
    ...
    if (utlatande.getOvrigt() != null && utlatande.getOvrigt().length() > MAX_OVRIGT_CHARS) {
      addValidationError(
          validationMessages, CATEGORY_OVRIGT, OVRIGT_DELSVAR_JSON_ID, ValidationMessageType.OTHER);
    }
  }
  ...
  private boolean validateDateWithinInterval(
      ...
      String category,
      String field,
      String notBeforeMessage,
      String notAfterMessage) {
    ...
    if (!dateToValidate.isValidDate()) {
      if (dateToValidate.isCorrectFormat()) {
        ...
        addValidationError(
            validationMessages, category, field, ValidationMessageType.INVALID_FORMAT);
      }
      return false;
    }
    ...
    if (dateToValidateLocalDate.isBefore(notBeforeDate)) {
      addValidationError(
          validationMessages, category, field, ValidationMessageType.OTHER, notBeforeMessage);
      return false;
    }
    if (dateToValidateLocalDate.isAfter(notAfterDate)) {
      addValidationError(
          validationMessages, category, field, ValidationMessageType.OTHER, notAfterMessage);
      return false;
    }
