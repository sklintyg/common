    ...
    return CertificateDataElement.builder()
        ...
        .value(
            CertificateDataValueDate.builder()
                .id(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID)
                .date(
                    validDate(aterkommandeVaketSenasteTreTidpunkt)
                        ? aterkommandeVaketSenasteTreTidpunkt.asLocalDate()
                        : null)
                .build())
        .validation(
            new CertificateDataValidation[] {
              ...
              CertificateDataValidationMandatory.builder()
                  ...
                  .expression(
                      singleExpression(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID))
                  .build(),
            })
        .build();
  }
