...
public class QuestionHypoglykemiAterkommandeVaketSenasteTreTidpunkt {

    public static CertificateDataElement toCertificate(Hypoglykemi hypoglykemi, Personnummer personId, int index,
        CertificateTextProvider textProvider) {
        final var aterkommandeVaketSenasteTreTidpunkt =
            hypoglykemi != null && hypoglykemi.getAterkommandeVaketSenasteTreTidpunkt() != null
                ? hypoglykemi.getAterkommandeVaketSenasteTreTidpunkt() : null;
        return CertificateDataElement.builder()
            .id(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_DELSVAR_ID)
            .parent(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_DELSVAR_ID)
            .index(index)
            .config(
                CertificateDataConfigDate.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID)
                    .text(textProvider.get(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_TEXT_ID))
            ...
            .value(
                CertificateDataValueDate.builder()
                    .id(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID)
                    .date(validDate(aterkommandeVaketSenasteTreTidpunkt) ? aterkommandeVaketSenasteTreTidpunkt.asLocalDate() : null)
                    .build()
            )
            .validation(
                new CertificateDataValidation[]{
                    CertificateDataValidationShow.builder()
                        ...
                        .expression(singleExpression(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_JSON_ID))
                        .build(),
                    CertificateDataValidationMandatory.builder()
                        .questionId(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_DELSVAR_ID)
                        .expression(singleExpression(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID))
                        .build(),
                }
            )
            .build();
    ...
    public static InternalDate toInternal(Certificate certificate) {
        final var localDate = dateValue(certificate.getData(), HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_DELSVAR_ID,
