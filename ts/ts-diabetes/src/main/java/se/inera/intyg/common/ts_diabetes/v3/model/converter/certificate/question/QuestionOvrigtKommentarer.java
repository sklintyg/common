...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.OVRIGT_KOMMENTARER_SVAR_TEXT_ID;
...
public class QuestionOvrigtKommentarer {
    ...
    public static CertificateDataElement toCertificate(String kommentarer, int index, CertificateTextProvider textProvider) {
        return CertificateDataElement.builder()
            ...
            .config(
                CertificateDataConfigViewText.builder()
                    .text(textProvider.get(OVRIGT_KOMMENTARER_SVAR_TEXT_ID))
                    .build()
            )
            .value(
