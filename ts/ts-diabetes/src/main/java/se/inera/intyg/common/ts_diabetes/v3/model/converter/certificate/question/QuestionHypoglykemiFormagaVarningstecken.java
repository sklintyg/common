...
public class QuestionHypoglykemiFormagaVarningstecken {
  ...
  public static CertificateDataElement toCertificate(
    ...
    final var varningstecken =
        hypoglykemier != null ? hypoglykemier.getFormagaVarningstecken() : null;
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(booleanValue(varningstecken)).build())
        .build();
  }
}
