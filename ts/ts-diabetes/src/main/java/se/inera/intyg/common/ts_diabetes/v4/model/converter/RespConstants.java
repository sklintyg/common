...
public final class RespConstants {
  ...
  public static final String IDENTITET_STYRKT_GENOM_FORETAG_ELLER_TJANSTEKORT_TEXT_ID =
      "KV_ID_KONTROLL.IDK2.RBK";
  public static final String IDENTITET_STYRKT_GENOM_KORKORT_TEXT_ID = "KV_ID_KONTROLL.IDK3.RBK";
  public static final String IDENTITET_STYRKT_GENOM_PERS_KANNEDOM_TEXT_ID =
      "KV_ID_KONTROLL.IDK4.RBK";
  public static final String IDENTITET_STYRKT_GENOM_FORSAKRAN_KAP18_TEXT_ID =
      "KV_ID_KONTROLL.IDK5.RBK";
  ...
  public static final String ALLMANT_PATIENTEN_FOLJS_AV_SPECIALISTVARD_LABEL_ID =
      "KV_VARDNIVA_VN2.RBK";
  ...
  public static final String ALLMANT_BESKRIVNING_ANNAN_TYP_AV_DIABETES_JSON_ID =
      "beskrivningAnnanTypAvDiabetes";
  ...
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_JSON_ID =
      "medicineringMedforRiskForHypoglykemi";
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_TEXT_ID =
      "FRG_208.RBK";
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_DESCRIPTION_ID =
      "FRG_208.HLP";
  ...
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_TIDPUNKT_SVAR_ID =
      "210";
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_TIDPUNKT_DELSVAR_ID =
      "210.1";
  ...
  public static final String ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_TIDPUNKT_TEXT_ID =
      "FRG_210.RBK";
  ...
  public static final String HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_JSON_ID =
  ...
  public static final String HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_VARFOR_JSON_ID =
      "kontrollSjukdomstillstandVarfor";
  public static final String HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_VARFOR_TEXT_ID =
      "DFR_200.2.RBK";
  ...
  public static final String HYPOGLYKEMI_FORSTAR_RISKER_MED_HYPOGLYKEMI_JSON_ID =
      "forstarRiskerMedHypoglykemi";
  public static final String HYPOGLYKEMI_FORSTAR_RISKER_MED_HYPOGLYKEMI_TEXT_ID = "FRG_201.RBK";
  public static final String HYPOGLYKEMI_FORSTAR_RISKER_MED_HYPOGLYKEMI_DESCRIPTION_ID =
      "FRG_201.HLP";
  ...
  public static final String HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_JSON_ID =
      "formagaKannaVarningstecken";
  public static final String HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_TEXT_ID = "FRG_110.RBK";
  public static final String HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_DESCRIPTION_ID =
      "FRG_110.HLP";
  ...
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_JSON_ID =
      "aterkommandeSenasteAret";
  ...
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TIDPUNKT_JSON_ID =
      "aterkommandeSenasteAretTidpunkt";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TIDPUNKT_TEXT_ID =
      "DFR_106.2.RBK";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_DELSVAR_ID =
      "106.3";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_JSON_ID =
      "aterkommandeSenasteAretKontrolleras";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_TEXT_ID =
      "DFR_106.3.RBK";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID = "106.5";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_JSON_ID =
      "aterkommandeSenasteAretTrafik";
  ...
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TOLV_JSON_ID =
      "aterkommandeVaketSenasteTolv";
  ...
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_JSON_ID =
      "aterkommandeVaketSenasteTre";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TEXT_ID = "DFR_107.3.RBK";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_DELSVAR_ID =
      "107.5";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_JSON_ID =
      "aterkommandeVaketSenasteTreTidpunkt";
  public static final String HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_TEXT_ID =
      "DFR_107.5.RBK";
  ...
  public static final String HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_JSON_ID =
      "allvarligSenasteTolvManaderna";
  public static final String HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_TEXT_ID = "FRG_203.RBK";
  public static final String HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_TIDPUNKT_DELSVAR_ID =
      "203.2";
  public static final String HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_TIDPUNKT_JSON_ID =
      "allvarligSenasteTolvManadernaTidpunkt";
  public static final String HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_TIDPUNKT_TEXT_ID =
      "DFR_203.2.RBK";
  ...
  public static final String HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_JSON_ID =
      "regelbundnaBlodsockerkontroller";
  public static final String HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_TEXT_ID = "FRG_204.RBK";
  public static final String HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_DESCRIPTION_ID =
      "FRG_204.HLP";
  ...
  public static final String OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_JSON_ID =
      "komplikationerAvSjukdomen";
  ...
  public static final String OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_ANGES_JSON_ID =
      "komplikationerAvSjukdomenAnges";
  public static final String OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_ANGES_TEXT_ID = "DFR_206.2.RBK";
  public static final String OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_ANGES_DESCRIPTION_ID =
      "DFR_206.2.HLP";
  ...
  public static final String OVRIGT_BOR_UNDERSOKAS_AV_SPECIALIST_JSON_ID =
      "borUndersokasAvSpecialist";
  ...
  public static final String BEDOMNING_UPPFYLLER_BEHORIGHETSKRAV_JSON_ID =
      "uppfyllerBehorighetskrav";
  public static final String BEDOMNING_UPPFYLLER_BEHORIGHETSKRAV_TEXT =
  ...
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR12_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR12.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR13_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR13.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR14_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR14.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR15_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR15.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR16_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR16.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR17_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR17.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR18_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR18.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR1_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR1.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR2_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR2.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR3_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR3.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR4_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR4.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR5_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR5.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR6_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR6.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR7_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR7.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR8_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR8.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR9_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR9.RBK";
  public static final String BEDOMNING_KORKORTSBEHORIGHET_VAR11_LABEL_ID =
      "KV_KORKORTSBEHORIGHET.VAR11.RBK";
