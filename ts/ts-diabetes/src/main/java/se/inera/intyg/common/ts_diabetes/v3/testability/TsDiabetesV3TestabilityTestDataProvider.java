...
public class TsDiabetesV3TestabilityTestDataProvider
    implements TestabilityUtlatandeTestDataProvider<TsDiabetesUtlatandeV3> {

  @Override
  public TsDiabetesUtlatandeV3 getMinimumValues(TsDiabetesUtlatandeV3 utlatande) {
    return utlatande.toBuilder()
        .setIntygAvser(IntygAvser.create(EnumSet.of(IntygAvserKategori.IAV1)))
        ...
        .setSynfunktion(
            Synfunktion.builder()
                .setBinokulart(Synskarpevarden.builder().setMedKorrektion(1.0).build())
                .setHoger(Synskarpevarden.builder().setMedKorrektion(1.0).build())
                .setVanster(Synskarpevarden.builder().setMedKorrektion(1.0).build())
    ...
    return utlatande.toBuilder()
        ...
        .setSynfunktion(
            Synfunktion.builder()
                ...
                .setHoger(
                    Synskarpevarden.builder().setUtanKorrektion(1.0).setMedKorrektion(1.0).build())
                .setVanster(
                    Synskarpevarden.builder().setMedKorrektion(1.0).setUtanKorrektion(1.0).build())
