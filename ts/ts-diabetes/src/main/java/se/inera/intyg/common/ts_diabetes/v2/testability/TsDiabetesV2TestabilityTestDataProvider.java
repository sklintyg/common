...
public class TsDiabetesV2TestabilityTestDataProvider
    implements TestabilityUtlatandeTestDataProvider<TsDiabetesUtlatandeV2> {
  ...
  public TsDiabetesUtlatandeV2 getMaximumValues(TsDiabetesUtlatandeV2 utlatande) {
    ...
    utlatande
        .getHypoglykemier()
        .setAllvarligForekomstTrafikBeskrivning("hur många sådana episoder och när inträffade de?");
