    ...
    ['$log', '$timeout', 'common.ObjectHelper', 'common.DateUtilsService', 'common.ueFactoryTemplatesHelper',
      ...
      function($log, $timeout, ObjectHelper, DateUtils, ueFactoryTemplates, ueTSFactoryTemplates) {
        ...
        function R14(model) {
          ...
          return (hogerUtanKorr < 0.8 && vansterUtanKorr < 0.8) && _hasAnyOfIntygAvserBehorighet(model,
        ...
        function R15(model) {
          var hogerUtanKorr = _synvarde(model, 'synfunktion.hoger.utanKorrektion', 99);
          var vansterUtanKorr = _synvarde(model, 'synfunktion.vanster.utanKorrektion', 99);
          return (hogerUtanKorr < 0.1 || vansterUtanKorr < 0.1) && _hasAnyOfIntygAvserBehorighet(model,
              ['C1', 'C1E', 'C', 'CE', 'D1', 'D1E', 'D', 'DE', 'TAXI']);
        }
              ...
              fraga(18, 'FRG_18.RBK', '', {required: true, requiredProp: 'allmant.typAvDiabetes'}, [{
              ...
              },
                {
                  ...
                  hideExpression: function(scope) {
                    return (scope.model.allmant.typAvDiabetes !== 'ANNAN');
                  },
                  htmlMaxlength: '160',
                  label: {
                    key: 'DFR_18.2.RBK',
