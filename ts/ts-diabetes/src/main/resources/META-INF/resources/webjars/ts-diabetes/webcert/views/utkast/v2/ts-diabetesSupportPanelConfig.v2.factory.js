 ...
 */
/**
 * Creates the supportpanel config related to working with ts-diabetes intyg and utkast
 *
 * Created by marced on 2018-01-26.
 */
angular.module('ts-diabetes').factory('ts-diabetes.supportPanelConfigFactory.v2', [ function() {
    'use strict';
