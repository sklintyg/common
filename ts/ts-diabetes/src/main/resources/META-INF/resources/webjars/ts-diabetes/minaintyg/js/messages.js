...
angular.module('ts-diabetes').constant('ts-diabetes.messages', {
    'sv': {
        ...
        'ts-diabetes.label.pageingress.v2': '<p>Här visas hela ditt läkarintyg. Från den här sidan kan du ladda ner intyget som PDF och arkivera intyget. För medicinska frågor som rör ditt intyg ska du kontakta den som utfärdade ditt intyg eller den mottagning du besökte när du fick ditt intyg utfärdat.</p><p>Du har fått ett intyg från din läkare som inte går att skicka digitalt.</p>',
        'ts-diabetes.label.pageingress.v3': 'Här visas hela ditt läkarintyg. Från den här sidan kan du skicka intyget elektroniskt, ladda ned intyget som PDF och arkivera intyget. För medicinska frågor som rör ditt intyg ska du kontakta den som utfärdade ditt intyg, eller den mottagning du besökte när du fick ditt intyg utfärdat.',
        'ts-diabetes.label.pageingress.v4': 'Här visas hela ditt läkarintyg. Från den här sidan kan du skicka intyget elektroniskt, ladda ned intyget som PDF och arkivera intyget. För medicinska frågor som rör ditt intyg ska du kontakta den som utfärdade ditt intyg, eller den mottagning du besökte när du fick ditt intyg utfärdat.',
