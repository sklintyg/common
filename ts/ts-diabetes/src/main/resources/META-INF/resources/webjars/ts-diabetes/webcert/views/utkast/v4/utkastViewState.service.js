 ...
 */
angular.module('ts-diabetes').service('ts-diabetes.UtkastController.ViewStateService.v4',
    ['$log', '$state', 'common.UtkastViewStateService', 'ts-diabetes.Domain.IntygModel.v4',
