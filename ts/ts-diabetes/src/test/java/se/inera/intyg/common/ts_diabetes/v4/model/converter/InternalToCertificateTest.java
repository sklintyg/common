...
class InternalToCertificateTest {
  ...
  void shallIncludeQuestionDiagnosAr() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        6, actualCertificate.getData().get(ALLMANT_DIABETES_DIAGNOS_AR_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionDiabetesBeskrivningAnnanTyp() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(ALLMANT_BESKRIVNING_ANNAN_TYP_AV_DIABETES_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionDiabetesHarMedicinering() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        9, actualCertificate.getData().get(ALLMANT_MEDICINERING_FOR_DIABETES_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionDiabetesMedicineringHypoglykemiRisk() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionDiabetesBehandlingAnnan() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(ALLMANT_BEHANDLING_ANNAN_ANGE_VILKEN_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionMedicineringHypoglykemiRiskDatum() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(ALLMANT_MEDICINERING_MEDFOR_RISK_FOR_HYPOGYKEMI_TIDPUNKT_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionKontrollSjukdomstillstand() {
    ...
    assertEquals(
        15,
        actualCertificate.getData().get(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionKontrollSjukdomstillstandVarfor() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_VARFOR_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionForstarRiskerMedHypoglykemi() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_FORSTAR_RISKER_MED_HYPOGLYKEMI_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionFormagaKannaVarningstecken() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionVidtaAdekvataAtgarder() {
    ...
    assertEquals(
        19,
        actualCertificate.getData().get(HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeSenasteAret() {
    ...
    assertEquals(
        20,
        actualCertificate.getData().get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeSenasteAretTidpunkt() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TIDPUNKT_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeSenasteAretKontrolleras() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeSenasteAretTrafik() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeVaketSenasteTolv() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TOLV_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeVaketSenasteTre() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAterkommandeVaketSenasteTreTidpunkt() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TIDPUNKT_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAllvarligSenasteTolvManaderna() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionAllvarligSenasteTolvManadernaTidpunkt() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_SENASTE_TOLV_MANADERNA_TIDPUNKT_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionRegelbundnaBlodsockerkontroller() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionKomplikationerAvSjukdomen() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        31, actualCertificate.getData().get(OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionKomplikationerAvSjukdomenAnges() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(OVRIGT_KOMPLIKATIONER_AV_SJUKDOMEN_ANGES_DELSVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionBorUndersokasAvSpecialist() {
    ...
    assertEquals(
        33,
        actualCertificate.getData().get(OVRIGT_BOR_UNDERSOKAS_AV_SPECIALIST_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionOvrigaKommentarer() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        36, actualCertificate.getData().get(BEDOMNING_OVRIGA_KOMMENTARER_SVAR_ID).getIndex());
  }
}
