    ...
    class RightEye {
      ...
      void shouldIncludeWithoutCorrection() {
        ...
        final var element =
            QuestionSynSynskarpa.toCertificate(
                Synfunktion.builder()
                    .setHoger(Synskarpevarden.builder().setUtanKorrektion(2.0).build())
                    .build(),
                0,
                textProvider);
      ...
      void shouldIncludeWithCorrection() {
        ...
        final var element =
            QuestionSynSynskarpa.toCertificate(
                Synfunktion.builder()
                    .setHoger(Synskarpevarden.builder().setMedKorrektion(2.0).build())
                    .build(),
                0,
                textProvider);
        final var value = (CertificateDataValueViewTable) element.getValue();
    ...
    class LeftEye {
      ...
      void shouldIncludeWithoutCorrection() {
        ...
        final var element =
            QuestionSynSynskarpa.toCertificate(
                Synfunktion.builder()
                    .setVanster(Synskarpevarden.builder().setUtanKorrektion(2.0).build())
                    .build(),
                0,
                textProvider);
        final var value = (CertificateDataValueViewTable) element.getValue();
      ...
      void shouldIncludeWithCorrection() {
        ...
        final var element =
            QuestionSynSynskarpa.toCertificate(
                Synfunktion.builder()
                    .setVanster(Synskarpevarden.builder().setMedKorrektion(2.0).build())
                    .build(),
                0,
                textProvider);
        final var value = (CertificateDataValueViewTable) element.getValue();
