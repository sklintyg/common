...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.HYPOGLYKEMI_TECKEN_NEDSATT_HJARNFUNKTION_SVAR_TEXT_ID;
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.certificate.question.QuestionHypoglykemiKunskapOmAtgarder.toCertificate;
...
class QuestionHypoglykemiTeckenNedsattHjarnfunktionTest {
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Boolean> {
    ...
    protected CertificateDataElement getElement(Boolean expectedValue) {
      return toCertificate(expectedValue, 0, textProvider);
    }
    ...
    protected List<InputExpectedValuePair<Boolean, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              false, CertificateDataValueViewText.builder().text("Nej").build()));
    }
  }
}
