...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.HYPOGLYKEMI_GODTAGBAR_KONTROLL_SVAR_TEXT_ID;
...
class QuestionHypoglykemiGodtagbarKontrollTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiGodtagbarKontroll.toCertificate(null, 0, texts);
    }

    @Override
    protected String getId() {
      return HYPOGLYKEMI_GODTAGBAR_KONTROLL_SVAR_ID;
    }
  ...
  class IncludeConfigViewTextTests extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return HYPOGLYKEMI_GODTAGBAR_KONTROLL_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Hypoglykemier> {
    ...
    protected CertificateDataElement getElement(Hypoglykemier expectedValue) {
      return QuestionHypoglykemiGodtagbarKontroll.toCertificate(expectedValue, 0, texts);
    }
    ...
    protected List<InputExpectedValuePair<Hypoglykemier, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Hypoglykemier.builder().setSjukdomenUnderKontroll(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Hypoglykemier.builder().setSjukdomenUnderKontroll(false).build(),
