...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TRE_TEXT_ID;
...
class QuestionHypoglykemiAterkommandeVaketSenasteTreTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiAterkommandeVaketSenasteTre.toCertificate(null, 0, texts);
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Hypoglykemier> {
    ...
    protected CertificateDataElement getElement(Hypoglykemier expectedValue) {
      return QuestionHypoglykemiAterkommandeVaketSenasteTre.toCertificate(expectedValue, 0, texts);
    }
    ...
    protected List<InputExpectedValuePair<Hypoglykemier, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Hypoglykemier.builder().setAterkommandeSenasteKvartalet(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Hypoglykemier.builder().setAterkommandeSenasteKvartalet(false).build(),
