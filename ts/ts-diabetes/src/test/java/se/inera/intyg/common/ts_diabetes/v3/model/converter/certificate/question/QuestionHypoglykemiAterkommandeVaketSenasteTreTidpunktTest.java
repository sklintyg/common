...
class QuestionHypoglykemiAterkommandeVaketSenasteTreTidpunktTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeVaketSenasteTreTidpunkt.toCertificate(null, 0, texts);
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<Hypoglykemier> {
        ...
        protected CertificateDataElement getElement(Hypoglykemier expectedValue) {
            return QuestionHypoglykemiAterkommandeVaketSenasteTreTidpunkt.toCertificate(expectedValue, 0, texts);
        }
        ...
        protected List<InputExpectedValuePair<Hypoglykemier, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(Hypoglykemier.builder().setSenasteTidpunktVaken(new InternalDate(LocalDate.now())).build(),
