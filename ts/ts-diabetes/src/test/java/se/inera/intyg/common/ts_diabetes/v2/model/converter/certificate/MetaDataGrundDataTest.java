    ...
    class ToCertificate {
        ...
        class IncludeTestCommonMetadata extends CommonMetaDataTest {
            ...
            protected CertificateMetadata getMetaData() {
                return MetaDataGrundData.toCertificate((TsDiabetesUtlatandeV2) getInternalCertificate(), texts);
            }

            @Override
            protected Utlatande getInternalCertificate() {
                TsDiabetesUtlatandeV2 tsDiabetesUtlatandeV2 = new TsDiabetesUtlatandeV2();
                tsDiabetesUtlatandeV2.setGrundData(grundData);
                tsDiabetesUtlatandeV2.setId("id");
                tsDiabetesUtlatandeV2.setTextVersion("textVersion");
