...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_DESCRIPTION_ID;
...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_TEXT_ID;
...
class QuestionHypoglykemiVidtaAdekvataAtgarderTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiVidtaAdekvataAtgarder.toCertificate(null, getIndex(), textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_SVAR_ID;
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiVidtaAdekvataAtgarder.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_DELSVAR_ID;
        }

        @Override
        protected String getTextId() {
            return HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return HYPOGLYKEMI_VIDTA_ADEKVATA_ATGARDER_DESCRIPTION_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setVidtaAdekvataAtgarder(true).build();
            return QuestionHypoglykemiVidtaAdekvataAtgarder.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setVidtaAdekvataAtgarder(expectedValue).build();
            return QuestionHypoglykemiVidtaAdekvataAtgarder.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiVidtaAdekvataAtgarder.toInternal(certificate);
        }
    }
}
