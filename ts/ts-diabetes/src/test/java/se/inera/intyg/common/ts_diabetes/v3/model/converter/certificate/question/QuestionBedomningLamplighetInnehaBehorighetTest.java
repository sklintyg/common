...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.BEDOMNING_LAMPLIGHET_SVAR_TEXT_ID;
...
class QuestionBedomningLamplighetInnehaBehorighetTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionBedomningLamplighetInnehaBehorighet.toCertificate(null, 0, texts);
    }

    @Override
    protected String getId() {
      return BEDOMNING_LAMPLIGHET_SVAR_ID;
    }
  ...
  class IncludeConfigViewTextTests extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return BEDOMNING_LAMPLIGHET_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Bedomning> {
    ...
    protected CertificateDataElement getElement(Bedomning expectedValue) {
      return QuestionBedomningLamplighetInnehaBehorighet.toCertificate(expectedValue, 0, texts);
    }

    @Override
    protected List<InputExpectedValuePair<Bedomning, CertificateDataValueViewText>>
        inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              null, CertificateDataValueViewText.builder().text("Ej angivet").build()),
          new InputExpectedValuePair<>(
              Bedomning.builder().setLampligtInnehav(true).build(),
              CertificateDataValueViewText.builder().text("Ja").build()),
          new InputExpectedValuePair<>(
              Bedomning.builder().setLampligtInnehav(false).build(),
