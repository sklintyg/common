 ...
 */
package se.inera.intyg.common.ts_diabetes.v4.utils;
...
public final class ScenarioFinder {
  ...
  private static final String TRANSPORT_MODEL_PATH = "classpath:/v4/transport/scenarios/";

  private static final String INTERNAL_MODEL_PATH = "classpath:/v4/internal/scenarios/";
   ...
   */
  public static List<Scenario> getTransportScenarios(String scenarioWithWildcards)
      throws ScenarioNotFoundException {
    return getScenarios(
        scenarioWithWildcards + TRANSPORT_MODEL_EXT, TRANSPORT_MODEL_PATH, "transport");
  }
   ...
   * @throws ScenarioNotFoundException If no scenarios could be found.
   */
  public static List<Scenario> getInternalScenarios(String scenarioWithWildcards)
      throws ScenarioNotFoundException {
    return getScenarios(
        scenarioWithWildcards + INTERNAL_MODEL_EXT, INTERNAL_MODEL_PATH, "internal");
  }

  public static List<Scenario> getScenarios(
      String scenarioWithWildcards, String scenarioPath, String model)
      throws ScenarioNotFoundException {
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    public RegisterCertificateType asTransportModel() throws ScenarioNotFoundException {
      try {
        JAXBElement<RegisterCertificateType> el =
            XmlMarshallerHelper.unmarshal(getTransportModelFor(getName()));
        return el.getValue();
      } catch (IOException e) {
    ...
    /** {@inheritDoc} */
    @Override
    public TsDiabetesUtlatandeV4 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), TsDiabetesUtlatandeV4.class);
      } catch (IOException e) {
