...
class QuestionIdentitetStyrktGenomTest {
    ...
    class ToCertificate {
        ...
        class IncludeValueCodeTest extends ValueCodeTest {
            ...
            protected CertificateDataElement getElement() {
                return QuestionIdentitetStyrktGenom.toCertificate(
                    IdKontroll.create(KvIdKontroll.FORETAG_ELLER_TJANSTEKORT), 0, textProvider);
            }
        ...
        class ToInternal extends InternalValueTest<IdKontroll, IdKontroll> {

            @Override
            protected CertificateDataElement getElement(IdKontroll input) {
                return QuestionIdentitetStyrktGenom.toCertificate(input, 0, textProvider);
            }

            @Override
            protected IdKontroll toInternalValue(Certificate certificate) {
