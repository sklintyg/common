...
class QuestionHypoglykemiAllvarligSenasteTolvManadernaTidpunktTest {
  ...
  class IncludeCommonElementTest extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiAllvarligSenasteTolvManadernaTidpunkt.toCertificate(
  ...
  class IncludeValueDateTest extends ValueDateTest {
    ...
    protected CertificateDataElement getElement() {
      final var hypoglykemi =
          Hypoglykemi.builder()
              .setAllvarligSenasteTolvManadernaTidpunkt(new InternalDate(getDate()))
              .build();
      return QuestionHypoglykemiAllvarligSenasteTolvManadernaTidpunkt.toCertificate(
    ...
    protected List<InputExpectedValuePair<Hypoglykemi, InternalDate>> inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              Hypoglykemi.builder()
                  .setAllvarligSenasteTolvManadernaTidpunkt(new InternalDate("2022-12-15"))
                  .build(),
              new InternalDate("2022-12-15")),
          new InputExpectedValuePair<>(
              Hypoglykemi.builder()
                  .setAllvarligSenasteTolvManadernaTidpunkt(new InternalDate(""))
                  .build(),
              null),
