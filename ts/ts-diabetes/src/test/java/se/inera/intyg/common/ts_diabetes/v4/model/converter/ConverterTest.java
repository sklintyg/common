...
import se.inera.intyg.common.ts_diabetes.v4.rest.TsDiabetesModuleApiV4;
...
public class ConverterTest {
  ...
  @Test
  public void doSchematronValidationTsDiabetesV4() throws Exception {
    String xmlContents =
        Resources.toString(getResource("v4/transport/scenarios/pass-complete.xml"), Charsets.UTF_8);

    RegisterCertificateTestValidator generalValidator = new RegisterCertificateTestValidator();
    assertTrue(generalValidator.validateGeneral(xmlContents));

    RegisterCertificateValidator validator =
        new RegisterCertificateValidator(TsDiabetesModuleApiV4.SCHEMATRON_FILE);
  ...
  public void outputJsonFromXml() throws Exception {
    ...
    TsDiabetesUtlatandeV4 utlatandeFromJson =
        objectMapper.readValue(json, TsDiabetesUtlatandeV4.class);
  ...
  private String getXmlFromModel(RegisterCertificateType transport) throws JAXBException {
    ...
    JAXBContext jaxbContext =
        JAXBContext.newInstance(
            RegisterCertificateType.class, DatePeriodType.class, PartialDateType.class);
  ...
  private String getJsonFromTransport(RegisterCertificateType transport) throws ConverterException {
    ...
    TsDiabetesUtlatandeV4 internal = TransportToInternal.convert(transport.getIntyg());
    try {
