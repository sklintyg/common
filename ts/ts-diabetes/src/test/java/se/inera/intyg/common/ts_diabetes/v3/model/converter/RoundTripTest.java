...
import se.inera.intyg.common.ts_diabetes.v3.utils.Scenario;
...
class RoundTripTest {
  ...
  void testRoundTripInternalFirst(String name, Scenario scenario) throws Exception {
    ...
    TsDiabetesUtlatandeV3 expectedInternal =
        objectMapper.readValue(
            getClass()
                .getResourceAsStream("/v3/internal/scenarios/roundtripjson/" + name + ".json"),
            TsDiabetesUtlatandeV3.class);
  ...
  void testRoundTripTransportFirst(String name, Scenario scenario) throws Exception {
    CustomObjectMapper objectMapper = new CustomObjectMapper();
    TsDiabetesUtlatandeV3 internal =
