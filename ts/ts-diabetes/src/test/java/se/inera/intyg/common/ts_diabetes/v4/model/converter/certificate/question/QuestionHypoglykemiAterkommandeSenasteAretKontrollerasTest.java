...
class QuestionHypoglykemiAterkommandeSenasteAretKontrollerasTest {
  ...
  class IncludeCommonElementTest extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiAterkommandeSenasteAretKontrolleras.toCertificate(
  ...
  class IncludeValueBooleanTest extends ValueBooleanTest {
    ...
    protected CertificateDataElement getElement() {
      final var hypoglykemi =
          Hypoglykemi.builder().setAterkommandeSenasteAretKontrolleras(true).build();
      return QuestionHypoglykemiAterkommandeSenasteAretKontrolleras.toCertificate(
  ...
  class IncludeValidationMandatoryTest extends ValidationMandatoryTest {
    ...
    @Override
    protected String getExpression() {
      return "exists(" + HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_KONTROLLERAS_JSON_ID + ")";
    }
  }
  ...
  class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
    ...
    protected CertificateDataElement getElement(Boolean expectedValue) {
      final var hypoglykemi =
          Hypoglykemi.builder().setAterkommandeSenasteAretKontrolleras(expectedValue).build();
      return QuestionHypoglykemiAterkommandeSenasteAretKontrolleras.toCertificate(
          hypoglykemi, 0, textProvider);
    }
