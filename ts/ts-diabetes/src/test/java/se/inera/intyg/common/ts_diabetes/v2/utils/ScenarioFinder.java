...
public class ScenarioFinder {
  ...
  private static final String TRANSFORMED_TRANSPORT_MODEL_PATH =
      "classpath:/v2/scenarios/transformed/";
  ...
  private static class FileBasedScenario implements Scenario {
    ...
    public RegisterTSDiabetesType asTransportModel() throws ScenarioNotFoundException {
      try {
        JAXBElement<RegisterTSDiabetesType> el =
            XmlMarshallerHelper.unmarshal(getTransportModelFor(getName(), TRANSPORT_MODEL_PATH));
        return el.getValue();
      } catch (IOException e) {
    ...
    public se.riv
        ...
        asTransformedTransportModel() throws ScenarioNotFoundException {
      try {
        JAXBElement<
                se.riv
                    .clinicalprocess
    ...
    /** {@inheritDoc} */
    @Override
    public TsDiabetesUtlatandeV2 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), TsDiabetesUtlatandeV2.class);
      } catch (IOException e) {
