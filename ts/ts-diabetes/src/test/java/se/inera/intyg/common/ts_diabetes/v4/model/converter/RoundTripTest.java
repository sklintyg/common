...
class RoundTripTest {
    ...
    void testRoundTripInternalFirst(String name, Scenario scenario) throws Exception {
        ...
        TsDiabetesUtlatandeV4 expectedInternal = objectMapper.readValue(
            getClass().getResourceAsStream("/v4/internal/scenarios/roundtripjson/" + name + ".json"),
    ...
    void testRoundTripTransportFirst(String name, Scenario scenario) throws Exception {
        CustomObjectMapper objectMapper = new CustomObjectMapper();
        TsDiabetesUtlatandeV4 internal = TransportToInternal.convert(scenario.asTransportModel().getIntyg());
