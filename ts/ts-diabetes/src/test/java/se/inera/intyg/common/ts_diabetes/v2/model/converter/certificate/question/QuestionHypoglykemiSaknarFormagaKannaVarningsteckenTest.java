...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.HYPOGLYKEMI_SAKNAR_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_TEXT_ID;
...
class QuestionHypoglykemiSaknarFormagaKannaVarningsteckenTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiSaknarFormagaKannaVarningstecken.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_SAKNAR_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_SAKNAR_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_TEXT_ID;
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<Boolean> {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            return QuestionHypoglykemiSaknarFormagaKannaVarningstecken.toCertificate(expectedValue, 0, textProvider);
        }
