...
public class RegisterCertificateTestValidator {
  ...
  private static final String EXT_SCHEMA_32 =
      "core_components/clinicalprocess_healthcond_certificate_3.2_ext.xsd";
  private static final String EXT_SCHEMA_34 =
  ...
  public void initGeneralSchema() throws IOException, SAXException {
    ...
    schemaValidatorBuilder.registerResource(EXT_SCHEMA_32);
    schemaValidatorBuilder.registerResource(EXT_SCHEMA_34);
