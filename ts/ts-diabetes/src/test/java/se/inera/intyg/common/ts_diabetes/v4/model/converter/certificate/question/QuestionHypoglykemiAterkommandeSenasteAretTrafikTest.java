...
class QuestionHypoglykemiAterkommandeSenasteAretTrafikTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeSenasteAretTrafik.toCertificate(null, getIndex(), textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_DELSVAR_ID;
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiAterkommandeSenasteAretTrafik.toCertificate(null, 0, textProvider);
        }
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TEXT_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeSenasteAretTrafik(true).build();
            return QuestionHypoglykemiAterkommandeSenasteAretTrafik.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeSenasteAretTrafik(expectedValue).build();
            return QuestionHypoglykemiAterkommandeSenasteAretTrafik.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiAterkommandeSenasteAretTrafik.toInternal(certificate);
        }
    }
}
