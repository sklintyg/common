...
final class ValidationMessages {
    ...
    static final String RULE12_MESSAGE = "Om \"Proliferativ retinopati, genomgången laserbehandling av retinopati, signifikant makulaödem, annan ögonsjukdom eller ögonbottenfoto som ger misstanke om sådan ögonsjukdom (Delsvar)\" har värdet false, eller\n" +
            "        om \"Ögonbottenfoto saknas (Delsvar)\" har värdet false,\n" +
            "        måste även \"Synskärpa (Svar)\" besvaras.";
    static final String RULE13_MESSAGE = "Om frågan \"Intyget avser behörighet (delsvar)\" besvarats med något av valen \"IAV11 - IAV17\"\n" +
