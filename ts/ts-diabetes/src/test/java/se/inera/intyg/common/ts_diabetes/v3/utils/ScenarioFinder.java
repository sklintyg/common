 ...
 */
package se.inera.intyg.common.ts_diabetes.v3.utils;
...
public final class ScenarioFinder {
  ...
  private static final String TRANSPORT_MODEL_PATH = "classpath:/v3/transport/scenarios/";

  private static final String INTERNAL_MODEL_PATH = "classpath:/v3/internal/scenarios/";
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    /** {@inheritDoc} */
    @Override
    public TsDiabetesUtlatandeV3 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), TsDiabetesUtlatandeV3.class);
      } catch (IOException e) {
