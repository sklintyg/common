...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TIDPUNKT_TEXT_ID;
...
class QuestionHypoglykemiAterkommandeSenasteAretTidpunktTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeSenasteAretTidpunkt.toCertificate(null, 0, texts);
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<Hypoglykemier> {
        ...
        protected CertificateDataElement getElement(Hypoglykemier expectedValue) {
            return QuestionHypoglykemiAterkommandeSenasteAretTidpunkt.toCertificate(expectedValue, 0, texts);
        }
        ...
        protected List<InputExpectedValuePair<Hypoglykemier, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(
                    Hypoglykemier.builder().setAterkommandeSenasteTidpunkt(new InternalDate(LocalDate.now())).build(),
