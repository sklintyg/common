...
class QuestionHypoglykemiAterkommandeSenasteAretTidpunktTest {
  ...
  class IncludeCommonElementTest extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiAterkommandeSenasteAretTidpunkt.toCertificate(
  ...
  class IncludeValueDateTest extends ValueDateTest {
    ...
    protected CertificateDataElement getElement() {
      final var hypoglykemi =
          Hypoglykemi.builder()
              .setAterkommandeSenasteAretTidpunkt(new InternalDate(getDate()))
              .build();
      return QuestionHypoglykemiAterkommandeSenasteAretTidpunkt.toCertificate(
    ...
    protected List<InputExpectedValuePair<Hypoglykemi, InternalDate>> inputExpectedValuePairList() {
      return List.of(
          new InputExpectedValuePair<>(
              Hypoglykemi.builder()
                  .setAterkommandeSenasteAretTidpunkt(new InternalDate("2022-12-15"))
                  .build(),
              new InternalDate("2022-12-15")),
          new InputExpectedValuePair<>(
              Hypoglykemi.builder()
                  .setAterkommandeSenasteAretTidpunkt(new InternalDate(""))
                  .build(),
              null),
