...
package se.inera.intyg.common.ts_diabetes.v4.model.converter.certificate;
...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.certificate.MetaDataGrundData.toInternal;
    ...
    class ToCertificate {
        ...
        class IncludeTestCommonMetadata extends CommonMetaDataTest {
            ...
            protected CertificateMetadata getMetaData() {
                return MetaDataGrundData.toCertificate((TsDiabetesUtlatandeV4) getInternalCertificate(), texts);
            }
