...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_BESKRIVNING_SVAR_TEXT_ID;
...
class QuestionHypoglykemiAllvarligForekomstTrafikenBeskrivningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAllvarligForekomstTrafikenBeskrivning.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_BESKRIVNING_SVAR_ID;
        }

        @Override
        protected String getParent() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_SVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_BESKRIVNING_SVAR_TEXT_ID;
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<String> {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionHypoglykemiAllvarligForekomstTrafikenBeskrivning.toCertificate(expectedValue, 0, textProvider);
        }
