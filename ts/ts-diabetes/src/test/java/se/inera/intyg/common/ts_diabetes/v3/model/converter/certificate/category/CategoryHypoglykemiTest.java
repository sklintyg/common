...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.HYPOGLYKEMI_CATEGORY_TEXT_ID;
...
class CategoryHypoglykemiTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryHypoglykemi.toCertificate(0, texts);
        }
