...
class InternalToCertificateTest {
  ...
  void shallIncludeQuestionDiabetesInsulinBehandlingsperiod() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        8, actualCertificate.getData().get(ALLMANT_BEHANDLING_INSULIN_DELSVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionDiabetesAnnanBehandlingBeskrivning() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        9, actualCertificate.getData().get(ALLMANT_BEHANDLING_ANNAN_DELSVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiKunskapOmAtgarder() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        11, actualCertificate.getData().get(HYPOGLYKEMI_KUNSKAP_OM_ATGARDER_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiSaknarFormagaKannaVarningstecken() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_SAKNAR_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomst() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        14, actualCertificate.getData().get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomstBeskrivning() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_BESKRIVNING_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomstTrafiken() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomstTrafikenBeskrivning() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_TRAFIKEN_BESKRIVNING_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomstVakenTid() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionHypoglykemiAllvarligForekomstVakenTidObervationstid() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_OBSERVATIONSTID_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionSynSeparatOgonlakarintyg() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        22, actualCertificate.getData().get(SYN_SEPARAT_OGONLAKARINTYG_SVAR_ID).getIndex());
  }
  ...
  void shallIncludeQuestionBedomningKorkortstypHeader() {
    ...
    assertEquals(
        ...
        actualCertificate
            .getData()
            .get(BEDOMNING_UPPFYLLER_BEHORIGHETSKRAV_HEADER_SVAR_ID)
            .getIndex());
  }
  ...
  void shallIncludeQuestionBedomningLakareSpecialKompetens() {
    final var actualCertificate = internalToCertificate.convert(internalCertificate, textProvider);
    assertEquals(
        29, actualCertificate.getData().get(BEDOMNING_LAKARE_SPECIAL_KOMPETENS_SVAR_ID).getIndex());
  }
