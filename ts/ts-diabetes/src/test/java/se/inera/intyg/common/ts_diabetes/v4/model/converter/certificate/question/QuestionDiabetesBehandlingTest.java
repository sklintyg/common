...
class QuestionDiabetesBehandlingTest {
  ...
  class IncludeValueCodeListTest extends ValueCodeListTest<Allmant> {
    ...
    @Override
    protected List<InputExpectedValuePair<Allmant, CertificateDataValueCodeList>>
    ...
    class Insulin {
      ...
      class IncludeInternalValuePairTest extends InternalValueTest<Allmant, Boolean> {
        ...
        protected List<InputExpectedValuePair<Allmant, Boolean>> inputExpectedValuePairList() {
          return List.of(
              new InputExpectedValuePair<>(Allmant.builder().build(), false),
              new InputExpectedValuePair<>(
                  Allmant.builder()
                      .setBehandling(Behandling.builder().setInsulin(false).build())
                      .build(),
                  false),
              new InputExpectedValuePair<>(
                  Allmant.builder()
      ...
      class IncludeInternalValuePairTest extends InternalValueTest<Allmant, Boolean> {
        ...
        protected List<InputExpectedValuePair<Allmant, Boolean>> inputExpectedValuePairList() {
          return List.of(
              ...
              new InputExpectedValuePair<>(
                  Allmant.builder()
                      .setBehandling(Behandling.builder().setTabletter(false).build())
                      .build(),
                  false),
              new InputExpectedValuePair<>(
                  Allmant.builder()
      ...
      class IncludeInternalValuePairTest extends InternalValueTest<Allmant, Boolean> {
        ...
        protected List<InputExpectedValuePair<Allmant, Boolean>> inputExpectedValuePairList() {
          return List.of(
              ...
              new InputExpectedValuePair<>(
                  Allmant.builder()
                      .setBehandling(Behandling.builder().setAnnan(false).build())
                      .build(),
                  false),
              new InputExpectedValuePair<>(
                  Allmant.builder()
                      .setBehandling(Behandling.builder().setAnnan(true).build())
                      .build(),
                  true));
        }
      }
