...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.IDENTITET_CATEGORY_TEXT_ID;
...
class CategoryIdentitetStyrktGenomTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryIdentitetStyrktGenom.toCertificate(0, texts);
        }
