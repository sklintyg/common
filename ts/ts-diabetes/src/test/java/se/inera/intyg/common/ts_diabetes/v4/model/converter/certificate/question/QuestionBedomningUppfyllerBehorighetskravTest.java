...
class QuestionBedomningUppfyllerBehorighetskravTest {
  ...
  class IncludeCommonElementTest extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionBedomningUppfyllerBehorighetskrav.toCertificate(
          null, VERSION_4_0, getIndex(), textProvider);
    }
  ...
  @Nested
  class IncludeConfigCheckboxMultipleCodeTestVersionFourZero
      extends ConfigCheckboxMultipleCodeTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionBedomningUppfyllerBehorighetskrav.toCertificate(
          null, VERSION_4_0, 0, textProvider);
    }
  ...
  @Nested
  class IncludeConfigCheckboxMultipleCodeTestNotVersionFourZero
      extends ConfigCheckboxMultipleCodeTest {
  ...
  class IncludeValueCodeListTest extends ValueCodeListTest<Set<BedomningKorkortstyp>> {
    ...
    protected CertificateDataElement getElement(Set<BedomningKorkortstyp> input) {
      ...
      return QuestionBedomningUppfyllerBehorighetskrav.toCertificate(
          bedomning, VERSION_4_0, 0, textProvider);
    }

    @Override
    protected List<InputExpectedValuePair<Set<BedomningKorkortstyp>, CertificateDataValueCodeList>>
  ...
  class IncludeValidationMandatoryTest extends ValidationMandatoryTest {
    ...
    protected String getExpression() {
      return "exists("
          ...
          + ") || exists("
          + BedomningKorkortstyp.VAR16.name()
          + ") || exists("
          + BedomningKorkortstyp.VAR17.name()
          + ") || exists("
          + BedomningKorkortstyp.VAR18.name()
          + ") || exists("
  ...
  class ToInternal {
    ...
    @Nested
    @TestInstance(Lifecycle.PER_CLASS)
    class IncludeInternalValuePairTest
        extends InternalValueTest<Bedomning, Set<BedomningKorkortstyp>> {

      @Override
      protected CertificateDataElement getElement(Bedomning input) {
        return QuestionBedomningUppfyllerBehorighetskrav.toCertificate(
            input, VERSION_4_0, 0, textProvider);
      }
