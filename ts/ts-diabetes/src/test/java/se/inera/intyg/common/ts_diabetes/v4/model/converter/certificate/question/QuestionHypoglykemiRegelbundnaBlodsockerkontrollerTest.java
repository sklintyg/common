...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_TEXT_ID;
...
class QuestionHypoglykemiRegelbundnaBlodsockerkontrollerTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiRegelbundnaBlodsockerkontroller.toCertificate(null, getIndex(), textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_SVAR_ID;
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiRegelbundnaBlodsockerkontroller.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_DELSVAR_ID;
        }

        @Override
        protected String getTextId() {
            return HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return HYPOGLYKEMI_REGELBUNDNA_BLODSOCKERKONTROLLER_DESCRIPTION_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setRegelbundnaBlodsockerkontroller(true).build();
            return QuestionHypoglykemiRegelbundnaBlodsockerkontroller.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setRegelbundnaBlodsockerkontroller(expectedValue).build();
            return QuestionHypoglykemiRegelbundnaBlodsockerkontroller.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiRegelbundnaBlodsockerkontroller.toInternal(certificate);
        }
    }
}
