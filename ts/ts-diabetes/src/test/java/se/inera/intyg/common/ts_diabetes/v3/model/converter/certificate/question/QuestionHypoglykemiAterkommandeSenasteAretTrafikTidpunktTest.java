...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TIDPUNKT_TEXT_ID;
...
class QuestionHypoglykemiAterkommandeSenasteAretTrafikTidpunktTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeSenasteAretTrafikTidpunkt.toCertificate(null, 0, texts);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TIDPUNKT_DELSVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TRAFIK_TIDPUNKT_TEXT_ID;
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<Hypoglykemier> {
        ...
        protected CertificateDataElement getElement(Hypoglykemier expectedValue) {
            return QuestionHypoglykemiAterkommandeSenasteAretTrafikTidpunkt.toCertificate(expectedValue, 0, texts);
        ...
        protected List<InputExpectedValuePair<Hypoglykemier, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(
                    Hypoglykemier.builder().setForekomstTrafikTidpunkt(new InternalDate(LocalDate.now())).build(),
                    CertificateDataValueViewText.builder().text(String.valueOf(LocalDate.now())).build())
            );
        }
    }
}
