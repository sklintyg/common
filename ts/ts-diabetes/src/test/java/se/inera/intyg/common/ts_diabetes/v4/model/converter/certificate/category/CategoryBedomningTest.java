...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.BEDOMNING_CATEGORY_TEXT_ID;
...
class CategoryBedomningTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryBedomning.toCertificate(getIndex(), textProvider);
        }
