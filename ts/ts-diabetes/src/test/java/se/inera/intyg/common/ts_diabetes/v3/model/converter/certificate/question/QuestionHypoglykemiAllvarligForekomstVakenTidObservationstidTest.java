...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_OBSERVATIONSTID_SVAR_TEXT_ID;
...
class QuestionHypoglykemiAllvarligForekomstVakenTidObservationstidTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAllvarligForekomstVakenTidObservationstid.toCertificate(null, 0, texts);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_OBSERVATIONSTID_SVAR_ID;
        }

        @Override
        protected String getParent() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_OBSERVATIONSTID_SVAR_TEXT_ID;
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<InternalDate> {
        ...
        protected CertificateDataElement getElement(InternalDate expectedValue) {
            return QuestionHypoglykemiAllvarligForekomstVakenTidObservationstid.toCertificate(expectedValue, 0, texts);
        }
