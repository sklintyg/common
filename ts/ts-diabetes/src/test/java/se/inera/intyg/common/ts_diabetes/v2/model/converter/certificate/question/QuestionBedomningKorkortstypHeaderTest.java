...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.BEDOMNING_UPPFYLLER_BEHORIGHETSKRAV_HEADER_TEXT_ID;
...
class QuestionBedomningKorkortstypHeaderTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionBedomningKorkortstypHeader.toCertificate(0, texts);
        }
    ...
    class IncludeConfigHeaderTests extends ConfigHeaderTest {
        ...
        protected String getTextId() {
            return BEDOMNING_UPPFYLLER_BEHORIGHETSKRAV_HEADER_TEXT_ID;
        }
