...
import static se.inera.intyg.common.ts_diabetes.v3.model.converter.RespConstants.ALLMANT_BEHANDLING_ANNAN_TEXT_ID;
...
class QuestionDiabetesAnnanBehandlingBeskrivningTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionDiabetesAnnanBehandlingBeskrivning.toCertificate(null, 0, textProvider);
    }

    @Override
    protected String getId() {
      return ALLMANT_BEHANDLING_ANNAN_DELSVAR_ID;
    }
  ...
  class IncludeConfigViewTextTests extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return ALLMANT_BEHANDLING_ANNAN_TEXT_ID;
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Allmant> {
    ...
    protected CertificateDataElement getElement(Allmant expectedValue) {
      return QuestionDiabetesAnnanBehandlingBeskrivning.toCertificate(
    ...
    protected List<InputExpectedValuePair<Allmant, CertificateDataValueViewText>>
      ...
      return List.of(
          ...
          new InputExpectedValuePair<>(
              Allmant.builder()
                  .setBehandling(Behandling.builder().setAnnanBehandlingBeskrivning("test").build())
                  .build(),
