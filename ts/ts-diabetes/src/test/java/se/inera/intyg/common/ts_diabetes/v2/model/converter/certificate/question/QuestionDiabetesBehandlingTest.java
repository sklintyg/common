...
class QuestionDiabetesBehandlingTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionDiabetesBehandling.toCertificate(null, null, null, 0, textProvider);
        }
    ...
    class IncludeValueViewTextTests {
        ...
        void shallIncludeKost() {
            final var element = QuestionDiabetesBehandling.toCertificate(true, null, null, 0, textProvider);
        ...
        void shallIncludeTabletter() {
            final var element = QuestionDiabetesBehandling.toCertificate(null, true, null, 0, textProvider);
            final var value = (CertificateDataValueViewText) element.getValue();
        ...
        void shallIncludeInsulin() {
            final var element = QuestionDiabetesBehandling.toCertificate(null, null, true, 0, textProvider);
            final var value = (CertificateDataValueViewText) element.getValue();
        ...
        @Test
        void shallIncludeKostTabletterAndInsulin() {
            final var element = QuestionDiabetesBehandling.toCertificate(true, true, true, 0, textProvider);
            final var value = (CertificateDataValueViewText) element.getValue();
            final var expectedValue = "Endast kost, Tabletter, Insulin";
            assertEquals(expectedValue, value.getText());
        }
    }
}
