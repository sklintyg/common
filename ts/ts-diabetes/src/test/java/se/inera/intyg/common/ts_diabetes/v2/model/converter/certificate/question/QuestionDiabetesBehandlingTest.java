...
class QuestionDiabetesBehandlingTest {
  ...
  class IncludeValueViewTextTests {
    ...
    void shallIncludeKost() {
      final var element =
          QuestionDiabetesBehandling.toCertificate(true, null, null, 0, textProvider);
    ...
    void shallIncludeTabletter() {
      final var element =
          QuestionDiabetesBehandling.toCertificate(null, true, null, 0, textProvider);
      final var value = (CertificateDataValueViewText) element.getValue();
    ...
    void shallIncludeInsulin() {
      final var element =
          QuestionDiabetesBehandling.toCertificate(null, null, true, 0, textProvider);
      final var value = (CertificateDataValueViewText) element.getValue();
    ...
    void shallIncludeKostTabletterAndInsulin() {
      final var element =
          QuestionDiabetesBehandling.toCertificate(true, true, true, 0, textProvider);
      final var value = (CertificateDataValueViewText) element.getValue();
