...
public class TSDiabetesTransformerTest {
  ...
  private static final String COMMON_REGISTER_SCHEMA =
      "interactions/RegisterTSDiabetesInteraction/RegisterTSDiabetesResponder_1.0.xsd";

  private static final String CLINICAL_TS_DIABETES_SCHEMA =
      "specializations/TS-Diabetes/ts-diabetes_model.xsd";

  private static final String CLINICAL_CORE_SCHEMA =
      "core_components/clinicalprocess_healthcond_certificate_1.0.xsd";

  private static final String CLINICAL_TYPES_SCHEMA =
      "core_components/clinicalprocess_healthcond_certificate_types_1.0.xsd";

  private static final String CLINIAL_REGISTER_SCHEMA =
