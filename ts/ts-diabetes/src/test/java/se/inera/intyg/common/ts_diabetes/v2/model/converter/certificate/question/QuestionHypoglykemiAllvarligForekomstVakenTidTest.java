...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_TEXT_ID;
...
class QuestionHypoglykemiAllvarligForekomstVakenTidTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionHypoglykemiAllvarligForekomstVakenTid.toCertificate(null, 0, texts);
    }
  ...
  class IncludeConfigViewTextTests extends ConfigViewTextTest {
    ...
    protected String getTextId() {
      return HYPOGLYKEMI_ALLVARLIG_FOREKOMST_VAKEN_TID_SVAR_TEXT_ID;
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Boolean> {
    ...
    protected CertificateDataElement getElement(Boolean expectedValue) {
      return QuestionHypoglykemiAllvarligForekomstVakenTid.toCertificate(expectedValue, 0, texts);
    }
