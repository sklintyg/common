...
public class TSDiabetesCertificateMetaTypeConverterTest {
  ...
  public void testToCertificateMetaData() {
    ...
    CertificateMetaData res =
        TSDiabetesCertificateMetaTypeConverter.toCertificateMetaData(source, intyg);
  ...
  public void testToStatusList() {
    ...
    List<Status> res =
        TSDiabetesCertificateMetaTypeConverter.toStatusList(Arrays.asList(source1, source2));
