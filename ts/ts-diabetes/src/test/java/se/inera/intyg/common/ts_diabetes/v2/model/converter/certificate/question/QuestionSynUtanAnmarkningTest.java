...
import static se.inera.intyg.common.ts_diabetes.v2.model.converter.RespConstants.SYN_UTAN_ANMARKNING_SVAR_TEXT_ID;
...
class QuestionSynUtanAnmarkningTest {
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected CertificateDataElement getElement() {
      return QuestionSynUtanAnmarkning.toCertificate(null, 0, texts);
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<Boolean> {
    ...
    protected CertificateDataElement getElement(Boolean expectedValue) {
      return QuestionSynUtanAnmarkning.toCertificate(expectedValue, 0, texts);
    }
