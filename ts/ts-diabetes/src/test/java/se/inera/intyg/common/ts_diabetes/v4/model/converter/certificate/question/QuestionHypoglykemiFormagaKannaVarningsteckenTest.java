...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_TEXT_ID;
...
class QuestionHypoglykemiFormagaKannaVarningsteckenTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiFormagaKannaVarningstecken.toCertificate(null, getIndex(), textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_SVAR_ID;
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiFormagaKannaVarningstecken.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_DELSVAR_ID;
        }

        @Override
        protected String getTextId() {
            return HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return HYPOGLYKEMI_FORMAGA_KANNA_VARNINGSTECKEN_DESCRIPTION_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setFormagaKannaVarningstecken(true).build();
            return QuestionHypoglykemiFormagaKannaVarningstecken.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setFormagaKannaVarningstecken(expectedValue).build();
            return QuestionHypoglykemiFormagaKannaVarningstecken.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiFormagaKannaVarningstecken.toInternal(certificate);
        }
    }
}
