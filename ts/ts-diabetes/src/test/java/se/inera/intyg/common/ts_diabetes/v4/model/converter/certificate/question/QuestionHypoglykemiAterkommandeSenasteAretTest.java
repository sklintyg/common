...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_TEXT_ID;
...
class QuestionHypoglykemiAterkommandeSenasteAretTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeSenasteAret.toCertificate(null, getIndex(), textProvider);
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiAterkommandeSenasteAret.toCertificate(null, 0, textProvider);
        }
        ...
        protected String getDescriptionId() {
            return HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_DESCRIPTION_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeSenasteAret(true).build();
            return QuestionHypoglykemiAterkommandeSenasteAret.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeValidationMandatoryTest extends ValidationMandatoryTest {
        ...
        @Override
        protected String getExpression() {
            return "exists(" + HYPOGLYKEMI_ATERKOMMANDE_SENASTE_ARET_JSON_ID + ")";
        }
    }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeSenasteAret(expectedValue).build();
            return QuestionHypoglykemiAterkommandeSenasteAret.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiAterkommandeSenasteAret.toInternal(certificate);
        }
    }
}
