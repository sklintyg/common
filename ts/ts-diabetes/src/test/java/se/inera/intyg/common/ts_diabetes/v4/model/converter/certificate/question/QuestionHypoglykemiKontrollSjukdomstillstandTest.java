...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DESCRIPTION_ID;
...
import static se.inera.intyg.common.ts_diabetes.v4.model.converter.RespConstants.HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_TEXT_ID;
...
class QuestionHypoglykemiKontrollSjukdomstillstandTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiKontrollSjukdomstillstand.toCertificate(null, getIndex(), textProvider);
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiKontrollSjukdomstillstand.toCertificate(null, 0, textProvider);
        }

        @Override
        protected String getId() {
            return HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DELSVAR_ID;
        }

        @Override
        protected String getTextId() {
            return HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_TEXT_ID;
        }

        @Override
        protected String getDescriptionId() {
            return HYPOGLYKEMI_KONTROLL_SJUKDOMSTILLSTAND_DESCRIPTION_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiKontrollSjukdomstillstand.toCertificate(Hypoglykemi.builder()
                .setKontrollSjukdomstillstand(true).build(), 0, textProvider);
        }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setKontrollSjukdomstillstand(expectedValue).build();
            return QuestionHypoglykemiKontrollSjukdomstillstand.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiKontrollSjukdomstillstand.toInternal(certificate);
        }
    }
}
