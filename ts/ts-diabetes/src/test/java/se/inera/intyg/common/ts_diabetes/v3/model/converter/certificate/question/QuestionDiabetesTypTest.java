    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<Allmant> {
        ...
        protected List<InputExpectedValuePair<Allmant, CertificateDataValueViewText>> inputExpectedValuePairList() {
            return List.of(
                ...
                new InputExpectedValuePair<>(Allmant.builder().setTypAvDiabetes(KvTypAvDiabetes.TYP1).build(),
                    CertificateDataValueViewText.builder().text("Typ 1").build()),
                new InputExpectedValuePair<>(Allmant.builder().setTypAvDiabetes(KvTypAvDiabetes.TYP2).build(),
                    CertificateDataValueViewText.builder().text("Typ 2").build()),
                new InputExpectedValuePair<>(Allmant.builder().setTypAvDiabetes(KvTypAvDiabetes.ANNAN).build(),
