...
class QuestionHypoglykemiAterkommandeVaketSenasteTolvTest {
    ...
    class IncludeCommonElementTest extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionHypoglykemiAterkommandeVaketSenasteTolv.toCertificate(null, getIndex(), textProvider);
        }
    ...
    class IncludeConfigRadioBooleanTest extends ConfigRadioBooleanTest {
        ...
        protected CertificateDataElement getElement() {
            ...
            return QuestionHypoglykemiAterkommandeVaketSenasteTolv.toCertificate(null, 0, textProvider);
        }
        ...
        protected String getTextId() {
            return HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TOLV_TEXT_ID;
        }
    ...
    class IncludeValueBooleanTest extends ValueBooleanTest {
        ...
        @Override
        protected CertificateDataElement getElement() {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeVaketSenasteTolv(true).build();
            return QuestionHypoglykemiAterkommandeVaketSenasteTolv.toCertificate(hypoglykemi, 0, textProvider);
        }
    ...
    class IncludeValidationMandatoryTest extends ValidationMandatoryTest {
        ...
        @Override
        protected String getExpression() {
            return "exists(" + HYPOGLYKEMI_ATERKOMMANDE_VAKET_SENASTE_TOLV_JSON_ID + ")";
        }
    }
    ...
    class IncludeInternalBooleanValueTest extends InternalBooleanValueTest {
        ...
        protected CertificateDataElement getElement(Boolean expectedValue) {
            final var hypoglykemi = Hypoglykemi.builder().setAterkommandeVaketSenasteTolv(expectedValue).build();
            return QuestionHypoglykemiAterkommandeVaketSenasteTolv.toCertificate(hypoglykemi, 0, textProvider);
        }

        @Override
        protected Boolean toInternalBooleanValue(Certificate certificate) {
            return QuestionHypoglykemiAterkommandeVaketSenasteTolv.toInternal(certificate);
        }
    }
}
