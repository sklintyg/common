...
public class Tstrk1009MetaDataConverterTest {
    ...
    public void testToCertificateMetaData() {
        ...
        CertificateMetaData res = Tstrk1009MetaDataConverter.toCertificateMetaData(source, intyg);
    ...
    public void testToStatusList() {
        ...
        List<Status> res = Tstrk1009MetaDataConverter.toStatusList(Arrays.asList(source1, source2));
    ...
    public void testToStatus() {
        ...
        Status res = Tstrk1009MetaDataConverter.toStatus(source);
