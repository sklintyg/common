...
public class UtlatandeToIntygTest {
  ...
  public void testAddIntygAvserSvar() {
    ...
    utlatande =
        utlatande.toBuilder()
            .setIntygetAvserBehorigheter(IntygetAvser.create(intygAvserKategorier))
            .build();

    Intyg intyg = UtlatandeToIntyg.convert(utlatande);

    assertEquals(
        KorkortBehorighetGrupp.A_B_TRAKTOR.getKorkortsbehorigheter().size(),
        intyg.getSvar().size());
    ...
    final Set<String> codes =
        KorkortBehorighetGrupp.A_B_TRAKTOR.getKorkortsbehorigheter().stream()
