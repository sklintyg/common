                        ...
                        fraga(8, 'FRG_8.RBK', 'FRG_8.HLP', {
                            ...
                            },
                            {
                                ...
                                components: [
                                    ...
                                    [{}, {
                                        type: 'ue-form-label',
                                        key: 'tstrk1009.label.syn.utankorrektion',
                                        helpKey: 'tstrk1009.helptext.synfunktioner.utan-korrektion',
                                        required: true,
                                        requiredProp: function(model) {
                                            return R12(model);
                                        }
                                        ...
                                        type: 'ue-form-label',
                                        key: 'tstrk1009.label.syn.medkorrektion',
                                        helpKey: 'tstrk1009.helptext.synfunktioner.med-korrektion',
                                        required: true,
                                        requiredProp: function(model) {
                                    ...
                                    [{
                                        type: 'ue-text',
                                        label: {
                                            key: 'tstrk1009.label.syn.hogeroga'
                                        }
                                    }, {
                                        type: 'ue-synskarpa',
                                    ...
                                    [{
                                        type: 'ue-text',
                                        label: {
                                            key: 'tstrk1009.label.syn.vansteroga'
                                        }
                                    }, {
                                        type: 'ue-synskarpa',
                                    ...
                                    [{
                                        type: 'ue-text',
                                        label: {
                                            key: 'tstrk1009.label.syn.binokulart'
                                        }
                                    }, {
                                        type: 'ue-synskarpa',
