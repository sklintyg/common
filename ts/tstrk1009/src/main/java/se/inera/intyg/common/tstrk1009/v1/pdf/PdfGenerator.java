...
public class PdfGenerator {
  ...
  public PdfResponse generatePdf(
    ...
    String filename;
    try {
      // Needed due to parsing incompatibilities (due to single/double quotes?) between internal
      // model and nashorn.
      ...
      PrintConfig printConfig =
          PrintConfig.PrintConfigBuilder.aPrintConfig()
              ...
              .withLeftMarginTypText(
                  KvIntygstyp.TSTRK1009.getCodeValue() + " - Fastställd av Transportstyrelsen")
