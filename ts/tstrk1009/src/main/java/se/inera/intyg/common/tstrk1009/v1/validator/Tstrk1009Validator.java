...
@Component("tstrk1009.v1.TsBasValidator")
public class Tstrk1009Validator implements InternalDraftValidator<Tstrk1009UtlatandeV1> {

    /**
     * Validates an internal Utlatande.
     *
     * @param utlatande Tstrk1009UtlatandeV1
