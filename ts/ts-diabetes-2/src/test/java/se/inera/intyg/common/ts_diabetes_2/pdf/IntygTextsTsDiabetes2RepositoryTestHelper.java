...
public class IntygTextsTsDiabetes2RepositoryTestHelper extends IntygTextsRepositoryImpl {

    public IntygTextsTsDiabetes2RepositoryTestHelper() {
    ...
    public void update()  {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ClassPathResource("text/texterTS_DIABETES_2_v1.0.xml").getInputStream());
