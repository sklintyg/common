...
public class TsDiabetes2ModuleApiTest {
    ...
    public void testValidateShouldUseValidator() throws Exception {
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue("internal model", TsDiabetes2Utlatande.class);
    ...
    public void testRegisterCertificate() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(internalModel, TsDiabetes2Utlatande.class);
    ...
    public void testGetUtlatandeFromJson() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(utlatandeJson, TsDiabetes2Utlatande.class);
    ...
    public void testCreateRevokeRequest() throws Exception {
        ...
        Utlatande utlatande = TsDiabetes2Utlatande.builder().setId(intygId).setGrundData(gd).setTextVersion("").build();
