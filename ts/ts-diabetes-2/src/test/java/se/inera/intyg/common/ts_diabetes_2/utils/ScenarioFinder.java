 ...
 */
package se.inera.intyg.common.ts_diabetes_2.utils;
...
public final class ScenarioFinder {
    ...
    private static final class FileBasedScenario implements Scenario {
         ...
         */
        @Override
        public TsDiabetes2Utlatande asInternalModel()
                throws ScenarioNotFoundException {
            try {
                return new CustomObjectMapper().readValue(getInternalModelFor(getName()), TsDiabetes2Utlatande.class);
            } catch (IOException e) {
