 ...
 */
angular.module('ts-diabetes-2').service('ts-diabetes-2.EditCertCtrl.ViewStateService',
    ['$log', '$state', 'common.UtkastViewStateService', 'ts-diabetes-2.Domain.IntygModel',
        function($log, $state, CommonViewState, IntygModel) {
            ...
            this.reset = function() {
                ...
                CommonViewState.intyg.type = 'ts-diabetes-2';
