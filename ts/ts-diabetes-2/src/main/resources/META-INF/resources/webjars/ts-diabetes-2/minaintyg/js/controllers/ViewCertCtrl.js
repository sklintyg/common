 ...
 */
angular.module('ts-diabetes-2').controller(
        'ts-diabetes-2.ViewCertCtrl',
        [ '$location', '$log', '$stateParams', '$scope', 'common.IntygService', 'ts-diabetes-2.viewConfigFactory',
                function($location, $log, $stateParams, $scope, certificateService, viewConfigFactory) {
                    ...
                    $scope.send = function() {
                        $location.path('/send/ts-diabetes-2/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId + '/TRANSP');
                    };
