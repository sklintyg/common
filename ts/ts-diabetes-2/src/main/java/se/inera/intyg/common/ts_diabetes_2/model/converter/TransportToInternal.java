...
public final class TransportToInternal {
    ...
    private static void handleFunktionsnedsattning(TsDiabetes2Utlatande.Builder utlatande, Svar svar) {
    ...
    private static void handleAktivitetsbegransning(TsDiabetes2Utlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleUtredningBehandling(TsDiabetes2Utlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
    ...
    private static void handleArbetetsPaverkan(TsDiabetes2Utlatande.Builder utlatande, Svar svar) {
        for (Delsvar delsvar : svar.getDelsvar()) {
            switch (delsvar.getId()) {
