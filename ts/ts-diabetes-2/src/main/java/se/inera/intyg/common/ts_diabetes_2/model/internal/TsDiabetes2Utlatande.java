...
@AutoValue
@JsonDeserialize(builder = AutoValue_TsDiabetes2Utlatande.Builder.class)
public abstract class TsDiabetes2Utlatande implements Utlatande {

    @Override
    public String getTyp() {
        return TsDiabetes2EntryPoint.MODULE_ID;
    }
    ...
    public static Builder builder() {
        return new AutoValue_TsDiabetes2Utlatande.Builder()
                .setSignature(null);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract TsDiabetes2Utlatande build();
