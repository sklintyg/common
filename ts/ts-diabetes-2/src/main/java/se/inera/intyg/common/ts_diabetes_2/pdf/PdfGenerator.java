    ...
    public PdfResponse generatePdf(String intygsId, String jsonModel, Personnummer personId, IntygTexts intygTexts, List<Status> statuses,
        ...
        try {
            ...
            PrintConfig printConfig = PrintConfig.PrintConfigBuilder.aPrintConfig()
                    ...
                    .withIntygsNamn(TsDiabetes2EntryPoint.MODULE_NAME)
                    .withIntygsKod(TsDiabetes2EntryPoint.ISSUER_TYPE_ID)
            ...
            LOG.error("Error generating PDF for ts-diabetes-2: " + e.getMessage());
            throw new ModuleException("Error generating PDF for ts-diabetes-2: " + e.getMessage());
        }
    }
