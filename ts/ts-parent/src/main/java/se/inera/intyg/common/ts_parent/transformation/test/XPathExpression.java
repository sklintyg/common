 ...
 */
package se.inera.intyg.common.ts_parent.transformation.test;
...
/**
 * Utility that wraps an xPath expression (string) and return type. The xPath can then be valuated
 * given a xPath engine and a DOM document.
 *
 * @param <T> The return type of the evaluated xPath.
 * @see XPathEvaluator
 */
public interface XPathExpression<T> {
   ...
   *
   * @param xPath The xPath engine to use.
