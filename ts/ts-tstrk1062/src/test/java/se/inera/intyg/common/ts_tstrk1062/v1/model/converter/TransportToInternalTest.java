...
import se.inera.intyg.common.ts_tstrk1062.v1.model.internal.PrognosTillstand;
...
public class TransportToInternalTest {
    ...
    public void convertIntygsTyp() throws Exception {
        ...
        final TsTstrk1062UtlatandeV1 utlatande = TransportToInternal.convert(intyg);

        assertNotNull("Utlatande should not be null", utlatande);
        assertEquals("", TsTstrk1062EntryPoint.MODULE_ID, utlatande.getTyp());
    }
