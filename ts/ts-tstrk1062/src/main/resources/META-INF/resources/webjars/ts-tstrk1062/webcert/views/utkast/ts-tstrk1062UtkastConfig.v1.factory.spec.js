...
describe('ts-tstrk1062UtkastConfigFactory', function() {
    'use strict';
    ...
    beforeEach(angular.mock.module('common', 'ts-tstrk1062'));
    beforeEach(inject(['$compile', '$rootScope', 'ts-tstrk1062.UtkastConfigFactory.v1', 'ts-tstrk1062.Domain.IntygModel.v1',
