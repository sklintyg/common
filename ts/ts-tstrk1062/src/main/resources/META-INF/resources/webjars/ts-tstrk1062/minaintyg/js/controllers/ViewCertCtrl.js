 ...
 */
angular.module('ts-tstrk1062').controller('ts-tstrk1062.ViewCertCtrl',
    [ '$location', '$log', '$rootScope', '$stateParams', '$scope', 'common.IntygListService',
        ...
        function($location, $log, $rootScope, $stateParams, $scope, IntygListService, IntygService,
            ...
            $scope.send = function() {
                $location.path('/send/ts-tstrk1062/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId + '/TRANSP');
            };

            $scope.errorMessage = null;
            $scope.doneLoading = false;
            IntygService.getCertificate('ts-tstrk1062', $stateParams.intygTypeVersion, $stateParams.certificateId, function(result) {
