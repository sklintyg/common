...
angular.module('ts-tstrk1062').constant('ts-tstrk1062.messages', {
    'sv': {
        ...
        'ts-tstrk1062.compact-header.complementaryinfo-prefix': 'Avser behörighet:',
        'ts-tstrk1062.inbox.complementaryinfo': 'Avser behörighet',
        ...
        'ts-tstrk1062.label.true': 'JA',
        'ts-tstrk1062.label.false': 'NEJ',

        'ts-tstrk1062.error.generic': 'Kunde inte visa intyget',
        'ts-tstrk1062.error.certnotfound': 'Intygen i Inkorgen kunde inte visas. Om felet kvarstår kan du kontakta <a href="/web/start/#/hjalp">support</a>. Om du inte kan komma åt intyget på Mina intyg just nu så kan du kontakta din läkare för att få en kopia.<br><br><a href="/web/start">Gå till Inkorgen och försök igen</a>'
