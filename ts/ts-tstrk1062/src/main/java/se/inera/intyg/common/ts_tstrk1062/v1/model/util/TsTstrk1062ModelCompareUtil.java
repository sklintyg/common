...
@Component("ts-tstrk1062.v1.TsTstrk1062ModelCompareUtil")
public class TsTstrk1062ModelCompareUtil implements ModelCompareUtil<TsTstrk1062UtlatandeV1> {

    @Override
    public boolean isValidForNotification(TsTstrk1062UtlatandeV1 utlatande) {
