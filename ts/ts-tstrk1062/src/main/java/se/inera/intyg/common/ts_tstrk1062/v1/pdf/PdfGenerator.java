    ...
    public PdfResponse generatePdf(String intygsId, String jsonModel, Personnummer personId, IntygTexts intygTexts, List<Status> statuses,
        ...
        try {
            ...
            PrintConfig printConfig = PrintConfig.PrintConfigBuilder.aPrintConfig()
                    ...
                    .withIntygsNamn(TsTstrk1062EntryPoint.MODULE_NAME)
                    .withIntygsKod(TsTstrk1062EntryPoint.KV_UTLATANDETYP_INTYG_CODE)
            ...
            LOG.error("Error generating PDF for ts-tstrk1062: " + e.getMessage());
            throw new ModuleException("Error generating PDF for ts-tstrk1062: " + e.getMessage());
        }
    }
