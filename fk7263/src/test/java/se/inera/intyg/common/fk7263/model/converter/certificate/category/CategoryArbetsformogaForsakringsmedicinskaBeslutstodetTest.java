...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_CATEGORY_TEXT_ID;
...
class CategoryArbetsformogaForsakringsmedicinskaBeslutstodetTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryArbetsformogaForsakringsmedicinskaBeslutstodet.toCertificate(0, messagesProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_CATEGORY_TEXT_ID;
        }
