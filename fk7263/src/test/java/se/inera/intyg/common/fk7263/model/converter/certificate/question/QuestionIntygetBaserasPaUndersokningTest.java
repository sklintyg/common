...
class QuestionIntygetBaserasPaUndersokningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected String getId() {
            return UNDERSOKNING_AV_PATIENTEN_DELSVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return UNDERSOKNING_AV_PATIENTEN_DELSVAR_TEXT;
        }
    }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<InternalDate> {
        ...
        protected CertificateDataElement getElement(InternalDate expectedValue) {
            return QuestionIntygetBaserasPaUndersokning.toCertificate(expectedValue, 0);
        }
