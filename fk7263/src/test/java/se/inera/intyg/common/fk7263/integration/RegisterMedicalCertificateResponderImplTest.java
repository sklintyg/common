...
class RegisterMedicalCertificateResponderImplTest {
  ...
  @Mock private ModuleEntryPoint moduleEntryPoint = mock(ModuleEntryPoint.class);

  @Mock private Fk7263ModuleApi moduleRestApi = mock(Fk7263ModuleApi.class);

  @Mock private ModuleContainerApi moduleContainer = mock(ModuleContainerApi.class);
  ...
  @InjectMocks private RegisterMedicalCertificateResponderImpl responder;

  @BeforeEach
  void prepareRequest() throws Exception {

    ClassPathResource file =
        new ClassPathResource("RegisterMedicalCertificateResponderImplTest/fk7263.xml");

    JAXBContext context = JAXBContext.newInstance(RegisterMedicalCertificateType.class);
    JAXBElement<RegisterMedicalCertificateType> registerMedicalCertificate =
        context
            .createUnmarshaller()
            .unmarshal(
  ...
  void testReceiveCertificate() throws Exception {
    ...
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);

    assertEquals(ResultCodeEnum.OK, response.getResult().getResultCode());

    Mockito.verify(moduleContainer, Mockito.only())
  ...
  void testRegisterMedicalCertificateUtanPrognosangivelseFalt10() throws Exception {
    request.getLakarutlatande().getFunktionstillstand().stream()
        .filter(ft -> ft.getArbetsformaga() != null)
  ...
  void testRegisterMedicalCertificateSaknadNedsattningsgrad() {
    request.getLakarutlatande().getFunktionstillstand().stream()
        .filter(
            ft ->
                ft.getArbetsformaga() != null
                    && !ft.getArbetsformaga().getArbetsformagaNedsattning().isEmpty())
        .forEach(
            ft ->
                ft.getArbetsformaga().getArbetsformagaNedsattning().stream()
                    .forEach(n -> n.setNedsattningsgrad(null)));
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
    ...
    assertEquals(
        "Validation Error(s) found: Validation Error:No arbetsformaganedsattning element found 8b!.",
  ...
  void testRegisterMedicalCertificateSaknatSigneringsdatum() {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Field 14: No signeringsDatum found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatSkickatDatum() {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Header: No or wrong skickatDatum found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatPersonId() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No Patient Id found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatReferensdatum() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Field 4: Referens is missing datum\n"
            + "Validation Error:Field 4: Referens is missing datum\n"
            + "Validation Error:No or wrong date for referens - journal found!\n"
            + "Validation Error:No or wrong date for referens - annat found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatReferensdatumSmL() throws Exception {
    ...
    request
        ...
        .getAktivitet()
        .get(0)
        .setAktivitetskod(Aktivitetskod.AVSTANGNING_ENLIGT_SM_L_PGA_SMITTA);
    request.getLakarutlatande().getReferens().stream().forEach(r -> r.setDatum(null));
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
  ...
  void testRegisterMedicalCertificateSaknatIntygId() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Head: Utlatande Id is mandatory!",
        response.getResult().getErrorText());
  ...
  //        assertEquals(ResultCodeEnum.ERROR, response.getResult().getResultCode());
  //        assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
  //        assertEquals("Validation Error(s) found: Validation Error:No Patient element found!",
  // response.getResult().getErrorText());
  //
  ...
  void testRegisterMedicalCertificatePersonnrUtanBindestreckKorrigeras() throws Exception {
    ...
    ArgumentCaptor<CertificateHolder> certificateCaptor =
        ArgumentCaptor.forClass(CertificateHolder.class);
    Mockito.verify(moduleContainer, Mockito.only())
        .certificateReceived(certificateCaptor.capture());
    assertEquals(
        "191212121212",
        certificateCaptor.getValue().getCivicRegistrationNumber().getPersonnummer());
  }
  ...
  void testRegisterMedicalCertificateSaknadHoSPersonal() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No SkapadAvHosPersonal element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadPersonalId() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No personal-id found!\n"
            + "Validation Error:Wrong o.i.d. for personalId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateFelaktigPersonalIdKod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Wrong o.i.d. for personalId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatPersonalnamn() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No skapadAvHosPersonal fullstandigtNamn found.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadEnhet() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No enhet element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatEnhetId() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No enhets-id found!\n"
            + "Validation Error:Wrong o.i.d. for enhetsId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateFelaktigEnhetIdKod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Wrong o.i.d. for enhetsId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatEnhetnamn() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No enhetsnamn found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadEnhetpostaddress() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No postadress found for enhet!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatEnhetpostnummer() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No postnummer found for enhet!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatEnhetpostort() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No postort found for enhet!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatEnhettelefonnummer() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No telefonnummer found for enhet!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadVardgivare() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No vardgivare element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadVardgivareId() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No vardgivare-id found!\n"
            + "Validation Error:Wrong o.i.d. for vardgivareId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateFelaktigVardgivareIdKod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Wrong o.i.d. for vardgivareId! Should be 1.2.752.129.2.1.4.1",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknatVardgivarenamn() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No vardgivarenamn found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadArbetsplatskod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No arbetsplatskod element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateFelaktigArbetsplatskodKod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Wrong o.i.d for arbetsplatskod, should be 1.2.752.29.4.71",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateTomArbetsplatskod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No arbetsplatskod found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadFunktionstillstandAktivitet() throws Exception {
    Optional<FunktionstillstandType> kroppsfunktion =
        request.getLakarutlatande().getFunktionstillstand().stream()
            .filter(ft -> ft.getTypAvFunktionstillstand() == TypAvFunktionstillstand.KROPPSFUNKTION)
            .findFirst();
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No funktionstillstand - aktivitet element found!\n"
            + "Validation Error:No arbetsformaga element found for field 8a!\n"
            + "Validation Error:No arbetsformaga element found 8b!.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadMedicinsktTillstand() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No medicinsktTillstand element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadDiagnoskod() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No tillstandskod in medicinsktTillstand found!\n"
  ...
  void testRegisterMedicalCertificateSaknadBedomtTillstandBeskrivning() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Beskrivning must be set for Falt3 Aktuellt Sjukdomsforlopp",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadFunktionstillstandKroppsfunktion() throws Exception {
    Optional<FunktionstillstandType> aktivitet =
        request.getLakarutlatande().getFunktionstillstand().stream()
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No funktionstillstand - kroppsfunktion element found!",
        response.getResult().getErrorText());
  ...
  @Test
  void testRegisterMedicalCertificateTomFunktionstillstandKroppsfunktionBeskrivning()
      throws Exception {
    request.getLakarutlatande().getFunktionstillstand().stream()
        .filter(ft -> ft.getTypAvFunktionstillstand() == TypAvFunktionstillstand.KROPPSFUNKTION)
        .forEach(ft -> ft.setBeskrivning(""));
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No beskrivning in funktionstillstand - kroppsfunktion found!",
        response.getResult().getErrorText());
  ...
  @Test
  void testRegisterMedicalCertificateTomFunktionstillstandKroppsfunktionBeskrivningSmL()
      throws Exception {
    request.getLakarutlatande().getAktivitet().clear();
    request.getLakarutlatande().getAktivitet().add(new AktivitetType());
    request
  ...
  @Test
  void testRegisterMedicalCertificateSaknadFunktionstillstandKroppsfunktionBeskrivning()
      throws Exception {
    request.getLakarutlatande().getFunktionstillstand().stream()
        .filter(ft -> ft.getTypAvFunktionstillstand() == TypAvFunktionstillstand.KROPPSFUNKTION)
        .forEach(ft -> ft.setBeskrivning(null));
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
  ...
  @Test
  void testRegisterMedicalCertificateSaknadFunktionstillstandKroppsfunktionBeskrivningSmL()
      throws Exception {
    request.getLakarutlatande().getAktivitet().clear();
    request.getLakarutlatande().getAktivitet().add(new AktivitetType());
    request
  ...
  void testRegisterMedicalCertificateSaknadeVardkontakterReferenser() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No vardkontakt or referens element found ! At least one must be set!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadeVardkontaktTid() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No or wrong date for vardkontakt - min undersokning av patienten found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadBeskrivningVidRekommendationOvrigt() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Beskrivning must be set for Aktivitet Rekommendation Ovrigt",
        response.getResult().getErrorText());
  ...
  @Test
  void testRegisterMedicalCertificateSaknadBeskrivningVidRekommendationOvrigtSmL()
      throws Exception {
    request.getLakarutlatande().getAktivitet().clear();
    request.getLakarutlatande().getAktivitet().add(new AktivitetType());
    request.getLakarutlatande().getAktivitet().get(0).setAktivitetskod(Aktivitetskod.OVRIGT);
  ...
  void testRegisterMedicalCertificateSaknadBeskrivningVidBehandlingAnnan() throws Exception {
    ...
    request
        ...
        .getAktivitet()
        .get(0)
        .setAktivitetskod(Aktivitetskod.PLANERAD_ELLER_PAGAENDE_ANNAN_ATGARD);
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
  ...
  void testRegisterMedicalCertificateSaknadKommentarReferensAnnat() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Upplysningar should contain data as field 4 or fields 10 is checked.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadKommentarPrognosGarEjAttBedomma() throws Exception {
    request.getLakarutlatande().getFunktionstillstand().stream()
        ...
        .forEach(
            ft ->
                ft.getArbetsformaga()
                    .setPrognosangivelse(Prognosangivelse.DET_GAR_INTE_ATT_BEDOMMA));
    request.getLakarutlatande().setKommentar(null);
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
  ...
  void testRegisterMedicalCertificateSaknadArbetsformaga() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No arbetsformaga element found for field 8a!\n"
            + "Validation Error:No arbetsformaga element found 8b!.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadArbetsuppgift() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No arbetsuppgift element found when arbete set in field 8a!.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadArbetsuppgiftBeskrivning() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No typAvArbetsuppgift element found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateTomArbetsuppgiftBeskrivning() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No typAvArbetsuppgift found when arbete set in field 8a!.",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadVaraktighetFrom() throws Exception {
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No or wrong date for helt nedsatt from date found!",
        response.getResult().getErrorText());
  ...
  void testRegisterMedicalCertificateSaknadVaraktighetTom() throws Exception {
    request.getLakarutlatande().getFunktionstillstand().stream()
        ...
        .forEach(
            ft ->
                ft.getArbetsformaga().getArbetsformagaNedsattning().get(0).setVaraktighetTom(null));
    RegisterMedicalCertificateResponseType response =
        responder.registerMedicalCertificate(null, request);
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:No or wrong date for helt nedsatt tom date found!",
        response.getResult().getErrorText());
    ...
    request.getLakarutlatande().getFunktionstillstand().stream()
        ...
        .forEach(
            ft -> {
              ...
              ft.getArbetsformaga()
                  .getArbetsformagaNedsattning()
                  .add(new ArbetsformagaNedsattningType());
              ft.getArbetsformaga()
                  .getArbetsformagaNedsattning()
                  .add(new ArbetsformagaNedsattningType());
              ft.getArbetsformaga()
                  .getArbetsformagaNedsattning()
                  .get(0)
                  .setNedsattningsgrad(Nedsattningsgrad.HELT_NEDSATT);
              ...
              ft.getArbetsformaga()
                  .getArbetsformagaNedsattning()
                  .get(1)
                  .setNedsattningsgrad(Nedsattningsgrad.NEDSATT_MED_1_2);
  ...
  void testRegisterMedicalCertificateMultiplaRessatt() throws Exception {
    ...
    request
        ...
        .getAktivitet()
        .get(0)
        .setAktivitetskod(Aktivitetskod.FORANDRAT_RESSATT_TILL_ARBETSPLATSEN_AR_AKTUELLT);
    request.getLakarutlatande().getAktivitet().add(new AktivitetType());
    request
        .getLakarutlatande()
        .getAktivitet()
    ...
    assertEquals(ErrorIdEnum.VALIDATION_ERROR, response.getResult().getErrorId());
    assertEquals(
        "Validation Error(s) found: Validation Error:Only one forandrat ressatt could be set for field 11.",
        response.getResult().getErrorText());
  ...
  void testWithExistingCertificate() throws Exception {
    Mockito.doThrow(
            new CertificateAlreadyExistsException(
