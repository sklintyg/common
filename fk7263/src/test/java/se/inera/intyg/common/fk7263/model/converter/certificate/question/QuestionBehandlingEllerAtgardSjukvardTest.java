...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.INOM_SJUKVARD_DELSVAR_TEXT_ID;
...
class QuestionBehandlingEllerAtgardSjukvardTest {
    ...
    @BeforeEach
    void setUp() {
        when(messagesProvider.get(any(String.class))).thenReturn(INOM_SJUKVARD_DELSVAR_TEXT_ID);
    }
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionBehandlingEllerAtgardSjukvard.toCertificate(null, 0, messagesProvider);
        }

        @Override
        protected String getId() {
            return INOM_SJUKVARD_DELSVAR_ID;
        }
    ...
    class IncludeConfigViewTextTests extends ConfigViewTextTest {
        ...
        protected String getTextId() {
            return INOM_SJUKVARD_DELSVAR_TEXT_ID;
        }
    }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<String> {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionBehandlingEllerAtgardSjukvard.toCertificate(expectedValue, 0, messagesProvider);
        }
