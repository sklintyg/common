...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.OVRIGA_UPPLYSNINGAR_CATEGORY_TEXT_ID;
...
class CategoryOvrigaUpplysningarTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryOvrigaUpplysningar.toCertificate(0, messagesProvider);
        }

        @Override
        protected String getId() {
            return OVRIGA_UPPLYSNINGAR_CATEGORY_ID;
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return OVRIGA_UPPLYSNINGAR_CATEGORY_TEXT_ID;
        }
