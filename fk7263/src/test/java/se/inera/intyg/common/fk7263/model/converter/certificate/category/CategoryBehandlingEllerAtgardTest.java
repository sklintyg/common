...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.BEHANDLING_ELLER_ATGARD_CATEGORY_TEXT_ID;
...
class CategoryBehandlingEllerAtgardTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryBehandlingEllerAtgard.toCertificate(0, messagesProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return BEHANDLING_ELLER_ATGARD_CATEGORY_TEXT_ID;
        }
