...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.REKOMMENDATIONER_CATEGORY_TEXT_ID;
...
class CategoryRekommendationerTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryRekommendationer.toCertificate(0, messagesProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return REKOMMENDATIONER_CATEGORY_TEXT_ID;
        }
