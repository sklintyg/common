...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.KONTAKT_MED_FK_CATEGORY_TEXT_ID;
...
class CategoryKontaktMedFkTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryKontaktMedFk.toCertificate(0, messagesProvider);
        }

        @Override
        protected String getId() {
            return KONTAKT_MED_FK_CATEGORY_ID;
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return KONTAKT_MED_FK_CATEGORY_TEXT_ID;
        }
