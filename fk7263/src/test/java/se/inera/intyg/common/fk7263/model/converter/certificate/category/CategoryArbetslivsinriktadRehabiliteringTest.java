...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.ARBETSLIVSINRIKTAD_REHABILITERING_CATEGORY_TEXT_ID;
...
class CategoryArbetslivsinriktadRehabiliteringTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryArbetslivsinriktadRehabilitering.toCertificate(0, messagesProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return ARBETSLIVSINRIKTAD_REHABILITERING_CATEGORY_TEXT_ID;
        }
