...
public class InternalDraftValidatorTest {
  ...
  @InjectMocks private InternalDraftValidator validator = new InternalDraftValidator();
  ...
  /**
   * ArgumentMatcher that validates a supplied diagnos code argument. If its not in the list, it is
   * invalid!
   *
   * @author npet
   */
