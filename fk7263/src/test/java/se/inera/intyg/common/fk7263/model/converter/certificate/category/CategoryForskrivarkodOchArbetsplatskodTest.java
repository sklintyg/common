...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.FORSKRIVARKOD_OCH_ARBETSPLATSKOD_CATEGORY_TEXT_ID;
...
class CategoryForskrivarkodOchArbetsplatskodTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryForskrivarkodOchArbetsplatskod.toCertificate(0, messagesProvider);
        }

        @Override
        protected String getId() {
            return FORSKRIVARKOD_OCH_ARBETSPLATSKOD_CATEGORY_ID;
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return FORSKRIVARKOD_OCH_ARBETSPLATSKOD_CATEGORY_TEXT_ID;
        }
