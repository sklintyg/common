...
class QuestionFunktionsnedsattningTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return QuestionFunktionsnedsattning.toCertificate(null, 0);
        }

        @Override
        protected String getId() {
            return FUNKTIONSNEDSATTNING_SVAR_ID;
        }
    ...
    class IncludeValueViewTextTests extends ValueViewTextTest<String> {
        ...
        protected CertificateDataElement getElement(String expectedValue) {
            return QuestionFunktionsnedsattning.toCertificate(expectedValue, 0);
        }
