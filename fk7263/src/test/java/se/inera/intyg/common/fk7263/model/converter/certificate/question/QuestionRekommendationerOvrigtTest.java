...
class QuestionRekommendationerOvrigtTest {
  ...
  void setUp() {
    when(messagesProvider.get(any(String.class)))
        .thenReturn(REKOMMENDATIONER_OVRIGT_DELSVAR_TEXT_ID);
  }
  ...
  class IncludeCommonElementTests extends CommonElementTest {
    ...
    protected String getId() {
      return REKOMMENDATIONER_OVRIGT_DELSVAR_ID;
    }
  ...
  class IncludeValueViewTextTests extends ValueViewTextTest<String> {
    ...
    protected CertificateDataElement getElement(String expectedValue) {
      return QuestionRekommendationerOvrigt.toCertificate(expectedValue, 0, messagesProvider);
    }
