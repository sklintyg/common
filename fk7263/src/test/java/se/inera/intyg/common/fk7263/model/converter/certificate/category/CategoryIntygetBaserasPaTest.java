...
import static se.inera.intyg.common.fk7263.model.converter.RespConstants.INTYGET_BASERAS_PA_CATEGORY_TEXT_ID;
...
class CategoryIntygetBaserasPaTest {
    ...
    class IncludeCommonElementTests extends CommonElementTest {
        ...
        protected CertificateDataElement getElement() {
            return CategoryIntygetBaserasPa.toCertificate(0, messagesProvider);
        }
    ...
    class IncludeConfigCategoryTests extends ConfigCategoryWithMessageProviderTest {
        ...
        protected String getTextId() {
            return INTYGET_BASERAS_PA_CATEGORY_TEXT_ID;
        }
