...
angular.module('fk7263').factory('fk7263.customizeViewstate', function() {
  ...
  var _fieldConfig = {
    ...
    'intygetBaserasPa': {
      mandatory: true, selected: true, fields: [
    ...
    'aktivitetsbegransning': {
      mandatory: false,
      selected: true,
      fields: ['aktivitetsbegransning'],
      warn: true,
      domId: 'aktivitetsbegransning'
    },
    ...
    'rekommendationerForetagsHalsoVard': {
      mandatory: true,
      selected: true,
      fields: ['rekommendationKontaktForetagshalsovarden'],
      domId: 'rekommendationerForetagsHalsoVard'
    },
    ...
    'arbetsFormagaRelativtUtomNuvarandeArbete': {
      mandatory: false,
      selected: true,
      fields: ['arbetsloshet', 'foraldrarledighet'],
      domId: 'arbetsFormagaRelativtUtomNuvarandeArbete'
    },
    'arbetsFormagaRelativtNuvarandeArbete': {
      mandatory: true,
      selected: true,
      fields: ['nuvarandeArbetsuppgifter'],
      domId: 'arbetsFormagaRelativtNuvarandeArbete'
    },
    'bedomdArbetsFormaga': {
      mandatory: true,
      selected: true,
      fields: ['nedsattMed25', 'nedsattMed50', 'nedsattMed75', 'nedsattMed100'],
      domId: 'bedomdArbetsFormaga'
    },
