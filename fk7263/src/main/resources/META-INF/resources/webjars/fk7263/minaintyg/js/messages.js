...
angular.module('fk7263').constant('fk7263.messages', {
    'sv': {
        // Labels
        'fk7263.label.pageingress': 'Här visas hela ditt läkarintyg. Från den här sidan kan du ladda ner intyget som PDF och arkivera intyget. Om du vill ansöka om sjukpenning, gör du det enklast på <LINK:forsakringskassan-sjuk>. För medicinska frågor som rör ditt intyg ska du kontakta den som utfärdade ditt intyg, eller den mottagning du besökte när du fick ditt intyg utfärdat. Du har fått ett intyg från din läkare som inte går att skicka digitalt. Om du vill ansöka om sjukpenning behöver du skicka intyget med post till Försäkringskassan.',
