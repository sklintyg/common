...
angular.module('fk7263').controller('fk7263.EditCertCtrl',
    ['$rootScope', '$location', '$scope', '$log', '$state', '$stateParams', '$q',
      ...
      function($rootScope, $location, $scope, $log, $state, $stateParams, $q,
          UtkastService, UserModel, utils, IntygModel, supportPanelConfigFactory, viewConfigFactory, viewState, ObjectHelper, IntygProxy,
          IntygHelper) {
        'use strict';
        ...
        UtkastService.load(viewState).then(function(intygModel) {
          ...
          $scope.supportPanelConfig =
              supportPanelConfigFactory.getConfig(intygModel.id, '1.0', false, viewState.common.intyg.isKomplettering);
