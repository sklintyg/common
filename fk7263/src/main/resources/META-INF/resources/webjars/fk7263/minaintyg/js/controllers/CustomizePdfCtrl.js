...
angular.module('fk7263').controller('fk7263.CustomizePdfCtrl',
    ['$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope', 'fk7263.customizeViewstate',
      ...
      function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService,
        ...
        $scope.downloadAsPdfLink = '/moduleapi/certificate/fk7263/' + $stateParams.intygTypeVersion + '/' + $stateParams.certificateId +
            '/pdf/arbetsgivarutskrift';
