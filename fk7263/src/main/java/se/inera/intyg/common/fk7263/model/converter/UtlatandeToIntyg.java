...
public final class UtlatandeToIntyg {
  ...
  public static final String
      ARBETSFORMAGA_PROGNOS_SJUKSKRIVNING_LANGRE_AN_REKOMMENDERAD_MOTIVERING_DELSVAR_37_1 = "37.1";
  public static final String
      ARBETSFORMAGA_PROGNOS_SJUKSKRIVNING_LANGRE_AN_REKOMMENDERAD_MOTIVERING_SVAR_37 = "37";
  ...
  public static Intyg convert(Fk7263Utlatande source) {
    ...
    // NOTE: See INTYG-7211: versionerade intyg kräver att alla intyg har en version (textVersion)
    // så Fk7263Utlatande har
    // fått hårdkodad "1.0" istf null. Fk7263 Roundtriptester däremot kräver idag (av en god
    // anledning?) empty versionstag
  ...
  private static List<Svar> getSvar(Fk7263Utlatande source) {
    ...
    if (source.getNedsattMed100() != null && source.getNedsattMed100().isValid()) {
      svars.add(
          createBehovAvSjukskrivningSvar(
              SjukskrivningsGrad.HELT_NEDSATT, sjukskrivningInstans++, source.getNedsattMed100()));
    }
    if (source.getNedsattMed75() != null && source.getNedsattMed75().isValid()) {
      svars.add(
          createBehovAvSjukskrivningSvar(
              SjukskrivningsGrad.NEDSATT_3_4, sjukskrivningInstans++, source.getNedsattMed75()));
    }
    if (source.getNedsattMed50() != null && source.getNedsattMed50().isValid()) {
      svars.add(
          createBehovAvSjukskrivningSvar(
              SjukskrivningsGrad.NEDSATT_HALFTEN,
              sjukskrivningInstans++,
              source.getNedsattMed50()));
    }
    if (source.getNedsattMed25() != null && source.getNedsattMed25().isValid()) {
      svars.add(
          createBehovAvSjukskrivningSvar(
              SjukskrivningsGrad.NEDSATT_1_4, sjukskrivningInstans++, source.getNedsattMed25()));
    }
    ...
    if (source.getTelefonkontaktMedPatienten() != null
      ...
      svars.add(
          aSvar(GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1, grundForMUInstans++)
              .withDelsvar(
                  GRUNDFORMEDICINSKTUNDERLAG_TYP_DELSVAR_ID_1,
                  aCV(
                      GRUNDFORMEDICINSKTUNDERLAG_CODE_SYSTEM,
                      ReferensTyp.TELEFONKONTAKT.transportId,
      ...
      svars.add(
          aSvar(GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1, grundForMUInstans++)
              .withDelsvar(
                  ...
                  aCV(
                      GRUNDFORMEDICINSKTUNDERLAG_CODE_SYSTEM,
                      ReferensTyp.UNDERSOKNING.transportId,
      ...
      svars.add(
          aSvar(GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1, grundForMUInstans++)
              .withDelsvar(
                  ...
                  aCV(
                      GRUNDFORMEDICINSKTUNDERLAG_CODE_SYSTEM,
                      ReferensTyp.JOURNAL.transportId,
                      ReferensTyp.JOURNAL.label))
              .withDelsvar(
                  GRUNDFORMEDICINSKTUNDERLAG_DATUM_DELSVAR_ID_1,
      ...
      svars.add(
          aSvar(GRUNDFORMEDICINSKTUNDERLAG_SVAR_ID_1, grundForMUInstans++)
              .withDelsvar(
                  ...
                  aCV(
                      GRUNDFORMEDICINSKTUNDERLAG_CODE_SYSTEM,
                      ReferensTyp.ANNAT.transportId,
                      ReferensTyp.ANNAT.label))
              .withDelsvar(
                  GRUNDFORMEDICINSKTUNDERLAG_DATUM_DELSVAR_ID_1,
    ...
    addIfNotBlank(
        ...
        SJUKDOMSFORLOPP_DELSVAR_10002_1,
        source.getSjukdomsforlopp());
    svars.add(createRekommendation(source));

    addIfNotBlank(
        svars,
        AKTIVITETSBEGRANSNING_SVAR_17,
        AKTIVITETSBEGRANSNING_DELSVAR_17_1,
        source.getAktivitetsbegransning());
    addIfNotBlank(
        svars,
        OVRIGA_UPPLYSNINGAR_SVAR_25,
        OVRIGA_UPPLYSNINGAR_DELSVAR_25_1,
        buildOvrigaUpplysningar(source));
    svars.add(
        aSvar(KONTAKT_MED_FK_SVAR_26)
            .withDelsvar(KONTAKT_MED_FK_DELSVAR_26_1, String.valueOf(source.isKontaktMedFk()))
            .build());
    svars.add(
        aSvar(AVSTANGNING_SMITTSKYDD_SVAR_27)
            .withDelsvar(
                AVSTANGNING_SMITTSKYDD_DELSVAR_27_1,
                String.valueOf(source.isAvstangningSmittskydd()))
            .build());
    if (source.isArbetsloshet()) {
      svars.add(
          aSvar(SYSSELSATTNING_SVAR_28)
              .withDelsvar(
                  SYSSELSATTNING_DELSVAR_28_1,
                  aCV(
                      TYP_AV_SYSSELSATTNING_CODE_SYSTEM,
                      Sysselsattning.ARBETSSOKANDE.getTransportId(),
      ...
      svars.add(
          aSvar(SYSSELSATTNING_SVAR_28)
              .withDelsvar(
                  ...
                  aCV(
                      TYP_AV_SYSSELSATTNING_CODE_SYSTEM,
                      Sysselsattning.NUVARANDE_ARBETE.getTransportId(),
    ...
    addIfNotBlank(
        ...
        NUVARANDE_ARBETSUPPGIFTER_DELSVAR_29_1,
        source.getNuvarandeArbetsuppgifter());
    svars.add(
        aSvar(RESSATT_TILL_ARBETE_AKTUELLT_SVAR_34)
            .withDelsvar(
                RESSATT_TILL_ARBETE_AKTUELLT_DELSVAR_34_1,
                String.valueOf(source.isRessattTillArbeteAktuellt()))
            .build());
    addIfNotBlank(
        svars,
        FUNKTIONSNEDSATTNING_SVAR_35,
        FUNKTIONSNEDSATTNING_DELSVAR_35_1,
    ...
    addIfNotBlank(
        ...
        source.getArbetsformagaPrognos());
    ...
    if (!isNullOrEmpty(source.getAtgardInomSjukvarden())) {
      svarBuilder =
          svarBuilder.withDelsvar(
              ATGARD_INOM_SJUKVARDEN_DELSVAR_10004_1, source.getAtgardInomSjukvarden());
    }

    if (!isNullOrEmpty(source.getAnnanAtgard())) {
      svarBuilder =
          svarBuilder.withDelsvar(ATGARD_INOM_SJUKVARDEN_DELSVAR_10004_2, source.getAnnanAtgard());
    }
    return svarBuilder.build();
  }

  private static Svar createRekommendation(Fk7263Utlatande source) {
    SvarBuilder svarBuilder =
        aSvar(REKOMMENDATION_KONTAKT_SVAR_10003)
            .withDelsvar(
                REKOMMENDATION_KONTAKT_DELSVAR_AF_10003_1,
                String.valueOf(source.isRekommendationKontaktArbetsformedlingen()))
            .withDelsvar(
                REKOMMENDATION_KONTAKT_DELSVAR_FHV_10003_2,
                String.valueOf(source.isRekommendationKontaktForetagshalsovarden()));
    if (!isNullOrEmpty(source.getRekommendationOvrigt())) {
      svarBuilder =
          svarBuilder.withDelsvar(
              REKOMMENDATION_KONTAKT_DELSVAR_OVRIGT_10003_3, source.getRekommendationOvrigt());
    }
    return svarBuilder.build();
  }
  ...
  private static Svar createPrognosSvar(Fk7263Utlatande source) {
    ...
    switch (bedomning) {
      case arbetsformagaPrognosJa:
        return svar.withDelsvar(ARBETSFORMAGA_PROGNOS_DELSVAR_10006_1, String.valueOf(true))
            .build();
      case arbetsformagaPrognosNej:
        return svar.withDelsvar(ARBETSFORMAGA_PROGNOS_DELSVAR_10006_1, String.valueOf(false))
            .build();
      case arbetsformagaPrognosJaDelvis:
        return svar.withDelsvar(ARBETSFORMAGA_PROGNOS_DELSVAR_10006_2, String.valueOf(true))
            .build();
      case arbetsformagaPrognosGarInteAttBedoma:
        return svar.withDelsvar(ARBETSFORMAGA_PROGNOS_DELSVAR_10006_3, String.valueOf(true))
            .build();
    }
    return aSvar(ARBETSFORMAGA_PROGNOS_SVAR_10006)
        .withDelsvar(ARBETSFORMAGA_PROGNOS_DELSVAR_10006_3, true)
        .build();
  }
  ...
  private static Svar createRehabiliteringSvar(Fk7263Utlatande source) {
    ...
    return aSvar(REHABILITERING_SVAR_10005)
        .withDelsvar(REHABILITERING_DELSVAR_10005_2, true)
        .build();
  }

  private static Svar createDiagnosFritextSvar(Fk7263Utlatande source) {
    return aSvar(DIAGNOS_FRITEXT_SVAR_10001)
        .withDelsvar(DIAGNOS_FRITEXT_DELSVAR_10001_1, source.getDiagnosBeskrivning())
        .build();
  }
    ...
    if (source.getDiagnosKodsystem1() != null) {
      svarBuilder =
          svarBuilder.withDelsvar(
              DIAGNOS_DELSVAR_6_2,
              aCV(
                  Diagnoskodverk.valueOf(source.getDiagnosKodsystem1()).getCodeSystem(),
                  source.getDiagnosKod(),
                  Strings.emptyToNull(source.getDiagnosBeskrivning1())));
    }
    return svarBuilder.build();
  }

  private static Svar createBehovAvSjukskrivningSvar(
      SjukskrivningsGrad sjukskrivningsgrad, int instans, InternalLocalDateInterval interval) {
    return aSvar(BEHOV_AV_SJUKSKRIVNING_SVAR_ID_32, instans)
        .withDelsvar(
            BEHOV_AV_SJUKSKRIVNING_NIVA_DELSVARSVAR_ID_32,
            aCV(
                SJUKSKRIVNING_CODE_SYSTEM,
                sjukskrivningsgrad.getTransportId(),
                sjukskrivningsgrad.getLabel()))
        .withDelsvar(
