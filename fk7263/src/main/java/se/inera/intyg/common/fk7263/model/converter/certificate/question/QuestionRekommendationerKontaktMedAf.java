...
public class QuestionRekommendationerKontaktMedAf {
  ...
  public static CertificateDataElement toCertificate(
      Boolean kontaktMedAf, int index, CertificateMessagesProvider messagesProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(radioBooleanValue(kontaktMedAf)).build())
        .build();
  }
}
