...
public class QuestionForskrivarkodOchArbetsplatskod {

    public static CertificateDataElement toCertificate(String forskrivarkodOchArbetsplatskod, int index) {
        return CertificateDataElement.builder()
            .id(FORSKRIVARKOD_OCH_ARBETSPLATSKOD_SVAR_ID)
            .parent(FORSKRIVARKOD_OCH_ARBETSPLATSKOD_CATEGORY_ID)
            .index(index)
            .config(
            ...
            .value(
                CertificateDataValueViewText.builder()
                    .text(stringValue(forskrivarkodOchArbetsplatskod))
                    .build()
            )
            .build();
    }
