...
public class CategoryArbetsformogaForsakringsmedicinskaBeslutstodet {

    public static CertificateDataElement toCertificate(int index, CertificateMessagesProvider messagesProvider) {
        return CertificateDataElement.builder()
            .id(ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigCategory.builder()
                    .text(messagesProvider.get(ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_CATEGORY_TEXT_ID))
                    .build()
            )
            .build();
    }
