...
public class QuestionSjukdomsforlopp {
  ...
  public static CertificateDataElement toCertificate(String sjukdomsforlopp, int index) {
    return CertificateDataElement.builder()
        .id(SJUKDOMSFORLOPP_SVAR_ID)
        .parent(SJUKDOMSFORLOPP_CATEGORY_ID)
        .index(index)
        .config(CertificateDataConfigViewText.builder().build())
        .value(CertificateDataValueViewText.builder().text(stringValue(sjukdomsforlopp)).build())
        .build();
  }
}
