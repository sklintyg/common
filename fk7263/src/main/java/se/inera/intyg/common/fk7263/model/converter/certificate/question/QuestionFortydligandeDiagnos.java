...
public class QuestionFortydligandeDiagnos {
  ...
  public static CertificateDataElement toCertificate(
      String diagnosBeskrivning1, int index, CertificateMessagesProvider messagesProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(
            CertificateDataValueViewText.builder().text(stringValue(diagnosBeskrivning1)).build())
        .build();
  }
}
