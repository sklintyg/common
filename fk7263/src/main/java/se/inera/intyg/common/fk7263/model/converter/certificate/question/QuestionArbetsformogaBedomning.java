...
public class QuestionArbetsformogaBedomning {
  ...
  public static CertificateDataElement toCertificate(
      InternalLocalDateInterval nedsattMed25,
      InternalLocalDateInterval nedsattMed50,
      InternalLocalDateInterval nedsattMed75,
      InternalLocalDateInterval nedsattMed100,
      int index,
    ...
    return CertificateDataElement.builder()
        ...
        .value(
            CertificateDataValueViewTable.builder()
                .rows(
                    getRows(
                        nedsattMed25, nedsattMed50, nedsattMed75, nedsattMed100, messagesProvider))
                .build())
        .build();
  }

  private static List<CertificateDataValueViewRow> getRows(
      InternalLocalDateInterval nedsattMed25,
      InternalLocalDateInterval nedsattMed50,
      InternalLocalDateInterval nedsattMed75,
      InternalLocalDateInterval nedsattMed100,
    ...
    if (nedsattMed25 != null) {
      rows.add(
          CertificateDataValueViewRow.builder()
              .columns(
                  getColumnNedsatt(
                      nedsattMed25, ARBETSFORMAGA_BEDOMNING_NEDSATT_25_TEXT_ID, messagesProvider))
              .build());
    }
    ...
    if (nedsattMed50 != null) {
      rows.add(
          CertificateDataValueViewRow.builder()
              .columns(
                  getColumnNedsatt(
                      nedsattMed50, ARBETSFORMAGA_BEDOMNING_NEDSATT_50_TEXT_ID, messagesProvider))
              .build());
    }
    if (nedsattMed75 != null) {
      rows.add(
          CertificateDataValueViewRow.builder()
              .columns(
                  getColumnNedsatt(
                      nedsattMed75, ARBETSFORMAGA_BEDOMNING_NEDSATT_75_TEXT_ID, messagesProvider))
              .build());
    }
    if (nedsattMed100 != null) {
      rows.add(
          CertificateDataValueViewRow.builder()
              .columns(
                  getColumnNedsatt(
                      nedsattMed100, ARBETSFORMAGA_BEDOMNING_NEDSATT_100_TEXT_ID, messagesProvider))
              .build());
    }
  ...
  private static List<CertificateDataValueText> getColumnNedsatt(
      InternalLocalDateInterval nedsattMed,
      String textId,
      CertificateMessagesProvider messagesProvider) {
    return List.of(
