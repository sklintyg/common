...
public class QuestionKontaktMedFk {
  ...
  public static CertificateDataElement toCertificate(Boolean kontaktMedFk, int index) {
    return CertificateDataElement.builder()
        .id(KONTAKT_MED_FK_SVAR_ID)
        .parent(KONTAKT_MED_FK_CATEGORY_ID)
        .index(index)
        .config(CertificateDataConfigViewText.builder().build())
        .value(CertificateDataValueViewText.builder().text(radioBooleanValue(kontaktMedFk)).build())
        .build();
  }
}
