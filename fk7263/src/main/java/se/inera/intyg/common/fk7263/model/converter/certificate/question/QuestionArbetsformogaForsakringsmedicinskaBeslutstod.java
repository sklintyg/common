...
public class QuestionArbetsformogaForsakringsmedicinskaBeslutstod {
  ...
  public static CertificateDataElement toCertificate(String beslutstod, int index) {
    return CertificateDataElement.builder()
        .id(ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_SVAR_ID)
        .parent(ARBETSFORMAGA_FORSAKRINGSMEDICINSKA_BESLUTSTODET_CATEGORY_ID)
        .index(index)
        .config(CertificateDataConfigViewText.builder().build())
        .value(CertificateDataValueViewText.builder().text(stringValue(beslutstod)).build())
        .build();
  }
}
