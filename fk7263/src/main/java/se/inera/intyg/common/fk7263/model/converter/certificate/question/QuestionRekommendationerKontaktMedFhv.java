...
public class QuestionRekommendationerKontaktMedFhv {
  ...
  public static CertificateDataElement toCertificate(
      Boolean kontaktMedFhv, int index, CertificateMessagesProvider messagesProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(
            CertificateDataValueViewText.builder().text(radioBooleanValue(kontaktMedFhv)).build())
        .build();
  }
}
