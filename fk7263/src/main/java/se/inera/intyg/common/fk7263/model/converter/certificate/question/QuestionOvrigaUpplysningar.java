...
public class QuestionOvrigaUpplysningar {
  ...
  public static CertificateDataElement toCertificate(String ovrigaUpplysningar, int index) {
    return CertificateDataElement.builder()
        .id(OVRIGA_UPPLYSNINGAR_SVAR_ID)
        .parent(OVRIGA_UPPLYSNINGAR_CATEGORY_ID)
        .index(index)
        .config(CertificateDataConfigViewText.builder().build())
        .value(CertificateDataValueViewText.builder().text(stringValue(ovrigaUpplysningar)).build())
        .build();
  }
}
