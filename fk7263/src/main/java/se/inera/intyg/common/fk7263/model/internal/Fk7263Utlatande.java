...
public class Fk7263Utlatande implements Utlatande {
  ...
  public void setRekommendationKontaktArbetsformedlingen(
  ...
  public void setRekommendationKontaktForetagshalsovarden(
  ...
  public String getForskrivarkodOchArbetsplatskod() {
    return Strings.emptyToNull(
        Joiner.on(" - ")
            .skipNulls()
            .join(
                getGrundData().getSkapadAv().getForskrivarKod(),
                getGrundData().getSkapadAv().getVardenhet().getArbetsplatsKod())
            .trim());
  }
  ...
  public String getNamnfortydligandeOchAdress() {
    return join(
        ...
        join(
            " ",
            getGrundData().getSkapadAv().getVardenhet().getPostnummer(),
  ...
  // INTYG-7211 - With versioned intyg - All Utlatanden must have an textVersion - Fk7263 will
  // always be 1.0
  @Override
