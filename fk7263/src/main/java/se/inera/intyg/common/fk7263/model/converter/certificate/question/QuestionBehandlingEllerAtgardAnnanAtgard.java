...
public class QuestionBehandlingEllerAtgardAnnanAtgard {
  ...
  public static CertificateDataElement toCertificate(
      String annanAtgard, int index, CertificateMessagesProvider messagesProvider) {
    return CertificateDataElement.builder()
        ...
        .config(
            CertificateDataConfigViewText.builder()
                ...
                .build())
        .value(CertificateDataValueViewText.builder().text(stringValue(annanAtgard)).build())
        .build();
  }
}
