...
public class CategoryArbetslivsinriktadRehabilitering {

    public static CertificateDataElement toCertificate(int index, CertificateMessagesProvider messagesProvider) {
        return CertificateDataElement.builder()
            .id(ARBETSLIVSINRIKTAD_REHABILITERING_CATEGORY_ID)
            .index(index)
            .config(
                CertificateDataConfigCategory.builder()
                    .text(messagesProvider.get(ARBETSLIVSINRIKTAD_REHABILITERING_CATEGORY_TEXT_ID))
                    .build()
            )
            .build();
    }
