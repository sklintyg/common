...
class DefaultCertificateTextProviderTest {
  ...
  private static final String VALUE_WITH_LIST_TAGS =
      "This is <ul><li> a text with </li><li> symbols</li></ul>";
  private static final String VALUE_STARTING_WITH_DASH_AS_LIST =
      "- This is \n - My list\n\nWith an extra paragraph";
  private static final String KEY_WITH_LIST_TAGS_IN_FRONT = "key_front";
  private static final String VALUE_WITH_LIST_TAGS_IN_FRONT =
      "<ul><li> This is </li><li> My list</li></ul>With an extra paragraph";
  ...
  class Get {
    ...
    void shallReplaceAngularLaunchIconWithReactLaunchIcon() {
      final var actualText =
          defaultCertificateTextProvider.get(ANGULAR_TRANSPORTSTYRELSEN_LINK_KEY);
  ...
  class GetOrNull {
    ...
    void shallAddNewlineInTsbasV7() {
      final var actualText =
          defaultCertificateTextProvider.getOrNull(TS_BAS_INTYGET_AVSER_HELP_TEXT_KEY);
      assertEquals(TS_BAS_INTYGET_AVSER_HELP_TEXT_FIXED, actualText);
    }
    ...
    void shallReplaceAngularLaunchIconWithReactLaunchIcon() {
      final var actualText =
          defaultCertificateTextProvider.getOrNull(ANGULAR_TRANSPORTSTYRELSEN_LINK_KEY);
      assertEquals(REACT_TRANSPORTSTYRELSEN_LINK_KEY, actualText);
    }
