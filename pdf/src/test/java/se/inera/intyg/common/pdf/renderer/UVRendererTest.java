...
public class UVRendererTest {
  ...
  public void testMinimalAg7804() throws IOException {
    ...
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            ...
            .withSummary(
                new Summary()
                    .add("Lite om intyget", "Lorem ipsum")
  ...
  public void testMaximalOptionalfieldsAg7804() throws IOException {
    ...
    replacementConfig.put(
        "funktionsnedsattning", "Denna text är istället för funktionsnedsattning!");
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            .withIntygJsonModel(cleanedJson)
            .withUpJsModel(upJsModel)
    ...
    try (FileOutputStream fos =
        new FileOutputStream("build/tmp/ag7804-maximal-optionalfields-v1.pdf")) {
      fos.write(data);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void testAg114TomtUtkast() throws IOException {
    ...
    byte[] data = new UVRenderer().startRendering(printConfig, intygTexts, TITLE);
    try (FileOutputStream fos =
        new FileOutputStream("build/tmp/ag1-14v1-generic-tomt-utkast.pdf")) {
      fos.write(data);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void testAg114EmployerPdfWithoutDiagnose() throws IOException {
    ...
    byte[] data = new UVRenderer().startRendering(printConfig, intygTexts, TITLE);
    try (FileOutputStream fos =
        new FileOutputStream("build/tmp/ag1-14v1-employer-no-diagnose.pdf")) {
      fos.write(data);
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void testTsDiabetes() throws IOException {
    ...
    byte[] logoData =
        IOUtils.toByteArray(new ClassPathResource("transportstyrelsen-logo.png").getInputStream());
    ...
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            ...
            .withSummary(
                new Summary()
                    .add("Om Transportstyrelsens läkarintyg diabetes", "Lorem ipsum")
                    .add(UTSK001_HEADER, UTSK001_BODY))
  ...
  public void testEmptyTsDiabetes() throws IOException {
    ...
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            ...
            .withInfoText(INFO_TEXT_TS)
            .withSummary(
                new Summary().add("Om Transportstyrelsens läkarintyg diabetes", "Lorem ipsum"))
            .withLeftMarginTypText("TSTRK1031 (U03) 181024")
            .withUtfardarLogotyp(logoData)
            .withApplicationOrigin(ApplicationOrigin.WEBCERT)
            .build();
  ...
  public void testLisjp() throws IOException {
    ...
    byte[] logoData =
        IOUtils.toByteArray(new ClassPathResource("forsakringskassan-logo.png").getInputStream());
    ...
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            ...
            .withSummary(
                new Summary()
                    .add(
                        "Om försäkringskassans läkarintyg",
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\n\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."))
            .withLeftMarginTypText(
                "FK7804 (001 F 001) Fastst\u00E4lld av F\u00F6rs\u00E4kringskassan")
            .withUtfardarLogotyp(logoData)
            .withApplicationOrigin(ApplicationOrigin.WEBCERT)
            .build();
  ...
  public void testAf00213() throws IOException {
    ...
    PrintConfig printConfig =
        PrintConfig.PrintConfigBuilder.aPrintConfig()
            ...
            .withSummary(
                new Summary().add("Arbetsförmedlingens medicinska utlåtande", "Lorem ipsum"))
  ...
  private IntygTexts loadTexts(String fileName) {
    ...
    try {
      ...
      prop.putAll(
          ImmutableMap.of(
              "formId",
              "FK 7802 (001 F 001) Fastställd av Försäkringskassan",
              "blankettId",
              "7802",
              "blankettVersion",
              "01"));
