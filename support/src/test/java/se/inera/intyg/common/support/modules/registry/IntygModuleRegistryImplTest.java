...
public class IntygModuleRegistryImplTest {
  ...
  private static final String MODULE_DEPENDENCY_DEFINITION_PATH_1 =
      "moduleDependencyDefinitionPath1";
  ...
  private static final String MODULE_DEPENDENCY_DEFINITION_PATH_2 =
      "moduleDependencyDefinitionPath2";
  private static final String INTYG_VERSION = "1.0";
  private static final String MODULE_ID_2_DEFAULT_FALLBACK_INTYG_VERSION = "4.0";

  @Mock private ModuleEntryPoint entryPointMock1;

  @Mock private ModuleEntryPoint entryPointMock2;

  @Mock private ModuleApi moduleAPiMockBean;
  ...
  public void setup() {
    ...
    when(entryPointMock1.getModuleDependencyDefinitionPath(ORIGIN))
        .thenReturn(MODULE_DEPENDENCY_DEFINITION_PATH_1);
    when(entryPointMock1.getDefaultFallbackIntygTypeVersion())
        .thenReturn(MODULE_ID_1_DEFAULT_FALLBACK_INTYG_VERSION);
    ...
    when(entryPointMock2.getModuleDependencyDefinitionPath(ORIGIN))
        .thenReturn(MODULE_DEPENDENCY_DEFINITION_PATH_2);
    when(entryPointMock2.getDefaultFallbackIntygTypeVersion())
        .thenReturn(MODULE_ID_2_DEFAULT_FALLBACK_INTYG_VERSION);
    ...
    ReflectionTestUtils.setField(
        registry, "moduleEntryPoints", Arrays.asList(entryPointMock1, entryPointMock2));
