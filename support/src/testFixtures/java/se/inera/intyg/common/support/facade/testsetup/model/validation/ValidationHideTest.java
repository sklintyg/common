...
public abstract class ValidationHideTest extends ValidationTest {
    ...
    protected CertificateDataValidationType getType() {
        return CertificateDataValidationType.HIDE_VALIDATION;
    }

    @Test
    void shouldIncludeValidationHideQuestionId() {
        final var question = getElement();
        final var certificateDataValidation = (CertificateDataValidationHide) question.getValidation()[getValidationIndex()];
