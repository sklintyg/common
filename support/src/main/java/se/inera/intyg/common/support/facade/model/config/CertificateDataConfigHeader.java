...
import lombok.Value;
import se.inera.intyg.common.support.facade.model.config.CertificateDataConfigHeader.CertificateDataConfigHeaderBuilder;

@JsonDeserialize(builder = CertificateDataConfigHeaderBuilder.class)
@Value
@Builder
