...
import lombok.Value;
import se.inera.intyg.common.support.facade.model.config.CertificateDataConfigTypeAhead.CertificateDataConfigTypeAheadBuilder;
...
public class CertificateDataConfigTypeAhead implements CertificateDataConfig {
    ...
    CertificateDataConfigTypes type = CertificateDataConfigTypes.UE_TYPE_AHEAD;
    @Getter(onMethod = @__(@Override))
    String header;
    @Getter(onMethod = @__(@Override))
    String label;
