...
public class TestabilityToolkit {
  ...
  public static <T extends Utlatande> T getUtlatandeWithTestData(
      T utlatande,
      FillType fillType,
  ...
  public static void fillCertificateWithTestData(
  ...
  public static void updateCertificate(
      Certificate certificate, Map<String, CertificateDataValue> valueMap) {
    valueMap.forEach(
        (key, value) -> {
          final var certificateDataElement = certificate.getData().get(key);
          final var updatedCertificateDataElement =
        ...
        .list(
            Collections.singletonList(
                CertificateDataValueDiagnosis.builder()
                    ...
                    .code("J09")
                    .description(
                        "Influensa orsakad av identifierat zoonotiskt eller pandemiskt influensavirus")
                    .build()))
        .build();
  }

  public static CertificateDataValueDateRangeList getCertificateDataValueDateRangeList(
      boolean shortPeriod) {
                ...
                CertificateDataValueDateRange.builder()
                    ...
                    .to(
                        LocalDate.now()
                            .plusDays(
                                shortPeriod
                                    ? DEFAULT_SHORT_SICK_LEAVE_LENGTH
                                    : DEFAULT_SICK_LEAVE_LENGTH))
                    .build()))
        .build();
  }

  public static CertificateDataValueDateRangeList
      getCertificateDataValueDateRangeListWithSeveralPeriods(boolean shortPeriod) {
    return CertificateDataValueDateRangeList.builder()
        .list(
            Arrays.asList(
                CertificateDataValueDateRange.builder()
