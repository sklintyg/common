...
/**
 * Reusable generic representation of a Relation between two intyg. While an instance of this class
 * usually exists as a relation (no pun intended!) on an Certificate instance, the relation may
 * either be a child-relation (e.g. a child is referencing me) or as a parent (I am referencing my
 * parent)
 *
 * <p>CERT B <- from <- RELATION (REPLACES) -> to -> CERT A.
 *
 * <p>An instance of this class is identified by fromIntygsId, toIntygsId and relationKod.
 *
 * <p>Applications may subclass this class in order to add application-specific information about
 * relations such as UtkastState in Webcert.
 *
 * <p>Created by eriklupander on 2017-05-10.
 */
public class CertificateRelation {
  ...
  public CertificateRelation(
      String fromIntygsId, String toIntygsId, RelationKod relationKod, LocalDateTime skapad) {
