...
public class SpecialistkompetensService {

    private static final Logger LOG = LoggerFactory.getLogger(SpecialistkompetensService.class);
    private static final String CSV_SEPARATOR = ";";

    private static SpecialistkompetensService instance;
    ...
    @Value("${specialistkompetens.file}")
