...
/**
 * Representation of inmplemented intyg types from kodverket Kv Intygstyp. see
 * https://riv-ta.atlassian.net/wiki/spaces/KINT/pages/270532953/Kodverk+i+nationella+tj+nstekontrakt.
 * Note: The codes - LIAG - TSTRK1031-002 - AFU - AFU_UTVIDGAD are not included as they are not
 * implemented.
 *
 * <p>TSTRK1007 and TSTRK1031 also exists in Kv Intygstyp, but they still use KvUtlatandetyp for
 * legacy reasons.
 */
