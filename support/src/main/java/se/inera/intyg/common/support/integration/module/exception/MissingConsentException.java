...
public class MissingConsentException extends RuntimeException {
    ...
    public MissingConsentException(Personnummer personnummer) {
        super(String.format("Consent required from user %s", Personnummer.getPersonnummerHashSafe(personnummer)));
    }
