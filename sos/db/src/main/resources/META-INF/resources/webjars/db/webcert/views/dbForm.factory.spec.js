 ...
 */
describe('dbFormFactory', function() {
    'use strict';
    ...
    beforeEach(angular.mock.module('common', 'db'));
    beforeEach(inject(['$compile', '$rootScope', 'db.FormFactory', 'db.Domain.IntygModel',
        function($compile, $rootScope, _dbFormFactory_, _dbIntygModel_) {
        lispFormFactory = _dbFormFactory_;

        $scope = $rootScope.$new();
        $scope.model = _dbIntygModel_._members.build().content;
        $scope.options = {
