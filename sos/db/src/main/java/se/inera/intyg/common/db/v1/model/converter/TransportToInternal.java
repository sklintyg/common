...
public final class TransportToInternal {
  ...
  private static void setSvar(DbUtlatandeV1.Builder utlatande, Intyg intyg)
  ...
  private static void handleUndersokning(DbUtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
  ...
  private static void handleDodsplats(DbUtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
