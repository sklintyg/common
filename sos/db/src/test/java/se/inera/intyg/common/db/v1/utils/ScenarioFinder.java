 ...
 */
package se.inera.intyg.common.db.v1.utils;
...
public final class ScenarioFinder {
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    /** {@inheritDoc} */
    @Override
    public DbUtlatandeV1 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), DbUtlatandeV1.class);
      } catch (IOException e) {
