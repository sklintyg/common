...
class InternalValidatorTest {
  ...
  void testValidateUtkast() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        setupUtlatandeDates(ScenarioFinder.getInternalScenario("pass-1").asInternalModel());
    ValidateDraftResponse internalValidationResponse =
  ...
  void testR1() throws ScenarioNotFoundException {
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getType());
    assertEquals(
        "dodsdatumOchdodsPlats",
        internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals("dodsdatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        DODSDATUM_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  }

  @Test
  void testR2() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("validation-fail-R2").asInternalModel();
    internalValidatorHelper.setDateToCurrentYear(utlatandeFromJson.getDodsdatum());
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals(
        "dodsdatum.month", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        DODSDATUM_OSAKERT_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  }
  ...
  void testR3() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        setupUtlatandeDates(ScenarioFinder.getInternalScenario("fail-R3").asInternalModel());
    ValidateDraftResponse internalValidationResponse =
        internalValidator.validateDraft(utlatandeFromJson, typeAheadProvider);
    assertEquals(1, getNumberOfInternalValidationErrors(internalValidationResponse));
    assertEquals(
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals(
        "antraffatDodDatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        "db.validation.antraffatDod.dodsdatumSakert",
  ...
  void testR3_2() throws ScenarioNotFoundException {
    ...
    assertEquals(
        "antraffatDodDatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        "db.validation.datum.innanDodsdatum",
        internalValidationResponse.getValidationErrors().get(0).getMessage());
    assertEquals(
        ANTRAFFAT_DOD_DATUM_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  ...
  void testR3_4() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("validation-fail-R3-4").asInternalModel();
  ...
  @Test
  void testR5_1() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        setupUtlatandeDates(ScenarioFinder.getInternalScenario("fail-R5-1").asInternalModel());
    ValidateDraftResponse internalValidationResponse =
        internalValidator.validateDraft(utlatandeFromJson, typeAheadProvider);
    assertEquals(1, getNumberOfInternalValidationErrors(internalValidationResponse));
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getType());
    assertEquals(
        "explosivImplantat", internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals(
        "explosivAvlagsnat", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        EXPLOSIV_AVLAGSNAT_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  }

  @Test
  void testR5_2() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        setupUtlatandeDates(ScenarioFinder.getInternalScenario("fail-R5-2").asInternalModel());
    ValidateDraftResponse internalValidationResponse =
        internalValidator.validateDraft(utlatandeFromJson, typeAheadProvider);
    assertEquals(1, getNumberOfInternalValidationErrors(internalValidationResponse));
    assertEquals(
  ...
  @Test
  void testR7() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getType());
    assertEquals(
        "yttreUndersokning", internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals(
        "undersokningDatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
  ...
  @Test
  void testR7_2() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("fail-R7-2").asInternalModel();
    internalValidatorHelper.setDateToCurrentYear(utlatandeFromJson.getDodsdatum());
    internalValidatorHelper.setDateToCurrentYear(utlatandeFromJson.getAntraffatDodDatum());
    internalValidatorHelper.setDateToCurrentYear(utlatandeFromJson.getUndersokningDatum());
    ValidateDraftResponse internalValidationResponse =
  ...
  @Test
  void testR7_3() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("validation-fail-R7-3").asInternalModel();
  ...
  @Test
  void testR7_4() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("validation-fail-R7-4").asInternalModel();
    ...
    utlatandeFromJson
        .getAntraffatDodDatum()
        .setDate(antraffatDatum.format(DateTimeFormatter.ISO_LOCAL_DATE));
    utlatandeFromJson.getDodsdatum().setDate(dodsDatum.format(DateTimeFormatter.ISO_LOCAL_DATE));
    utlatandeFromJson
        .getUndersokningDatum()
        .setDate(undersokningDatum.format(DateTimeFormatter.ISO_LOCAL_DATE));
    ValidateDraftResponse internalValidationResponse =
        internalValidator.validateDraft(utlatandeFromJson, typeAheadProvider);
    assertEquals(1, getNumberOfInternalValidationErrors(internalValidationResponse));
    assertEquals(
    ...
    assertEquals(
        "undersokningDatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        "common.validation.date.beforePatientBirthDate",
        internalValidationResponse.getValidationErrors().get(0).getMessage());
    assertEquals(
        UNDERSOKNING_DATUM_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  ...
  @Test
  void testR7_5() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
        ScenarioFinder.getInternalScenario("validation-fail-R7-5").asInternalModel();
    ...
    assertEquals(
        "undersokningDatum", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        "db.validation.undersokningDatum.before.fourWeeks",
        internalValidationResponse.getValidationErrors().get(0).getMessage());
    assertEquals(
        UNDERSOKNING_DATUM_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  ...
  @Test
  void testR19() throws ScenarioNotFoundException {
    DbUtlatandeV1 utlatandeFromJson =
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getType());
    assertEquals(
        "polisanmalan", internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals(
        "polisanmalan", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        POLISANMALAN_DELSVAR_ID,
        internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  }
  ...
  void testR20_1() throws ScenarioNotFoundException {
    ...
    assertEquals(
        ...
        internalValidationResponse.getValidationErrors().get(0).getType());
    assertEquals(
        "barnSomAvlidit", internalValidationResponse.getValidationErrors().get(0).getCategory());
    assertEquals("barn", internalValidationResponse.getValidationErrors().get(0).getField());
    assertEquals(
        BARN_DELSVAR_ID, internalValidationResponse.getValidationErrors().get(0).getQuestionId());
  }
