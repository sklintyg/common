...
class CategoryUndersokningYttreTest {
    ...
    void shouldIncludeId() {
        ...
        assertEquals(UNDERSOKNING_YTTRE_CATEGORY_ID, category.getId());
    }

    @Test
    void shouldIncludeIndex() {
        final var expectedIndex = 3;
        final var category = CategoryUndersokningYttre.toCertificate(expectedIndex, texts);
