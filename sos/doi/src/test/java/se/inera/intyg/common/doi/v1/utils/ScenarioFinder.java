 ...
 */
package se.inera.intyg.common.doi.v1.utils;
...
public final class ScenarioFinder {
  ...
  private static final class FileBasedScenario implements Scenario {
    ...
    /** {@inheritDoc} */
    @Override
    public DoiUtlatandeV1 asInternalModel() throws ScenarioNotFoundException {
      try {
        return new CustomObjectMapper()
            .readValue(getInternalModelFor(getName()), DoiUtlatandeV1.class);
      } catch (IOException e) {
