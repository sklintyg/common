...
describe('doiFormFactory', function() {
    'use strict';
    ...
    beforeEach(angular.mock.module('common', 'doi'));
    beforeEach(inject(['$compile', '$rootScope', 'doi.FormFactory', 'doi.Domain.IntygModel',
        function($compile, $rootScope, _doiFormFactory_, _doiIntygModel_) {
        lispFormFactory = _doiFormFactory_;

        $scope = $rootScope.$new();
        $scope.model = _doiIntygModel_._members.build().content;
        $scope.options = {
