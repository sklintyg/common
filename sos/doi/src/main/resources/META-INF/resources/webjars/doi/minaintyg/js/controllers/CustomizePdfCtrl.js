...
angular.module('doi').controller('doi.CustomizePdfCtrl',
    [ '$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope','doi.customizeViewstate', 'common.IntygListService',
        ...
        function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService, dialogService, messageService) {
            ...
            $scope.downloadAsPdfLink = '/moduleapi/certificate/doi' + '/' + $stateParams.certificateId + '/pdf/arbetsgivarutskrift';
            ...
            $scope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams, options) {
                if (toState.name.indexOf('doi-customize')!==-1 || leaveConfirmed) {
                    return;
                }
            ...
            $scope.backToViewCertificate = function() {
                ...
                $location.path('/doi/view/' + $stateParams.certificateId);
            };
