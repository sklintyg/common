...
import se.inera.intyg.common.af00213.model.internal.Af00213Utlatande.Builder;
 ...
 */
public class WebcertModelFactoryImpl implements WebcertModelFactory<Af00213Utlatande> {
     ...
     * @return {@link Af00213Utlatande} or throws a ConverterException if something unforeseen happens
     * @throws ConverterException
     */
    @Override
    public Af00213Utlatande createNewWebcertDraft(CreateNewDraftHolder newDraftData) throws ConverterException {

        LOG.trace("Creating draft with id {}", newDraftData.getCertificateId());

        Builder template = Af00213Utlatande.builder();
    ...
    @Override
    public Af00213Utlatande createCopy(CreateDraftCopyHolder copyData, Utlatande template) throws ConverterException {
        if (!Af00213Utlatande.class.isInstance(template)) {
            throw new ConverterException("Template is not of type Af00213Utlatande");
        }

        Af00213Utlatande lisjpUtlatande = (Af00213Utlatande) template;

        LOG.trace("Creating copy with id {} from {}", copyData.getCertificateId(), lisjpUtlatande.getId());

        Af00213Utlatande.Builder templateBuilder = lisjpUtlatande.toBuilder();
