...
public class Af00213ModuleApiV1 extends AfParentModuleApi<Af00213Utlatande> {
    ...
    public PdfResponse pdf(String internalModel, List<Status> statuses, ApplicationOrigin applicationOrigin, UtkastStatus utkastStatus)
        ...
        return new PdfGenerator().generatePdf(af00213Intyg.getId(), internalModel, personId, texts, statuses, applicationOrigin,
                utkastStatus);
    }
