 ...
 */
package se.inera.intyg.common.af00213.v2.model.internal;
...
@AutoValue
@JsonDeserialize(builder = AutoValue_Af00213UtlatandeV2.Builder.class)
public abstract class Af00213UtlatandeV2 implements Af00213Utlatande {

    public static Builder builder() {
        return new AutoValue_Af00213UtlatandeV2.Builder()
                .setSignature(null);
    }
    ...
    // Fråga 4 - Beteende i trafiken --------------------------------------------------------
    // Fråga 4.1
    @Nullable
    public abstract Boolean getHarSkipparBalte();

    @Nullable
    public abstract String getSkipparBalteMotivering();
    ...
    /*
     * Retrieve a builder from an existing Af00213UtlatandeV2 object. The builder can then be used
    ...
    public abstract static class Builder {
        ...
        public abstract Af00213UtlatandeV2 build();
