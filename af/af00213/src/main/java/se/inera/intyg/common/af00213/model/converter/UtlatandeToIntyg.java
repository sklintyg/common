...
public final class UtlatandeToIntyg {
    ...
    public static Intyg convert(Af00213Utlatande utlatande) {
    ...
    private static TypAvIntyg getTypAvIntyg(Af00213Utlatande source) {
    ...
    private static List<Svar> getSvar(Af00213Utlatande source) {
    ...
    private static String buildOvrigaUpplysningar(Af00213Utlatande source) {
        String ovrigt = null;
