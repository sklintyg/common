...
public class Af00213TestabilityCertificateTestdataProvider
  ...
  public Map<String, CertificateDataValue> getMinimumValues() {
    ...
    final CertificateDataValueBoolean harFunktionsnedsattning =
    ...
    final CertificateDataValueBoolean harUtredningBehandling =
        CertificateDataValueBoolean.builder()
    ...
    final CertificateDataValueBoolean harArbetspaverkan =
        CertificateDataValueBoolean.builder()
  ...
  public Map<String, CertificateDataValue> getMaximumValues() {
    ...
    final var harFunktionsnedsattning =
        CertificateDataValueBoolean.builder()
            .id(FUNKTIONSNEDSATTNING_SVAR_JSON_ID_11)
            .selected(true)
            .build();
    ...
    final var harAktivitetsbegransning =
        CertificateDataValueBoolean.builder()
    ...
    final var harUtredningBehandling =
        CertificateDataValueBoolean.builder()
            .id(UTREDNING_BEHANDLING_SVAR_JSON_ID_31)
            .selected(true)
            .build();
    ...
    final var ovrigt =
        CertificateDataValueText.builder().id(OVRIGT_SVAR_JSON_ID_5).text(EXAMPLE_TEXT).build();
