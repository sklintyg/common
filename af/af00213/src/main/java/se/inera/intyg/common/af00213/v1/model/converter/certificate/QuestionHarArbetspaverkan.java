...
public class QuestionHarArbetspaverkan {
  ...
  public static CertificateDataElement toCertificate(
      Boolean harArbetspaverkan, int index, CertificateTextProvider texts) {
        ...
        .validation(
            new CertificateDataValidation[] {
              CertificateDataValidationMandatory.builder()
                  ...
                  .expression(exists(ARBETETS_PAVERKAN_SVAR_JSON_ID_41))
                  .build()
            })
        .build();
  }
  ...
  public static Boolean toInternal(Certificate certificate) {
    return booleanValue(
        certificate.getData(), ARBETETS_PAVERKAN_DELSVAR_ID_41, ARBETETS_PAVERKAN_SVAR_JSON_ID_41);
  }
}
