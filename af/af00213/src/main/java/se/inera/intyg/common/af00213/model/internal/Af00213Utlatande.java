...
import static se.inera.intyg.common.af00213.model.converter.RespConstants.GRUNDDATA_SVAR_JSON_ID;
import static se.inera.intyg.common.af00213.model.converter.RespConstants.ID_JSON_ID;
import static se.inera.intyg.common.af00213.model.converter.RespConstants.OVRIGT_SVAR_JSON_ID_5;
import static se.inera.intyg.common.af00213.model.converter.RespConstants.SIGNATURE;
import static se.inera.intyg.common.af00213.model.converter.RespConstants.TEXTVERSION_JSON_ID;
...
@AutoValue
@JsonDeserialize(builder = AutoValue_Af00213Utlatande.Builder.class)
public abstract class Af00213Utlatande implements AfUtlatande {
    ...
    /*
     * Retrieve a builder from an existing Af00213Utlatande object. The builder can then be used
     * to create a new copy with modified attributes.
     */
    public abstract Builder toBuilder();

    public static Builder builder() {
        return new AutoValue_Af00213Utlatande.Builder()
                .setSignature(null);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract Af00213Utlatande build();
