...
public abstract class Af00213UtlatandeV1 implements AfUtlatande {
  ...
  public static Builder builder() {
    return new AutoValue_Af00213UtlatandeV1.Builder().setSignature(null);
  }
  ...
  // Fråga 1.1
  @Nullable public abstract Boolean getHarFunktionsnedsattning();
  ...
  // Fråga 2.1
  @Nullable public abstract Boolean getHarAktivitetsbegransning();
  ...
  @Nullable public abstract Boolean getHarUtredningBehandling();

  @Nullable public abstract String getUtredningBehandling();

  // Fråga 4 - Planerad medicinsk behandling
  // Fråga 4.1
  @Nullable public abstract Boolean getHarArbetetsPaverkan();

  @Nullable public abstract String getArbetetsPaverkan();
