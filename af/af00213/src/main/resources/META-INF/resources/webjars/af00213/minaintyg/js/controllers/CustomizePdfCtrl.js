 ...
 */
angular.module('af00213').controller('af00213.CustomizePdfCtrl',
    [ '$window', '$location', '$log', '$rootScope', '$state', '$stateParams', '$scope','af00213.customizeViewstate', 'common.IntygListService',
        ...
        function($window, $location, $log, $rootScope, $state, $stateParams, $scope, customizeViewstate, listCertService, certificateService, dialogService, messageService) {
            ...
            $scope.downloadAsPdfLink = '/moduleapi/certificate/af00213' + '/' + $stateParams.certificateId + '/pdf/arbetsgivarutskrift';
            ...
            certificateService.getCertificate('af00213', $stateParams.certificateId, function(result) {
                ...
                if (result !== null) {
                    ...
                    // show error view
                    $location.path('/af00213/visafel/certnotfound');
                }
            }, function() {
                $log.debug('got error');
                $location.path('/af00213/visafel/certnotfound');
            ...
            $scope.$on('$stateChangeStart', function(event, toState, toParams, fromState, fromParams, options) {
                if (toState.name.indexOf('af00213-customize')!==-1 || leaveConfirmed) {
                    return;
                }
            ...
            $scope.backToViewCertificate = function() {
                ...
                $location.path('/af00213/view/' + $stateParams.certificateId);
            };
