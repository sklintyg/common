 ...
 */
angular.module('af00213').factory('af00213.Domain.IntygModel.v2',
    ['common.Domain.GrundDataModel', 'common.Domain.DraftModel', 'common.domain.ModelAttr',
        'common.domain.BaseAtticModel',
        function(GrundData, DraftModel, ModelAttr, BaseAtticModel) {
            'use strict';

            var Af00213Modelv2 = BaseAtticModel._extend({
                init: function init() {
                    var grundData = GrundData.build();
                    init._super.call(this, 'af00213Modelv2', {
                ...
                build : function(){
                    return new DraftModel(new Af00213Modelv2());
                }
            });
