 ...
 */
package se.inera.intyg.common.af00213.utils;
...
public final class ScenarioFinder {
    ...
    private static final class FileBasedScenario implements Scenario {
         ...
         */
        @Override
        public Af00213Utlatande asInternalModel()
                throws ScenarioNotFoundException {
            try {
                return new CustomObjectMapper().readValue(getInternalModelFor(getName()), Af00213Utlatande.class);
            } catch (IOException e) {
