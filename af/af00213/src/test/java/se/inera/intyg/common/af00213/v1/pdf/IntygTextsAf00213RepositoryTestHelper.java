...
public class IntygTextsAf00213RepositoryTestHelper extends IntygTextsRepositoryImpl {

    public IntygTextsAf00213RepositoryTestHelper() {
    ...
    public void update() {
        ...
        try {
            Document e = DocumentBuilderFactory.newInstance().newDocumentBuilder()
                .parse(new ClassPathResource("v1/text/texterMU_AF00213_v1.0.xml").getInputStream());
