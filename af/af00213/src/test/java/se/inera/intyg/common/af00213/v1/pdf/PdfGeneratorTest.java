...
public class PdfGeneratorTest {
  ...
  public void testGeneratePdf() throws IOException, ModuleException {
    IntygTextsAf00213RepositoryTestHelper intygsTextRepositoryHelper =
        new IntygTextsAf00213RepositoryTestHelper();
    intygsTextRepositoryHelper.update();
    IntygTexts intygTexts = intygsTextRepositoryHelper.getTexts("af00213", "1.0");

    String jsonModel =
        IOUtils.toString(
            new ClassPathResource("v1/internal/scenarios/pass-complete.json").getInputStream(),
    ...
    Pattern p =
        Pattern.compile("^af_medicinskt_utlatande_[\\d]{2}_[\\d]{2}_[\\d]{2}_[\\d]{4}\\.pdf$");
