...
public class ConverterTest {
    ...
    public void outputJsonFromXml() throws Exception {
        ...
        Af00213Utlatande utlatandeFromJson = objectMapper.readValue(json, Af00213Utlatande.class);
    ...
    private String getJsonFromTransport(RegisterCertificateType transport) throws ConverterException {
        ...
        Af00213Utlatande internal = se.inera.intyg.common.af00213.model.converter.TransportToInternal.convert(transport.getIntyg());
        try {
