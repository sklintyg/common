...
import se.inera.intyg.common.af00213.model.converter.WebcertModelFactoryImpl;
...
public class Af00213ModuleApiTest {
    ...
    public void testValidateShouldUseValidator() throws Exception {
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue("internal model", Af00213Utlatande.class);
    ...
    public void testRegisterCertificate() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(internalModel, Af00213Utlatande.class);
    ...
    public void testGetUtlatandeFromJson() throws Exception {
        ...
        doReturn(ScenarioFinder.getInternalScenario("pass-minimal").asInternalModel())
                .when(objectMapper)
                .readValue(utlatandeJson, Af00213Utlatande.class);
    ...
    public void testCreateRevokeRequest() throws Exception {
        ...
        Utlatande utlatande = Af00213Utlatande.builder().setId(intygId).setGrundData(gd).setTextVersion("").build();
    ...
    private Af00213Utlatande getUtlatandeFromFile() throws IOException {
        return new CustomObjectMapper().readValue(new ClassPathResource(
                TESTFILE_UTLATANDE).getFile(), Af00213Utlatande.class);
    }
