 ...
 */
angular.module('af00251').service('af00251.EditCertCtrl.ViewStateService.v1',
    ['$log', '$state', 'common.UtkastViewStateService', 'af00251.Domain.IntygModel.v1',
        function($log, $state, CommonViewState, IntygModel) {
            ...
            this.reset = function() {
                ...
                CommonViewState.intyg.type = 'af00251';
