...
public class WebcertModelFactoryImpl implements WebcertModelFactory<AF00251UtlatandeV1> {
   ...
   * @return {@link AF00251UtlatandeV1} or throws a ConverterException if something unforeseen
   *     happens
   */
  @Override
  public AF00251UtlatandeV1 createNewWebcertDraft(CreateNewDraftHolder newDraftData)
    ...
    template.setTextVersion(
        intygTexts.getLatestVersionForSameMajorVersion(
            AF00251EntryPoint.MODULE_ID, newDraftData.getIntygTypeVersion()));

    return template.setGrundData(grundData).build();
  }

  @Override
  public AF00251UtlatandeV1 createCopy(CreateDraftCopyHolder copyData, Utlatande template)
      throws ConverterException {
  ...
  private void populateWithId(AF00251UtlatandeV1.Builder utlatande, String utlatandeId)
      throws ConverterException {
