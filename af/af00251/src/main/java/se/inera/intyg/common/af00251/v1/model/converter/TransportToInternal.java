...
public final class TransportToInternal {
  ...
  private static void setSvar(AF00251UtlatandeV1.Builder utlatande, Intyg source)
  ...
  private static void handleMedicinsktUnderlag(AF00251UtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
  ...
  private static void handleArbetsmarknadspolitisktProgram(
      AF00251UtlatandeV1.Builder utlatande, Svar svar) throws ConverterException {
    ...
    for (Delsvar delsvar : svar.getDelsvar()) {
      switch (delsvar.getId()) {
        ...
        case ARBETSMARKNADSPOLITISKT_PROGRAM_DELSVAR_ID_22:
          builder.setOmfattning(
              ArbetsmarknadspolitisktProgram.Omfattning.fromId(
  ...
  private static void handleSjukfranvaro(List<Sjukfranvaro> sjukfranvaroList, Svar svar)
      throws ConverterException {
        ...
        case SJUKFRANVARO_DELSVAR_ID_62:
          ...
          builder.setPeriod(
              new InternalLocalDateInterval(
                  new InternalDate(datePeriod.getStart()), new InternalDate(datePeriod.getEnd())));
          break;
        default:
          throw new IllegalArgumentException();
      }
  ...
  private static void handleBegransningSjukfranvaro(
      AF00251UtlatandeV1.Builder utlatande, Svar svar) {
  ...
  private static void handlePrognosAtergang(AF00251UtlatandeV1.Builder utlatande, Svar svar)
      throws ConverterException {
