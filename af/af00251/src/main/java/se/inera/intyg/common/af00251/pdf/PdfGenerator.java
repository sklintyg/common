...
public class PdfGenerator {
  ...
  private static final String PDF_SUMMARY_HEADER =
      "Arbetsförmedlingens intyg för arbetsmarknadspolitiska program";
  ...
  private static final String INFO_SIGNED_TEXT =
      "Detta är en utskrift av ett elektroniskt intyg. Intyget har signerats "
  ...
  private static final String SENT_TEXT =
      "Notera att intyget redan har skickats till Arbetsförmedlingen.";

  private static final String CERTIFICATE_FILE_PREFIX =
      "af_lakarintyg_arbetsmarknadspolitiskt_program_";
      ...
      PrintConfig printConfig =
          PrintConfig.PrintConfigBuilder.aPrintConfig()
              ...
              .withLeftMarginTypText(
                  AF00251EntryPoint.ISSUER_TYPE_ID + " - Fastställd av Arbetsförmedlingen")
