...
module.exports = function(config) {
    ...
    var SRC_DIR = 'src/main/resources/META-INF/resources/webjars/afmu/webcert/views/';
    var TEST_DIR = 'src/main/resources/META-INF/resources/webjars/afmu/webcert/';
    ...
    config.set({
        ...
        preprocessors: {
            'src/main/resources/META-INF/resources/webjars/afmu/webcert/views/**/*.html': ['ng-html2js']
        },
